...
I personally use `Picard <https://picard.musicbrainz.org/>`__ to tag my music files.
...
- MPD does not support multi-value MusicBrainz ID tags: `MPD issue <https://github.com/MusicPlayerDaemon/MPD/issues/687>`__. myMPD implements a workaround and splits the MUSICBRAINZ_ARTISTID and MUSICBRAINZ_ALBUMARTISTID tags by semicolon.
