...
| FIELD    | DESCRIPTION                                                           |
+==========+=======================================================================+
| ligature | The same as for home icons from `Material Icons `MaterialIconsLink`_  |
+----------+-----------------------------------------------------------------------+
...
.. _MaterialIconsLink: https://fonts.google.com/icons?selected=Material+Icons&icon.style=Filled
