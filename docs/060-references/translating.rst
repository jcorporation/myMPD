...
.. include:: /_includes/translating_status.md
...
The translation files are imported to a public POEditor project. You can `join the project <https://poeditor.com/join/project/Z54inZwdul>`__ and help translating.

- `GitHub discussion <https://github.com/jcorporation/myMPD/discussions/803>`__

.. hint::
   There are some phrases that are only shortcuts for the full text. You can lookup the english phrase `here <https://github.com/jcorporation/myMPD/blob/master/src/i18n/json/en-US.json>`__.
