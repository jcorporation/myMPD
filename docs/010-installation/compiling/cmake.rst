...
+-----------------------------+---------+-----------------------------------------------------------+
| MYMPD_EMBEDDED_LIBMPDCLIENT | OFF     | Use embedded libmpdclient                                 |
+-----------------------------+---------+-----------------------------------------------------------+
...
+-----------------------------+---------+-----------------------------------------------------------+
| MYMPD_ENABLE_TSAN           | OFF     | Enables build with thread sanitizer                       |
+-----------------------------+---------+-----------------------------------------------------------+
...
+-----------------------------+---------+-----------------------------------------------------------+
| MYMPD_MINIMAL               | OFF     | Enables minimal myMPD build, disables all                 |
|                             |         | MYMPD_ENABLE\_\* flags                                    |
+-----------------------------+---------+-----------------------------------------------------------+
| MYMPD_STARTUP_SCRIPT        | ON      | Installs the startup script.                              |
|                             |         | Valid values: ON, OFF, SYSTEMD, OPENRC, SYSVINIT, FREEBSD |
+-----------------------------+---------+-----------------------------------------------------------+
