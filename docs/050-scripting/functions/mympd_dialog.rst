...
+--------------+-------------------------------------------------------+
| displayValue | The display values of the form element, it is         |
|              | optional and only valid for ``select``, ``radio`` and |
|              | ``list``.                                             |
+--------------+-------------------------------------------------------+
...
| radio            | Radios                                            |
+------------------+---------------------------------------------------+
| list             | List of elements to select from. Selected items   |
|                  | are separated by ``;;``                           |
+------------------+---------------------------------------------------+
