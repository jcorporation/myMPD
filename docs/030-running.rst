...
The installation process installs a LSB compatible startup script /
systemd unit for myMPD.
...
+-------------+---------------------------------------+
| systemd     | ``/usr/lib/systemd/system/mympd`` and |
|             | ``/usr/lib/systemd/user/mympd``       |
+-------------+---------------------------------------+
...
.. warning:: The default systemd service unit supports only systemd v235 and above.
...
Goto :doc:`Docker <010-installation/docker>`
