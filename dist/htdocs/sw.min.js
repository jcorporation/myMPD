...
var CACHE="myMPD-cache-v5.2.0",urlsToCache="/ /player.html /css/bootstrap.min.css /css/mympd.min.css /js/bootstrap-native-v4.min.js /js/mympd.min.js /js/player.min.js /js/keymap.min.js /assets/appicon-167.png /assets/appicon-192.png /assets/appicon-512.png /assets/coverimage-httpstream.png /assets/coverimage-notavailable.png /assets/coverimage-loading.png /assets/favicon.ico /assets/MaterialIcons-Regular.woff2".split(" "),ignoreRequests=/(\/api(\/?)|\/ws(\/?)|\/library\/(.*)(\/?)|\/pics\/(.*))$/;
