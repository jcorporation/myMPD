...
t){F=l.placement;H=c.title||a.getAttribute("data-title");A=c.content||a.getAttribute("data-content");A=A.trim();t=e.createElement("div");var b=e.createElement("div");b.setAttribute("class","arrow");t.appendChild(b);null!==A&&null===l.template?(t.setAttribute("role","tooltip"),null!==H&&(b=e.createElement("h3"),b.setAttribute("class","popover-header"),b.innerHTML=l.dismissible?H+'<button type="button" class="close">\u00d7</button>':H,t.appendChild(b)),b=e.createElement("div"),b.setAttribute("class",
