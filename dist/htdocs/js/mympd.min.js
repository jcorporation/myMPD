...
$jscomp.polyfillIsolated=function(a,b,c,d){var g=a.split(".");a=1===g.length;d=g[0];d=!a&&d in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var f=0;f<g.length-1;f++){var h=g[f];if(!(h in d))return;d=d[h]}g=g[g.length-1];c=$jscomp.IS_SYMBOL_NATIVE&&"es6"===c?d[g]:null;b=b(c);null!=b&&(a?$jscomp.defineProperty($jscomp.polyfills,g,{configurable:!0,writable:!0,value:b}):b!==c&&($jscomp.propertyToPolyfillSymbol[g]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(g):$jscomp.POLYFILL_PREFIX+g,g=
$jscomp.propertyToPolyfillSymbol[g],$jscomp.defineProperty(d,g,{configurable:!0,writable:!0,value:b})))};$jscomp.polyfill("Object.is",function(a){return a?a:function(b,c){return b===c?0!==b||1/b===1/c:b!==b&&c!==c}},"es6","es3");$jscomp.polyfill("Array.prototype.includes",function(a){return a?a:function(b,c){var d=this;d instanceof String&&(d=String(d));var g=d.length;c=c||0;for(0>c&&(c=Math.max(c+g,0));c<g;c++){var f=d[c];if(f===b||Object.is(f,b))return!0}return!1}},"es7","es3");
...
$jscomp.polyfill("Symbol",function(a){if(a)return a;var b=function(g,f){this.$jscomp$symbol$id_=g;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:f})};b.prototype.toString=function(){return this.$jscomp$symbol$id_};var c=0,d=function(g){if(this instanceof d)throw new TypeError("Symbol is not a constructor");return new b("jscomp_symbol_"+(g||"")+"_"+c++,g)};return d},"es6","es3");
$jscomp.polyfill("Symbol.iterator",function(a){if(a)return a;a=Symbol("Symbol.iterator");for(var b="Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "),c=0;c<b.length;c++){var d=$jscomp.global[b[c]];"function"===typeof d&&"function"!=typeof d.prototype[a]&&$jscomp.defineProperty(d.prototype,a,{configurable:!0,writable:!0,value:function(){return $jscomp.iteratorPrototype($jscomp.arrayIteratorImpl(this))}})}return a},"es6",
"es3");$jscomp.iteratorPrototype=function(a){a={next:a};a[Symbol.iterator]=function(){return this};return a};$jscomp.iteratorFromArray=function(a,b){a instanceof String&&(a+="");var c=0,d=!1,g={next:function(){if(!d&&c<a.length){var f=c++;return{value:b(f,a[f]),done:!1}}d=!0;return{done:!0,value:void 0}}};g[Symbol.iterator]=function(){return g};return g};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");
...
function sendAPI(a,b,c,d){var g={jsonrpc:"2.0",id:0,method:a,params:b},f=new XMLHttpRequest;f.open("POST",subdir+"/api",!0);f.setRequestHeader("Content-type","application/json");f.onreadystatechange=function(){if(4===f.readyState)if(""!==f.responseText){var h=JSON.parse(f.responseText);if(h.error)showNotification(t(h.error.message,h.error.data),"","","danger"),logError(JSON.stringify(h.error));else if(h.result&&h.result.message&&"ok"!==h.result.message)logDebug("Got API response: "+JSON.stringify(h.result)),
showNotification(t(h.result.message,h.result.data),"","","success");else if(h.result&&h.result.message&&"ok"===h.result.message)logDebug("Got API response: "+JSON.stringify(h.result));else if(h.result&&h.result.method)logDebug("Got API response of type: "+h.result.method);else if(logError("Got invalid API response: "+JSON.stringify(h)),!0!==d)return;void 0!==c&&"function"===typeof c&&(void 0!==h.result||!0===d?(logDebug("Calling "+c.name),c(h)):logDebug("Undefined resultset, skip calling "+c.name))}else logError("Empty response for request: "+
JSON.stringify(g)),!0===d&&void 0!==c&&"function"===typeof c&&(logDebug("Got empty API response calling "+c.name),c(""))};f.send(JSON.stringify(g));logDebug("Send API request: "+a)}
...
function initBrowse(){document.getElementById("BrowseDatabaseCards").addEventListener("click",function(a){"Album"===app.current.tag?a.target.classList.contains("card-body")?appGoto("Browse","Database","Detail",0,void 0,"Album","AlbumArtist",decodeURI(a.target.parentNode.getAttribute("data-album")),decodeURI(a.target.parentNode.getAttribute("data-albumartist"))):a.target.classList.contains("card-footer")&&popoverMenuAlbumCards(a):(app.current.search="",document.getElementById("searchDatabaseStr").value=
"",appGoto(app.current.app,app.current.card,void 0,0,void 0,"Album","AlbumArtist","Album","("+app.current.tag+" == '"+decodeURI(a.target.parentNode.getAttribute("data-tag"))+"')"))},!1);document.getElementById("BrowseDatabaseCards").addEventListener("contextmenu",function(a){"Album"===app.current.tag&&popoverMenuAlbumCards(a)},!1);document.getElementById("BrowseDatabaseCards").addEventListener("long-press",function(a){"Album"===app.current.tag&&popoverMenuAlbumCards(a)},!1);document.getElementById("BrowseDatabaseCards").addEventListener("keydown",
function(a){navigateGrid(a.target,a.key)},!1);!1===isMobile&&(document.getElementById("BrowseDatabaseCards").addEventListener("mouseover",function(a){if(a.target.classList.contains("card-body")&&0===a.target.childNodes.length){var b=document.getElementById("BrowseDatabaseCards").getElementsByClassName("album-grid-mouseover");if(1<b.length)for(var c=0;c<b.length;c++)b[c].remove();addPlayButton(a.target)}},!1),document.getElementById("BrowseDatabaseCards").addEventListener("mouseout",function(a){!a.target.classList.contains("card-body")||
null!==a.relatedTarget&&a.relatedTarget.classList.contains("album-grid-mouseover")||(a.target.innerHTML="")},!1));document.getElementById("BrowseDatabaseDetailList").addEventListener("click",function(a){"TFOOT"!==a.target.parentNode.parentNode.nodeName&&("TD"===a.target.nodeName?appendQueue("song",decodeURI(a.target.parentNode.getAttribute("data-uri")),a.target.parentNode.getAttribute("data-name")):"A"===a.target.nodeName&&showMenu(a.target,a))},!1);document.getElementById("searchDatabaseTags").addEventListener("click",
function(a){"BUTTON"===a.target.nodeName&&(app.current.filter=a.target.getAttribute("data-tag"),appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,app.current.filter,app.current.sort,app.current.tag,app.current.search))},!1);document.getElementById("databaseSortDesc").addEventListener("click",function(a){toggleBtnChk(this);a.stopPropagation();a.preventDefault();"-"===app.current.sort.charAt(0)?app.current.sort=app.current.sort.substr(1):app.current.sort="-"+app.current.sort;
appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,app.current.filter,app.current.sort,app.current.tag,app.current.search)},!1);document.getElementById("databaseSortTags").addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&(a.preventDefault(),a.stopPropagation(),app.current.sort=a.target.getAttribute("data-tag"),appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,app.current.filter,app.current.sort,app.current.tag,app.current.search))},
...
!1);document.getElementById("searchFilesystemStr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,""!==this.value?this.value:"-",app.current.sort,"-",app.current.search)},!1);document.getElementById("searchPlaylistsStr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,app.current.filter,app.current.sort,"-",
this.value)},!1);document.getElementById("searchDatabaseStr").addEventListener("keyup",function(a){if("Escape"===a.key)this.blur();else if("Enter"===a.key&&"Album"===app.current.tag)if(""!==this.value){a=document.getElementById("searchDatabaseMatch");var b=document.createElement("button");b.classList.add("btn","btn-light","mr-2");b.setAttribute("data-filter-tag",encodeURI(app.current.filter));b.setAttribute("data-filter-op",encodeURI(a.options[a.selectedIndex].value));b.setAttribute("data-filter-value",
encodeURI(this.value));b.innerHTML=e(app.current.filter)+" "+e(a.options[a.selectedIndex].value)+" '"+e(this.value)+'\'<span class="ml-2 badge badge-secondary">&times;</span>';this.value="";document.getElementById("searchDatabaseCrumb").appendChild(b)}else searchAlbumgrid(this.value);else"Album"===app.current.tag?searchAlbumgrid(this.value):appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,app.current.filter,app.current.sort,app.current.tag,this.value)},!1);document.getElementById("searchDatabaseCrumb").addEventListener("click",
function(a){"SPAN"===a.target.nodeName?(a.preventDefault(),a.stopPropagation(),a.target.parentNode.remove(),searchAlbumgrid("")):"BUTTON"===a.target.nodeName&&(a.preventDefault(),a.stopPropagation(),selectTag("searchDatabaseTags","searchDatabaseTagsDesc",decodeURI(a.target.getAttribute("data-filter-tag"))),document.getElementById("searchDatabaseStr").value=unescapeMPD(decodeURI(a.target.getAttribute("data-filter-value"))),document.getElementById("searchDatabaseMatch").value=decodeURI(a.target.getAttribute("data-filter-op")),
a.target.remove(),searchAlbumgrid(document.getElementById("searchDatabaseStr").value))},!1);document.getElementById("BrowseFilesystemList").addEventListener("click",function(a){if("TD"===a.target.nodeName)switch(a.target.parentNode.getAttribute("data-type")){case "parentDir":case "dir":app.current.filter="-";appGoto("Browse","Filesystem",void 0,"0",app.current.limit,app.current.filter,app.current.sort,"-",decodeURI(a.target.parentNode.getAttribute("data-uri")));break;case "song":appendQueue("song",
...
d=decodeURI(a.target.parentNode.parentNode.getAttribute("data-uri")),g=a.target.parentNode.parentNode.firstChild.innerText,f=a.target.getAttribute("data-href");"delete"===f?(sendAPI("MYMPD_API_BOOKMARK_RM",{id:b},function(){sendAPI("MYMPD_API_BOOKMARK_LIST",{offset:0,limit:0},parseBookmarks)}),a.preventDefault(),a.stopPropagation()):"edit"===f?showBookmarkSave(b,g,d,c):"goto"===f&&appGoto("Browse","Filesystem",void 0,"0",void 0,"-","-","-",d)}},!1);document.getElementById("BrowsePlaylistsAllList").addEventListener("click",
function(a){"TD"===a.target.nodeName?appendQueue("plist",decodeURI(a.target.parentNode.getAttribute("data-uri")),a.target.parentNode.getAttribute("data-name")):"A"===a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("BrowsePlaylistsDetailList").addEventListener("click",function(a){"TFOOT"!==a.target.parentNode.parentNode.nodeName&&("TD"===a.target.nodeName?appendQueue("song",decodeURI(a.target.parentNode.getAttribute("data-uri")),a.target.parentNode.getAttribute("data-name")):"A"===
a.target.nodeName&&showMenu(a.target,a))},!1);document.getElementById("BrowseBreadcrumb").addEventListener("click",function(a){"A"===a.target.nodeName&&(a.preventDefault(),appGoto("Browse","Filesystem",void 0,"0",app.current.limit,app.current.filter,app.current.sort,"-",decodeURI(a.target.getAttribute("data-uri"))))},!1);document.getElementById("BrowseFilesystemBookmark").parentNode.addEventListener("show.bs.dropdown",function(){sendAPI("MYMPD_API_BOOKMARK_LIST",{offset:0,limit:0},parseBookmarks)})}
...
app.current.filter,app.current.sort,a,app.current.search)))}function popoverMenuAlbumCards(a){showMenu(a.target,a);for(var b=document.getElementById("BrowseDatabaseCards").getElementsByClassName("selected"),c=0;c<b.length;c++)b[c].classList.remove("selected");a.target.parentNode.classList.add("selected");a.preventDefault();a.stopPropagation()}
function gotoBrowse(a){if(!1!==settings.featAdvsearch){a=a.target;var b=a.getAttribute("data-tag"),c=decodeURI(a.getAttribute("data-name"));null===b&&(b=a.parentNode.getAttribute("data-tag"),c=decodeURI(a.parentNode.getAttribute("data-name")));if(""!==b&&""!==c&&"-"!==c&&settings.browsetags.includes(b))if("Album"===b){var d=a.getAttribute("data-albumartist");null===d&&(d=a.parentNode.getAttribute("data-albumartist"));null!==d?appGoto("Browse","Database","Detail","0",void 0,b,tagAlbumArtist,c,decodeURI(d)):
appGoto("Browse","Database","List","0",void 0,b,tagAlbumArtist,"Album","("+b+" == '"+escapeMPD(c)+"')")}else appGoto("Browse","Database","List","0",void 0,b,tagAlbumArtist,"Album","("+b+" == '"+escapeMPD(c)+"')")}}
function parseFilesystem(a){var b=app.current.app+("Filesystem"===app.current.tab?app.current.tab:""),c=document.getElementById(app.current.app+(void 0===app.current.tab?"":app.current.tab)+"List"),d=c.getElementsByTagName("tbody")[0],g=settings["cols"+b].length;if(a.error)d.innerHTML='<tr><td><span class="material-icons">error_outline</span></td><td colspan="'+g+'">'+t(a.error.message)+"</td></tr>";else{if("Browse"===app.current.app&&"Filesystem"===app.current.tab){var f=document.getElementById("BrowseFilesystemImages");
f.innerHTML="";0===a.result.images.length&&""===a.result.bookletPath||!1===settings.publish?f.classList.add("hide"):f.classList.remove("hide");if(""!==a.result.bookletPath&&!0===settings.publish){var h=document.createElement("div");h.style.backgroundImage='url("'+subdir+'/assets/coverimage-booklet.svg")';h.classList.add("booklet");h.setAttribute("data-href",subdir+"/browse/music/"+a.result.bookletPath);h.title=t("Booklet");f.appendChild(h)}for(h=0;h<a.result.images.length;h++){var k=document.createElement("div");
k.style.backgroundImage='url("'+subdir+"/browse/music/"+a.result.images[h]+'"),url("assets/coverimage-loading.svg")';f.appendChild(k)}}f=a.result.returnedEntities;h=d.getElementsByTagName("tr");c=document.activeElement.parentNode.parentNode===c?!0:!1;for(var l=k=0;l<f;l++){var m=encodeURI(a.result.data[l].uri),n=document.createElement("tr"),p="";n.setAttribute("data-type",a.result.data[l].Type);n.setAttribute("data-uri",m);n.setAttribute("tabindex",0);"Search"===app.current.app&&!0===settings.featTags&&
...
p}l<h.length?k=!0===replaceTblRow(h[l],n)?l:k:d.append(n)}for(b=h.length-1;b>=f;b--)h[b].remove();!0===c&&focusTable(0);setPagination(a.result.totalEntities,a.result.returnedEntities);0===f&&(d.innerHTML='<tr><td><span class="material-icons">error_outline</span></td><td colspan="'+g+'">'+t("Empty list")+"</td></tr>")}document.getElementById(app.current.app+(void 0===app.current.tab?"":app.current.tab)+"List").classList.remove("opacity05")}
...
function parseDatabase(a){var b=a.result.returnedEntities,c=document.getElementById("BrowseDatabaseCards"),d=c.getElementsByClassName("col"),g="IntersectionObserver"in window?!0:!1;0===d.length&&(c.innerHTML="");for(var f=0;f<b;f++){var h=document.createElement("div");h.classList.add("col","px-0","flex-grow-0");""===a.result.data[f].AlbumArtist&&(a.result.data[f].AlbumArtist=t("Unknown artist"));""===a.result.data[f].Album&&(a.result.data[f].Album=t("Unknown album"));if("Album"===a.result.tag){var k=
genId("database"+a.result.data[f].Album+a.result.data[f].AlbumArtist);var l=subdir+"/albumart/"+encodeURI(a.result.data[f].FirstSongUri);var m='<div class="card card-grid clickable" data-picture="'+l+'" data-uri="'+encodeURI(a.result.data[f].FirstSongUri.replace(/\/[^/]+$/,""))+'" data-type="dir" data-name="'+encodeURI(a.result.data[f].Album)+'" data-album="'+encodeURI(a.result.data[f].Album)+'" data-albumartist="'+encodeURI(a.result.data[f].AlbumArtist)+'" tabindex="0"><div class="card-body album-cover-loading album-cover-grid bg-white d-flex" id="'+
k+'"></div><div class="card-footer card-footer-grid p-2" title="'+e(a.result.data[f].AlbumArtist)+": "+e(a.result.data[f].Album)+'">'+e(a.result.data[f].Album)+"<br/><small>"+e(a.result.data[f].AlbumArtist)+"</small></div></div>"}else k=genId("database"+a.result.data[f].value),l=subdir+"/tagpics/"+a.result.tag+"/"+encodeURI(a.result.data[f].value),m='<div class="card card-grid clickable" data-picture="'+l+'" data-tag="'+encodeURI(a.result.data[f].value)+'" tabindex="0">'+(!0===a.result.pics?'<div class="card-body album-cover-loading album-cover-grid bg-white" id="'+
k+'"></div>':"")+'<div class="card-footer card-footer-grid p-2" title="'+e(a.result.data[f].value)+'">'+e(a.result.data[f].value)+"<br/></div></div>";h.innerHTML=m;m=!1;f<d.length?d[f].firstChild.getAttribute("data-picture")!==h.firstChild.getAttribute("data-picture")&&(d[f].replaceWith(h),m=!0):(c.append(h),m=!0);!0===m&&(!0===g?(new IntersectionObserver(setGridImage,{root:null,rootMargin:"0px"})).observe(h):h.firstChild.firstChild.style.backgroundImage=l,"Album"===a.result.tag&&!0===isMobile&&addPlayButton(document.getElementById(k)))}for(g=
d.length-1;g>=b;g--)d[g].remove();setPagination(a.result.totalEntities,a.result.returnedEntities);0===b&&(c.innerHTML='<div class="ml-3 mb-3"><span class="material-icons">error_outline</span>&nbsp;'+t("Empty list")+"</div>")}
function setGridImage(a,b){a.forEach(function(c){if(0<c.intersectionRatio){b.unobserve(c.target);var d=decodeURI(c.target.firstChild.getAttribute("data-picture"));if(c=c.target.firstChild.getElementsByClassName("card-body")[0])c.style.backgroundImage='url("'+d+'"), url("'+subdir+'/assets/coverimage-loading.svg")'}})}
...
!1===settings.featBrowse?"":'<span class="text-light material-icons">description</span>&nbsp;<a class="text-light" target="_blank" href="'+subdir+"/browse/music/"+e(a.result.bookletPath)+'">'+t("Download booklet")+"</a>")+"</p>";b=document.getElementById("BrowseDatabaseDetailList");var c=b.getElementsByTagName("tbody")[0],d=settings.colsBrowseDatabaseDetail.length,g="";1<a.result.Discs&&(g='<tr class="not-clickable"><td><span class="material-icons">album</span></td><td colspan="'+d+'">'+t("Disc 1")+
"</td></tr>");for(var f=a.result.returnedEntities,h=parseInt(a.result.data[0].Disc),k=0;k<f;k++){h<parseInt(a.result.data[k].Disc)&&(g+='<tr class="not-clickable"><td><span class="material-icons">album</span></td><td colspan="'+d+'">'+t("Disc")+" "+e(a.result.data[k].Disc)+"</td></tr>");a.result.data[k].Duration&&(a.result.data[k].Duration=beautifySongDuration(a.result.data[k].Duration));g+='<tr tabindex="0" data-type="song" data-name="'+a.result.data[k].Title+'" data-uri="'+encodeURI(a.result.data[k].uri)+
'">';for(h=0;h<settings.colsBrowseDatabaseDetail.length;h++)g+='<td data-col="'+settings.colsBrowseDatabaseDetail[h]+'">'+e(a.result.data[k][settings.colsBrowseDatabaseDetail[h]])+"</td>";g+='<td data-col="Action"><a href="#" class="material-icons color-darkgrey">'+ligatureMore+"</a></td></tr>";h=a.result.data[k].Disc}c.innerHTML=g;b.getElementsByTagName("tfoot")[0].innerHTML='<tr><td colspan="'+(settings.colsBrowseDatabaseDetail.length+1)+'"><small>'+t("Num songs",a.result.totalEntities)+"&nbsp;&ndash;&nbsp;"+
beautifyDuration(a.result.totalTime)+"</small></td></tr>";document.getElementById("BrowseDatabaseDetailList").classList.remove("opacity05")}function backToAlbumGrid(){appGoto("Browse","Database","List")}function addAlbum(a){var b=decodeURI(app.current.tag),c=decodeURI(app.current.search);_addAlbum(a,c,b)}
...
function searchAlbumgrid(a){for(var b="",c=document.getElementById("searchDatabaseCrumb").children,d=0;d<c.length;d++)0<d&&(b+=" AND "),b+="("+decodeURI(c[d].getAttribute("data-filter-tag"))+" "+decodeURI(c[d].getAttribute("data-filter-op"))+" '"+escapeMPD(decodeURI(c[d].getAttribute("data-filter-value")))+"')";""!==a&&(""!==b&&(b+=" AND "),c=document.getElementById("searchDatabaseMatch"),b+="("+app.current.filter+" "+c.options[c.selectedIndex].value+" '"+escapeMPD(a)+"')");2>=b.length&&(b="");appGoto(app.current.app,
...
function parseHome(a){var b=a.result.returnedEntities,c=document.getElementById("HomeCards"),d=c.getElementsByClassName("col");0===d.length&&(c.innerHTML="");for(var g=0;g<b;g++){var f=document.createElement("div");f.classList.add("col","px-0","flex-grow-0");""===a.result.data[g].AlbumArtist&&(a.result.data[g].AlbumArtist=t("Unknown artist"));""===a.result.data[g].Album&&(a.result.data[g].Album=t("Unknown album"));"appGoto"===a.result.data[g].cmd&&8===a.result.data[g].options.length&&a.result.data[g].options.splice(4,
0,settings.maxElementsPerPage);var h=JSON.stringify({cmd:a.result.data[g].cmd,options:a.result.data[g].options});h='<div class="card home-icons clickable" draggable="true" tabindex="0" data-pos="'+g+"\" data-href='"+e(h)+"'  title=\""+e(a.result.data[g].name)+'"><div class="card-body material-icons">'+e(a.result.data[g].ligature)+'</div><div class="card-footer card-footer-grid p-2">'+e(a.result.data[g].name)+"</div></div>";f.innerHTML=h;g<d.length?d[g].replaceWith(f):c.append(f);""!==a.result.data[g].image&&
(f.getElementsByClassName("card-body")[0].style.backgroundImage='url("'+subdir+"/browse/pics/"+a.result.data[g].image+'")');""!==a.result.data[g].bgcolor&&(f.getElementsByClassName("card-body")[0].style.backgroundColor=a.result.data[g].bgcolor)}for(a=d.length-1;a>=b;a--)d[a].remove();0===b&&(c.innerHTML='<div class="ml-3">'+t("Homescreen welcome")+"</div>")}
function initHome(){document.getElementById("HomeCards").addEventListener("click",function(a){if(a.target.classList.contains("card-body")){var b=a.target.parentNode.getAttribute("data-href");null!==b&&parseCmd(a,b)}else a.target.classList.contains("card-footer")&&popoverMenuHome(a)},!1);document.getElementById("HomeCards").addEventListener("contextmenu",function(a){popoverMenuHome(a)},!1);document.getElementById("HomeCards").addEventListener("long-press",function(a){popoverMenuHome(a)},!1);document.getElementById("HomeCards").addEventListener("keydown",
function(a){navigateGrid(a.target,a.key)},!1);dragAndDropHome();document.getElementById("selectHomeIconCmd").addEventListener("change",function(){showHomeIconCmdOptions()},!1);document.getElementById("inputHomeIconLigature").addEventListener("change",function(a){document.getElementById("homeIconPreview").innerText=a.target.value;""!==a.target.value&&(document.getElementById("selectHomeIconImage").value="",document.getElementById("homeIconPreview").style.backgroundImage="")},!1);document.getElementById("inputHomeIconBgcolor").addEventListener("change",
function(a){document.getElementById("homeIconPreview").style.backgroundColor=a.target.value},!1);document.getElementById("selectHomeIconImage").addEventListener("change",function(a){a=getSelectValue(a.target);document.getElementById("homeIconPreview").style.backgroundImage='url("'+subdir+"/browse/pics/"+a+'")';""!==a?(document.getElementById("divHomeIconLigature").classList.add("hide"),document.getElementById("homeIconPreview").innerHTML=""):(document.getElementById("divHomeIconLigature").classList.remove("hide"),
document.getElementById("homeIconPreview").innerText=document.getElementById("inputHomeIconLigature").value)},!1)}function popoverMenuHome(a){for(var b=document.getElementById("HomeCards").getElementsByClassName("selected"),c=0;c<b.length;c++)b[c].classList.remove("selected");a.target.parentNode.classList.add("selected");showMenu(a.target,a);a.preventDefault();a.stopPropagation()}
...
""):(document.getElementById("divHomeIconLigature").classList.add("hide"),document.getElementById("homeIconPreview").style.backgroundImage="url("+subdir+'"/browse/pics/'+d.result.data.image+'")');modalEditHomeIcon.show()})}
...
name:b.value,ligature:""===c?document.getElementById("inputHomeIconLigature").value:"",bgcolor:document.getElementById("inputHomeIconBgcolor").value,image:c,cmd:document.getElementById("selectHomeIconCmd").value,options:a},function(){modalEditHomeIcon.hide();sendAPI("MYMPD_API_HOME_LIST",{},function(g){parseHome(g)})})}}function deleteHomeIcon(a){sendAPI("MYMPD_API_HOME_ICON_DELETE",{pos:a},function(b){parseHome(b)})}
function showHomeIconCmdOptions(a){var b="",c=getSelectedOptionAttribute("selectHomeIconCmd","data-options");if(void 0!==c){c=JSON.parse(c);for(var d=0;d<c.options.length;d++){var g=void 0!==a?void 0!==a[d]?a[d]:"":"";b+='<div class="form-group row"><label class="col-sm-4 col-form-label">'+t(c.options[d])+'</label><div class="col-sm-8"><input class="form-control border-secondary" value="'+e(g)+'"></div></div>'}}document.getElementById("divHomeIconOptions").innerHTML=b}
...
f.length-1;h>=b;h--)f[h].remove();f=settings.colsQueueJukebox.length;0===b&&(c.innerHTML='<tr><td><span class="material-icons">error_outline</span></td><td colspan="'+f+'">'+t("Empty list")+"</td></tr>");!0===d&&focusTable(g);setPagination(a.result.totalEntities,a.result.returnedEntities);document.getElementById("QueueJukeboxList").classList.remove("opacity05")}
...
function i18nHtml(a){for(var b=[["data-phrase","innerText"],["data-title-phrase","title"],["data-placeholder-phrase","placeholder"]],c=0;c<b.length;c++)for(var d=a.querySelectorAll("["+b[c][0]+"]"),g=d.length,f=0;f<g;f++)d[f][b[c][1]]=t(d[f].getAttribute(b[c][0]))}
...
function createImgCarousel(a,b,c){for(var d='<div id="'+b+'" class="carousel slide" data-ride="carousel"><ol class="carousel-indicators">',g=0;g<c.length;g++)d+='<li data-target="#'+b+'" data-slide-to="'+g+'"'+(0===g?' class="active"':"")+"></li>";d+='</ol><div class="carousel-inner" role="listbox">';for(g=0;g<c.length;g++)d+='<div class="carousel-item'+(0===g?" active":"")+'"><div></div></div>';a.innerHTML=d+('</div><a class="carousel-control-prev" href="#'+b+'" data-slide="prev"><span class="carousel-control-prev-icon"></span></a><a class="carousel-control-next" href="#'+
b+'" data-slide="next"><span class="carousel-control-next-icon"></span></a></div>');a=a.getElementsByClassName("carousel-item");for(d=0;d<a.length;d++)a[d].children[0].style.backgroundImage='url("'+encodeURI(c[d])+'")';b=document.getElementById(b);new BSN.Carousel(b,{interval:!1,pause:!1})}
function initMounts(){document.getElementById("listMountsList").addEventListener("click",function(a){a.stopPropagation();a.preventDefault();if("TD"===a.target.nodeName){if(""===a.target.parentNode.getAttribute("data-point"))return!1;showEditMount(decodeURI(a.target.parentNode.getAttribute("data-url")),decodeURI(a.target.parentNode.getAttribute("data-point")))}else if("A"===a.target.nodeName){var b=a.target.getAttribute("data-action"),c=decodeURI(a.target.parentNode.parentNode.getAttribute("data-point"));
"unmount"===b?unmountMount(c):"update"===b&&updateMount(a.target,c)}},!1);document.getElementById("btnDropdownNeighbors").parentNode.addEventListener("show.bs.dropdown",function(){!0===settings.featNeighbors?sendAPI("MPD_API_MOUNT_NEIGHBOR_LIST",{},parseNeighbors,!0):document.getElementById("dropdownNeighbors").children[0].innerHTML='<div class="list-group-item"><span class="material-icons">warning</span> '+t("Neighbors are disabled")+"</div>"},!1);document.getElementById("dropdownNeighbors").children[0].addEventListener("click",
...
function parseListMounts(a){for(var b=document.getElementById("listMounts").getElementsByTagName("tbody")[0],c=b.getElementsByTagName("tr"),d=0,g=0;g<a.result.returnedEntities;g++){var f=document.createElement("tr");f.setAttribute("data-url",encodeURI(a.result.data[g].mountUrl));f.setAttribute("data-point",encodeURI(a.result.data[g].mountPoint));""===a.result.data[g].mountPoint&&f.classList.add("not-clickable");var h="<td>"+(""===a.result.data[g].mountPoint?'<span class="material-icons">home</span>':
e(a.result.data[g].mountPoint))+"</td><td>"+e(a.result.data[g].mountUrl)+"</td>";h=""!==a.result.data[g].mountPoint?h+('<td data-col="Action"><a href="#" title="'+t("Unmount")+'" data-action="unmount" class="material-icons color-darkgrey">delete</a><a href="#" title="'+t("Update")+'" data-action="update"class="material-icons color-darkgrey">refresh</a></td>'):h+"<td>&nbsp;</td>";f.innerHTML=h;g<c.length?d=!0===replaceTblRow(c[g],f)?g:d:b.append(f)}for(d=c.length-1;d>=a.result.returnedEntities;d--)c[d].remove();
...
function appGoto(a,b,c,d,g,f,h,k,l,m){var n=document.body.scrollTop?document.body.scrollTop:document.documentElement.scrollTop;void 0!==app.apps[app.current.app].scrollPos?app.apps[app.current.app].scrollPos=n:void 0!==app.apps[app.current.app].tabs[app.current.tab].scrollPos?app.apps[app.current.app].tabs[app.current.tab].scrollPos=n:void 0!==app.apps[app.current.app].tabs[app.current.tab].views[app.current.view].scrollPos&&(app.apps[app.current.app].tabs[app.current.tab].views[app.current.view].scrollPos=
n);null===d&&(d=void 0);null===g&&(g=void 0);null===f&&(f=void 0);null===h&&(h=void 0);null===k&&(k=void 0);null===l&&(l=void 0);app.apps[a].tabs?(void 0===b&&(b=app.apps[a].active),app.apps[a].tabs[b].views?(void 0===c&&(c=app.apps[a].tabs[b].active),d="/"+encodeURIComponent(a)+"/"+encodeURIComponent(b)+"/"+encodeURIComponent(c)+"!"+encodeURIComponent(void 0===d?app.apps[a].tabs[b].views[c].offset:d)+"/"+encodeURIComponent(void 0===g?app.apps[a].tabs[b].views[c].limit:g)+"/"+encodeURIComponent(void 0===
f?app.apps[a].tabs[b].views[c].filter:f)+"/"+encodeURIComponent(void 0===h?app.apps[a].tabs[b].views[c].sort:h)+"/"+encodeURIComponent(void 0===k?app.apps[a].tabs[b].views[c].tag:k)+"/"+encodeURIComponent(void 0===l?app.apps[a].tabs[b].views[c].search:l),void 0!==m&&(app.apps[a].tabs[b].views[c].scrollPos=m)):(d="/"+encodeURIComponent(a)+"/"+encodeURIComponent(b)+"!"+encodeURIComponent(void 0===d?app.apps[a].tabs[b].offset:d)+"/"+encodeURIComponent(void 0===g?app.apps[a].tabs[b].limit:g)+"/"+encodeURIComponent(void 0===
f?app.apps[a].tabs[b].filter:f)+"/"+encodeURIComponent(void 0===h?app.apps[a].tabs[b].sort:h)+"/"+encodeURIComponent(void 0===k?app.apps[a].tabs[b].tag:k)+"/"+encodeURIComponent(void 0===l?app.apps[a].tabs[b].search:l),void 0!==m&&(app.apps[a].tabs[b].scrollPos=m))):(d="/"+encodeURIComponent(a)+"!"+encodeURIComponent(void 0===d?app.apps[a].offset:d)+"/"+encodeURIComponent(void 0===g?app.apps[a].limit:g)+"/"+encodeURIComponent(void 0===f?app.apps[a].filter:f)+"/"+encodeURIComponent(void 0===h?app.apps[a].sort:
...
"disabled"));a='<li class="breadcrumb-item"><a data-uri="" class="text-body material-icons">home</a></li>';for(var b=app.current.search.split("/"),c=b.length,d="",g=0;g<c;g++){if(c-1===g){a+='<li class="breadcrumb-item active">'+e(b[g])+"</li>";break}d+=b[g];a+='<li class="breadcrumb-item"><a class="text-body" href="#" data-uri="'+encodeURI(d)+'">'+e(b[g])+"</a></li>";d+="/"}document.getElementById("BrowseBreadcrumb").innerHTML=a;document.getElementById("searchFilesystemStr").value="-"===app.current.filter?
...
toggleBtnChk("databaseSortDesc",!0)):toggleBtnChk("databaseSortDesc",!1),selectTag("databaseSortTags",void 0,a),"Album"===app.current.tag){c=document.getElementById("searchDatabaseCrumb");d=document.getElementById("searchDatabaseStr");g="";for(var f=app.current.search.split(" AND "),h=0;h<f.length-1;h++){var k=f[h].substring(1,f[h].length-1),l=k.match(/^(\w+)\s+(\S+)\s+'(.*)'$/);g+='<button data-filter-tag="'+encodeURI(l[1])+'" data-filter-op="'+encodeURI(l[2])+'" data-filter-value="'+encodeURI(unescapeMPD(l[3]))+
'" class="btn btn-light mr-2">'+e(k)+'<span class="badge badge-secondary">&times</span></button>'}c.innerHTML=g;""===d.value&&1<=f.length&&(g=f[f.length-1].substring(1,f[f.length-1].length-1),f=g.substring(g.indexOf("'")+1,g.length-1),d.value!==f&&(d=g.match(/^(\w+)\s+(\S+)\s+'(.*)'$/),c.innerHTML+='<button data-filter-tag="'+encodeURI(d[1])+'" data-filter-op="'+encodeURI(d[2])+'" data-filter-value="'+encodeURI(unescapeMPD(d[3]))+'" class="btn btn-light mr-2">'+e(g)+'<span class="badge badge-secondary">&times</span></button>'),
...
app.current.app){domCache.searchstr.focus();if(settings.featAdvsearch){a="";b=app.current.search.substring(1,app.current.search.length-1).split(" AND ");for(c=0;c<b.length-1;c++)d=b[c].substring(1,b[c].length-1),g=d.match(/^(\w+)\s+(\S+)\s+'(.*)'$/),a+='<button data-filter-tag="'+encodeURI(g[1])+'" data-filter-op="'+encodeURI(g[2])+'" data-filter-value="'+encodeURI(unescapeMPD(g[3]))+'" class="btn btn-light mr-2">'+e(d)+'<span class="badge badge-secondary">&times</span></button>';domCache.searchCrumb.innerHTML=
...
1),a=a.substring(0,a.indexOf(" ")),""===a&&(a="contains"),document.getElementById("searchMatch").value=a)}else""===domCache.searchstr.value&&""!==app.current.search&&(domCache.searchstr.value=app.current.search);app.last.app!==app.current.app&&""!==app.current.search&&(a=settings["cols"+app.current.app].length,document.getElementById("SearchList").getElementsByTagName("tbody")[0].innerHTML='<tr><td><span class="material-icons">search</span></td><td colspan="'+a+'">'+t("Searching...")+"</td></tr>");
...
function appInit(){document.getElementById("mainMenu").addEventListener("click",function(f){f.preventDefault()},!1);document.getElementById("btnChVolumeDown").addEventListener("click",function(f){f.stopPropagation()},!1);document.getElementById("btnChVolumeUp").addEventListener("click",function(f){f.stopPropagation()},!1);domCache.volumeBar.addEventListener("click",function(f){f.stopPropagation()},!1);domCache.volumeBar.addEventListener("change",function(){sendAPI("MPD_API_PLAYER_VOLUME_SET",{volume:domCache.volumeBar.value})},
!1);domCache.progress.addEventListener("click",function(f){currentSong&&0<=currentSong.currentSongId&&0<currentSong.totalTime&&(domCache.progressBar.style.transition="none",domCache.progressBar.style.width=f.clientX+"px",setTimeout(function(){domCache.progressBar.style.transition=progressBarTransition},10),sendAPI("MPD_API_PLAYER_SEEK",{songid:currentSong.currentSongId,seek:Math.ceil(currentSong.totalTime*f.clientX/f.target.offsetWidth)}))},!1);domCache.progress.addEventListener("mousemove",function(f){if(("pause"===
playstate||"play"===playstate)&&0<currentSong.totalTime){domCache.progressPos.innerText=beautifySongDuration(Math.ceil(currentSong.totalTime/f.target.offsetWidth*f.clientX));domCache.progressPos.style.display="block";var h=domCache.progressPos.offsetWidth/2;domCache.progressPos.style.left=(f.clientX<h?f.clientX:f.clientX<window.innerWidth-h?f.clientX-h:f.clientX-2*h)+"px"}},!1);domCache.progress.addEventListener("mouseout",function(){domCache.progressPos.style.display="none"},!1);for(var a=document.querySelectorAll(".subMenu"),
b=a.length,c=0;c<b;c++)a[c].addEventListener("click",function(f){f.stopPropagation();f.preventDefault();f=this.getElementsByTagName("span")[0];f.innerText="keyboard_arrow_right"===f.innerText?"keyboard_arrow_down":"keyboard_arrow_right"},!1);document.getElementById("navbar-main").addEventListener("click",function(f){f.preventDefault();var h=f.target.getAttribute("data-href");null===h&&(h=f.target.parentNode.getAttribute("data-href"));null!==h&&parseCmd(f,h)},!1);document.getElementById("volumeMenu").parentNode.addEventListener("show.bs.dropdown",
function(){sendAPI("MPD_API_PLAYER_OUTPUT_LIST",{},parseOutputs)});document.getElementById("playDropdown").parentNode.addEventListener("show.bs.dropdown",function(){showPlayDropdown()});document.getElementById("playDropdown").addEventListener("click",function(f){f.preventDefault();f.stopPropagation()});a=document.querySelectorAll(".dropdown-toggle");for(b=0;b<a.length;b++)a[b].parentNode.addEventListener("show.bs.dropdown",function(){alignDropdown(this)});document.getElementById("modalAbout").addEventListener("shown.bs.modal",
function(){sendAPI("MPD_API_DATABASE_STATS",{},parseStats);getServerinfo();var f="",h;for(h in keymap)if(void 0===keymap[h].req||!0===settings[keymap[h].req])f+='<tr><td><div class="key'+(keymap[h].key&&1<keymap[h].key.length?" material-icons material-icons-small":"")+'">'+(void 0!==keymap[h].key?keymap[h].key:h)+"</div></td><td>"+t(keymap[h].desc)+"</td></tr>";document.getElementById("tbodyShortcuts").innerHTML=f});document.getElementById("modalAddToPlaylist").addEventListener("shown.bs.modal",function(){document.getElementById("addStreamFrm").classList.contains("hide")?
document.getElementById("addToPlaylistPlaylist").focus():(document.getElementById("streamUrl").focus(),document.getElementById("streamUrl").value="")});document.getElementById("modalUpdateDB").addEventListener("hidden.bs.modal",function(){document.getElementById("updateDBprogress").classList.remove("updateDBprogressAnimate")});document.getElementById("addToPlaylistPlaylist").addEventListener("change",function(){"new"===this.options[this.selectedIndex].value?(document.getElementById("addToPlaylistNewPlaylistDiv").classList.remove("hide"),
document.getElementById("addToPlaylistNewPlaylist").focus()):document.getElementById("addToPlaylistNewPlaylistDiv").classList.add("hide")},!1);document.getElementById("syscmds").addEventListener("click",function(f){"A"===f.target.nodeName&&parseCmd(f,f.target.getAttribute("data-href"))},!1);document.getElementById("scripts").addEventListener("click",function(f){"A"===f.target.nodeName&&execScript(f.target.getAttribute("data-href"))},!1);a=document.querySelectorAll("[data-href]");b=a.length;for(c=
0;c<b;c++){!1===a[c].classList.contains("notclickable")&&a[c].classList.add("clickable");var d=a[c].parentNode.classList.contains("noInitChilds")?!0:!1;!1===d&&(d=a[c].parentNode.parentNode.classList.contains("noInitChilds")?!0:!1);!0!==d&&a[c].addEventListener("click",function(f){parseCmd(f,this.getAttribute("data-href"))},!1)}document.getElementById("cardPlaybackTags").addEventListener("click",function(f){"P"===f.target.nodeName&&gotoBrowse(f)},!1);document.getElementById("tbodySongDetails").addEventListener("click",
function(f){if("A"===f.target.nodeName)if("calcFingerprint"===f.target.id){sendAPI("MPD_API_DATABASE_FINGERPRINT",{uri:decodeURI(f.target.getAttribute("data-uri"))},parseFingerprint);f.preventDefault();var h=f.target.parentNode,k=document.createElement("div");k.classList.add("spinner-border","spinner-border-sm");f.target.classList.add("hide");h.appendChild(k)}else f.target.classList.contains("external")||null===f.target.parentNode.getAttribute("data-tag")||(modalSongDetails.hide(),f.preventDefault(),
gotoBrowse(f));else"BUTTON"===f.target.nodeName&&f.target.getAttribute("data-href")&&parseCmd(f,f.target.getAttribute("data-href"))},!1);document.getElementById("outputs").addEventListener("click",function(f){"BUTTON"===f.target.nodeName?(f.stopPropagation(),f.preventDefault(),sendAPI("MPD_API_PLAYER_TOGGLE_OUTPUT",{output:f.target.getAttribute("data-output-id"),state:f.target.classList.contains("active")?0:1}),toggleBtn(f.target.id)):"A"===f.target.nodeName&&(f.preventDefault(),showListOutputAttributes(decodeURI(f.target.parentNode.getAttribute("data-output-name"))))},
!1);a=["PlaybackColsDropdown"];for(b=0;b<a.length;b++)document.getElementById(a[b]).addEventListener("click",function(f){"BUTTON"===f.target.nodeName&&f.target.classList.contains("material-icons")&&(f.stopPropagation(),f.preventDefault(),toggleBtnChk(f.target))},!1);a=["search","searchqueue","searchdatabase"];for(b=0;b<a.length;b++)document.getElementById(a[b]).addEventListener("submit",function(f){f.preventDefault()},!1);document.getElementsByTagName("body")[0].addEventListener("click",function(){hideMenu()},
!1);initHome();initBrowse();initQueue();initSearch();initScripts();initTrigger();initTimer();initPartitions();initMounts();initSettings();dragAndDropTable("QueueCurrentList");dragAndDropTable("BrowsePlaylistsDetailList");dragAndDropTableHeader("QueueCurrent");dragAndDropTableHeader("QueueLastPlayed");dragAndDropTableHeader("QueueJukebox");dragAndDropTableHeader("Search");dragAndDropTableHeader("BrowseFilesystem");dragAndDropTableHeader("BrowsePlaylistsDetail");dragAndDropTableHeader("BrowseDatabaseDetail");
window.addEventListener("focus",function(){sendAPI("MPD_API_PLAYER_STATE",{},parseState)},!1);document.addEventListener("keydown",function(f){if("INPUT"!==f.target.tagName&&"SELECT"!==f.target.tagName&&"TEXTAREA"!==f.target.tagName&&!f.ctrlKey&&!f.altKey){var h=keymap[f.key];h&&"function"===typeof window[h.cmd]&&(void 0===keymap[f.key].req||!0===settings[keymap[f.key].req])&&parseCmd(f,h)}},!1);a=document.getElementsByTagName("table");for(b=0;b<a.length;b++)a[b].setAttribute("tabindex",0),a[b].addEventListener("keydown",
function(f){navigateTable(this,f.key)},!1);var g="";Object.keys(themes).forEach(function(f){g+='<option value="'+e(f)+'">'+t(themes[f])+"</option>"});document.getElementById("selectTheme").innerHTML=g;window.addEventListener("beforeunload",function(){webSocketClose()});document.getElementById("alertLocalPlayback").getElementsByTagName("a")[0].addEventListener("click",function(f){f.stopPropagation();f.preventDefault();clickCheckLocalPlayerState(f)},!1);document.getElementById("errorLocalPlayback").getElementsByTagName("a")[0].addEventListener("click",
function(f){f.stopPropagation();f.preventDefault();clickCheckLocalPlayerState(f)},!1);document.getElementById("localPlayer").addEventListener("click",function(f){f.stopPropagation()});document.getElementById("localPlayer").addEventListener("canplay",function(){logDebug("localPlayer event: canplay");document.getElementById("alertLocalPlayback").classList.add("hide");document.getElementById("errorLocalPlayback").classList.add("hide")});document.getElementById("localPlayer").addEventListener("error",
...
function showNotification(a,b,c,d){if("No current song"!==a&&"No lyrics found"!==a){if(!0===settings.notificationWeb){var g=new Notification(a,{icon:"assets/favicon.ico",body:b});setTimeout(g.close.bind(g),3E3)}if(!0===settings.notificationPage||"danger"===d||"warning"===d){alertTimeout&&clearTimeout(alertTimeout);document.getElementById("alertBox")?g=document.getElementById("alertBox"):(g=document.createElement("div"),g.setAttribute("id","alertBox"),g.classList.add("toast"));var f='<div class="toast-header">';
f=("success"===d?f+'<span class="material-icons text-success mr-2">info</span>':"warning"===d?f+'<span class="material-icons text-warning mr-2">warning</span>':f+'<span class="material-icons text-danger mr-2">error</span>')+('<strong class="mr-auto">'+e(a)+'</strong><button type="button" class="ml-2 mb-1 close">&times;</button></div>');if(""!==c||""!==b)f+='<div class="toast-body">'+(""===c?e(b):c)+"</div>";g.innerHTML=f+"</div>";document.getElementById("alertBox")||(document.getElementsByTagName("main")[0].append(g),
requestAnimationFrame(function(){var h=document.getElementById("alertBox");h&&h.classList.add("alertBoxActive")}));g.getElementsByTagName("button")[0].addEventListener("click",function(){hideNotification()},!1);alertTimeout=setTimeout(function(){hideNotification()},3E3)}setStateIcon();logMessage(a,b,c,d)}}
function logMessage(a,b,c,d){"success"===d?d="Info":"warning"===d?d="Warning":"danger"===d&&(d="Error");var g=document.getElementById("logOverview"),f=!0,h=g.firstElementChild;h&&h.getAttribute("data-title")===a&&(f=!1);var k=document.createElement("div");k.classList.add("text-light");k.setAttribute("data-title",a);var l=1;!1===f&&(l+=parseInt(h.getAttribute("data-occurence")));k.setAttribute("data-occurence",l);k.innerHTML="<small>"+localeDate()+"&nbsp;&ndash;&nbsp;"+t(d)+(1<l?"&nbsp;("+l+")":"")+
"</small><p>"+e(a)+(""===c&&""===b?"":"<br/>"+(""===c?e(b):c))+"</p>";!0===f?g.insertBefore(k,g.firstElementChild):g.replaceChild(k,h);a=g.getElementsByTagName("div");10<a.length&&a[10].remove()}function clearLogOverview(){for(var a=document.getElementById("logOverview").getElementsByTagName("div"),b=a.length-1;0<=b;b--)a[b].remove();setStateIcon()}
...
function parsePartitionOutputsList(a){for(var b=document.getElementById("outputs").getElementsByTagName("button"),c=[],d=0;d<b.length;d++)c.push(parseInt(b[d].getAttribute("data-output-id")));b="";for(var g=d=0;g<a.result.data.length;g++)!1===c.includes(a.result.data[g].id)&&(b+='<tr data-output="'+encodeURI(a.result.data[g].name)+'"><td>'+e(a.result.data[g].name)+"</td></tr>",d++);0===d&&(b='<tr class="not-clickable"><td><span class="material-icons">error_outline</span>&nbsp;'+t("Empty list")+"</td></tr>");
...
document.getElementById("btnAddSmartpls").parentNode.classList.add("hide"),document.getElementById("BrowseNavPlaylists").parentNode.classList.add("hide"));var b=a.result.returnedEntities,c=document.getElementById(app.current.app+app.current.tab+app.current.view+"List"),d=c.getElementsByTagName("tbody")[0],g=d.getElementsByTagName("tr"),f=document.activeElement.parentNode.parentNode===c?!0:!1,h=0;if("All"===app.current.view)for(c=0;c<b;c++){var k=encodeURI(a.result.data[c].uri),l=document.createElement("tr");
l.setAttribute("data-uri",k);l.setAttribute("data-type",a.result.data[c].Type);l.setAttribute("data-name",a.result.data[c].name);l.setAttribute("tabindex",0);l.innerHTML='<td data-col="Type"><span class="material-icons">'+("smartpls"===a.result.data[c].Type?"queue_music":"list")+"</span></td><td>"+e(a.result.data[c].name)+"</td><td>"+localeDate(a.result.data[c].last_modified)+'</td><td data-col="Action"><a href="#" class="material-icons color-darkgrey">'+ligatureMore+"</a></td>";c<g.length?h=!0===
replaceTblRow(g[c],l)?c:h:d.append(l)}else if("Detail"===app.current.view){for(k=0;k<b;k++){var m=encodeURI(a.result.data[k].uri);l=document.createElement("tr");!1===a.result.smartpls&&l.setAttribute("draggable","true");l.setAttribute("id","playlistTrackId"+a.result.data[k].Pos);l.setAttribute("data-type",a.result.data[k].Type);l.setAttribute("data-uri",m);l.setAttribute("data-name",a.result.data[k].Title);l.setAttribute("data-songpos",a.result.data[k].Pos);l.setAttribute("tabindex",0);a.result.data[k].Duration=
beautifySongDuration(a.result.data[k].Duration);m="";for(var n=0;n<settings.colsBrowsePlaylistsDetail.length;n++)m+='<td data-col="'+settings.colsBrowsePlaylistsDetail[n]+'">'+e(a.result.data[k][settings.colsBrowsePlaylistsDetail[n]])+"</td>";m+='<td data-col="Action"><a href="#" class="material-icons color-darkgrey">'+ligatureMore+"</a></td>";l.innerHTML=m;k<g.length?h=!0===replaceTblRow(g[k],l)?k:h:d.append(l)}h=c.getElementsByTagName("tfoot")[0];c=settings.colsBrowsePlaylistsDetail.length;c++;
h.innerHTML='<tr><td colspan="'+(c+1)+'"><small>'+t("Num songs",a.result.totalEntities)+"&nbsp;&ndash;&nbsp;"+beautifyDuration(a.result.totalTime)+"</small></td></tr>"}for(h=g.length-1;h>=b;h--)g[h].remove();!0===f&&focusTable(0);setPagination(a.result.totalEntities,a.result.returnedEntities);0===b&&(d.innerHTML="All"===app.current.view?'<tr class="not-clickable"><td><span class="material-icons">error_outline</span></td><td colspan="3">'+t("No playlists found")+"</td></tr>":'<tr class="not-clickable"><td><span class="material-icons">error_outline</span></td><td colspan="'+
settings.colsBrowsePlaylistsDetail.length+'">'+t("Empty playlist")+"</td></tr>");document.getElementById(app.current.app+app.current.tab+app.current.view+"List").classList.remove("opacity05")}function playlistDetails(a){document.getElementById("BrowsePlaylistsAllList").classList.add("opacity05");appGoto("Browse","Playlists","Detail","0",void 0,a,"-","-","")}
...
function getAllPlaylists(a,b,c){var d=a.result.returnedEntities,g="";if("addToPlaylistPlaylist"===b)g='<option value=""></option><option value="new">'+t("New playlist")+"</option>";else if("selectJukeboxPlaylist"===b||"selectAddToQueuePlaylist"===b||"selectTimerPlaylist"===b)g='<option value="Database">'+t("Database")+"</option>";for(var f=0;f<d;f++)if("addToPlaylistPlaylist"!==b||"smartpls"!==a.result.data[f].Type)g+='<option value="'+e(a.result.data[f].uri)+'"',null!==c&&a.result.data[f].uri===
c&&(g+=" selected"),g+=">"+e(a.result.data[f].uri)+"</option>";document.getElementById(b).innerHTML=g}function updateSmartPlaylists(a){sendAPI("MPDWORKER_API_SMARTPLS_UPDATE_ALL",{force:a})}function removeFromPlaylist(a,b){b--;sendAPI("MPD_API_PLAYLIST_RM_TRACK",{uri:a,track:b});document.getElementById("BrowsePlaylistsDetailList").classList.add("opacity05")}
...
function parseSmartPlaylist(a){var b=document.getElementById("saveSmartPlaylistName");b.value=a.result.playlist;removeIsInvalid(document.getElementById("modalSaveSmartPlaylist"));document.getElementById("saveSmartPlaylistType").value=t(a.result.type);document.getElementById("saveSmartPlaylistType").setAttribute("data-value",a.result.type);document.getElementById("saveSmartPlaylistSearch").classList.add("hide");document.getElementById("saveSmartPlaylistSticker").classList.add("hide");document.getElementById("saveSmartPlaylistNewest").classList.add("hide");
...
function saveSmartPlaylist(){var a=document.getElementById("saveSmartPlaylistName").value,b=document.getElementById("saveSmartPlaylistType").getAttribute("data-value"),c=document.getElementById("saveSmartPlaylistSort");c=c.options[c.selectedIndex].value;if(!0===validatePlname(a)){if("search"===b){var d=document.getElementById("selectSaveSmartPlaylistTag");d=d.options[d.selectedIndex].value;var g=document.getElementById("inputSaveSmartPlaylistSearchstr").value;sendAPI("MPD_API_SMARTPLS_SAVE",{type:b,
playlist:a,tag:d,searchstr:g,sort:c})}else if("sticker"===b){d=document.getElementById("selectSaveSmartPlaylistSticker");d=d.options[d.selectedIndex].value;g=document.getElementById("inputSaveSmartPlaylistStickerMaxentries");if(!validateInt(g))return;var f=document.getElementById("inputSaveSmartPlaylistStickerMinvalue");if(!validateInt(f))return;sendAPI("MPD_API_SMARTPLS_SAVE",{type:b,playlist:a,sticker:d,maxentries:parseInt(g.value),minvalue:parseInt(f.value),sort:c})}else if("newest"===b){d=document.getElementById("inputSaveSmartPlaylistNewestTimerange");
...
content:" "});c=a.Popover;null===a.getAttribute("data-init")&&(a.setAttribute("data-init","true"),a.addEventListener("shown.bs.popover",function(d){d.target.setAttribute("data-popover","true");document.getElementById("colChecklist"+b).addEventListener("click",function(g){"BUTTON"===g.target.nodeName&&g.target.classList.contains("material-icons")?(toggleBtnChk(g.target),g.preventDefault(),g.stopPropagation()):"BUTTON"===g.target.nodeName&&(g.preventDefault(),saveCols(b))},!1)},!1));c.show()}
function showMenuTd(a){var b=a.getAttribute("data-type"),c=decodeURI(a.getAttribute("data-uri")),d=decodeURI(a.getAttribute("data-name")),g=0;if(null===b||""===c)b=a.parentNode.getAttribute("data-type"),c=decodeURI(a.parentNode.getAttribute("data-uri")),d=a.parentNode.getAttribute("data-name");if(null===b||""===c)b=a.parentNode.parentNode.getAttribute("data-type"),c=decodeURI(a.parentNode.parentNode.getAttribute("data-uri")),d=a.parentNode.parentNode.getAttribute("data-name");lastState&&(g=lastState.nextSongPos);
var f="";if("Browse"===app.current.app&&"Filesystem"===app.current.tab||"Search"===app.current.app||"Browse"===app.current.app&&"Database"===app.current.tab&&"Detail"===app.current.view){if(f+=addMenuItem({cmd:"appendQueue",options:[b,c,d]},t("Append to queue"))+("song"===b?addMenuItem({cmd:"appendAfterQueue",options:[b,c,g,d]},t("Add after current playing song")):"")+addMenuItem({cmd:"replaceQueue",options:[b,c,d]},t("Replace queue"))+("plist"!==b&&"smartpls"!==b&&!0===settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",
options:[c,""]},t("Add to playlist")):"")+("song"===b?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):"")+("plist"===b||"smartpls"===b?addMenuItem({cmd:"playlistDetails",options:[c]},t("View playlist")):"")+("plist"!==b&&"smartpls"!==b||!0!==settings.featHome?"":addMenuItem({cmd:"addPlistToHome",options:[c,d]},t("Add to homescreen"))),"Filesystem"===app.current.tab&&(f+=("dir"===b&&settings.featBookmarks?addMenuItem({cmd:"showBookmarkSave",options:[-1,d,c,b]},t("Add bookmark")):"")+
("dir"===b?addMenuItem({cmd:"updateDB",options:[dirname(c),!0]},t("Update directory")):"")+("dir"===b?addMenuItem({cmd:"rescanDB",options:[dirname(c),!0]},t("Rescan directory")):"")),"Search"===app.current.app){var h=a.parentNode.parentNode;h.hasAttribute("data-album")&&h.hasAttribute("data-albumartist")?(b=decodeURI(h.getAttribute("data-album")),c=decodeURI(h.getAttribute("data-albumartist")),f+='<div class="dropdown-divider"></div><a class="dropdown-item" id="advancedMenuLink" data-toggle="collapse" href="#advancedMenu"><span class="material-icons material-icons-left">keyboard_arrow_right</span>Album actions</a><div class="collapse" id="advancedMenu">'+
addMenuItem({cmd:"_addAlbum",options:["appendQueue",c,b]},t("Append to queue"))+addMenuItem({cmd:"_addAlbum",options:["replaceQueue",c,b]},t("Replace queue"))+(!0===settings.featPlaylists?addMenuItem({cmd:"_addAlbum",options:["addPlaylist",c,b]},t("Add to playlist")):"")+"</div>"):(c=dirname(c),f+='<div class="dropdown-divider"></div><a class="dropdown-item" id="advancedMenuLink" data-toggle="collapse" href="#advancedMenu"><span class="material-icons material-icons-left">keyboard_arrow_right</span>Folder actions</a><div class="collapse" id="advancedMenu">'+
addMenuItem({cmd:"appendQueue",options:[b,c,d]},t("Append to queue"))+addMenuItem({cmd:"appendAfterQueue",options:[b,c,g,d]},t("Add after current playing song"))+addMenuItem({cmd:"replaceQueue",options:[b,c,d]},t("Replace queue"))+(!0===settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",options:[c,""]},t("Add to playlist")):"")+"</div>")}}else if("Browse"===app.current.app&&"Database"===app.current.tab&&"List"===app.current.view)b=decodeURI(a.parentNode.getAttribute("data-albumartist")),
c=decodeURI(a.parentNode.getAttribute("data-album")),f+=addMenuItem({cmd:"appGoto",options:["Browse","Database","Detail",0,void 0,"Album",tagAlbumArtist,c,b]},t("Show album"))+addMenuItem({cmd:"_addAlbum",options:["appendQueue",b,c]},t("Append to queue"))+addMenuItem({cmd:"_addAlbum",options:["replaceQueue",b,c]},t("Replace queue"))+(!0===settings.featPlaylists?addMenuItem({cmd:"_addAlbum",options:["addPlaylist",b,c]},t("Add to playlist")):"");else if("Browse"===app.current.app&&"Playlists"===app.current.tab&&
"All"===app.current.view)f+=addMenuItem({cmd:"appendQueue",options:[b,c,d]},t("Append to queue"))+addMenuItem({cmd:"replaceQueue",options:[b,c,d]},t("Replace queue"))+(!0===settings.smartpls&&"smartpls"===b?addMenuItem({cmd:"playlistDetails",options:[c]},t("View playlist")):addMenuItem({cmd:"playlistDetails",options:[c]},t("Edit playlist")))+(!0===settings.smartpls&&"smartpls"===b?addMenuItem({cmd:"showSmartPlaylist",options:[c]},t("Edit smart playlist")):"")+(!0===settings.smartpls&&"smartpls"===
b?addMenuItem({cmd:"updateSmartPlaylist",options:[c]},t("Update smart playlist")):"")+addMenuItem({cmd:"showRenamePlaylist",options:[c]},t("Rename playlist"))+addMenuItem({cmd:"showDelPlaylist",options:[c]},t("Delete playlist"))+(!0===settings.featHome?addMenuItem({cmd:"addPlistToHome",options:[c,d]},t("Add to homescreen")):"");else if("Browse"===app.current.app&&"Playlists"===app.current.tab&&"Detail"===app.current.view)g=document.getElementById("BrowsePlaylistsDetailList"),f+=addMenuItem({cmd:"appendQueue",
options:[b,c,d]},t("Append to queue"))+addMenuItem({cmd:"replaceQueue",options:[b,c,d]},t("Replace queue"))+("false"===g.getAttribute("data-ro")?addMenuItem({cmd:"removeFromPlaylist",options:[g.getAttribute("data-uri"),a.parentNode.parentNode.getAttribute("data-songpos")]},t("Remove")):"")+(settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",options:[c,""]},t("Add to playlist")):"")+(-1===c.indexOf("http")?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):"");else if("Queue"===
app.current.app&&"Current"===app.current.tab)b=parseInt(a.parentNode.parentNode.getAttribute("data-trackid")),f+=(b!==lastState.currentSongId?addMenuItem({cmd:"playAfterCurrent",options:[b,a.parentNode.parentNode.getAttribute("data-songpos")]},t("Play after current playing song")):"")+addMenuItem({cmd:"delQueueSong",options:["single",b]},t("Remove"))+addMenuItem({cmd:"delQueueSong",options:["range",0,a.parentNode.parentNode.getAttribute("data-songpos")]},t("Remove all upwards"))+addMenuItem({cmd:"delQueueSong",
options:["range",parseInt(a.parentNode.parentNode.getAttribute("data-songpos"))-1,-1]},t("Remove all downwards"))+(-1===c.indexOf("http")?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):"");else if("Queue"===app.current.app&&"LastPlayed"===app.current.tab)f+=addMenuItem({cmd:"appendQueue",options:[b,c,d]},t("Append to queue"))+addMenuItem({cmd:"replaceQueue",options:[b,c,d]},t("Replace queue"))+(settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",options:[c,""]},t("Add to playlist")):
"")+(-1===c.indexOf("http")?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):"");else if("Queue"===app.current.app&&"Jukebox"===app.current.tab)f+=addMenuItem({cmd:"songDetails",options:[c]},t("Song details"))+addMenuItem({cmd:"delQueueJukeboxSong",options:[a.parentNode.parentNode.getAttribute("data-pos")]},t("Remove"));else if("Home"===app.current.app){g=parseInt(a.parentNode.getAttribute("data-pos"));h=JSON.parse(a.parentNode.getAttribute("data-href"));var k="";"replaceQueue"===h.cmd&&
"plist"===h.options[0]?(b="plist",c=h.options[1],k=t("Add and play playlist"),d=t("Playlist")):"appGoto"===h.cmd?(b="view",k=t("Goto view"),d=t("View")):"execScriptFromOptions"===h.cmd&&(b="script",k=t("Execute script"),d=t("Script"));f+='<h6 class="dropdown-header">'+d+"</h6>"+addMenuItem({cmd:"executeHomeIcon",options:[g]},k)+("plist"===b?addMenuItem({cmd:"playlistDetails",options:[c]},t("View playlist")):"")+addMenuItem({cmd:"editHomeIcon",options:[g]},t("Edit home icon"))+addMenuItem({cmd:"duplicateHomeIcon",
options:[g]},t("Duplicate home icon"))+addMenuItem({cmd:"deleteHomeIcon",options:[g]},t("Delete home icon"))}new BSN.Popover(a,{trigger:"click",delay:0,dismissible:!0,template:'<div class="popover" role="tooltip"><div class="arrow"></div><div class="popover-content">'+f+"</div></div>",content:" "});f=a.Popover;null===a.getAttribute("data-init")&&(a.setAttribute("data-init","true"),a.addEventListener("shown.bs.popover",function(l){l.target.setAttribute("data-popover","true");document.getElementsByClassName("popover-content")[0].addEventListener("click",
function(n){n.preventDefault();n.stopPropagation();"A"===n.target.nodeName&&(n=n.target.getAttribute("data-href"))&&(n=JSON.parse(b64DecodeUnicode(n)),parseCmd(l,n),hideMenu())},!1);document.getElementsByClassName("popover-content")[0].addEventListener("keydown",function(n){n.preventDefault();n.stopPropagation();if("ArrowDown"===n.key||"ArrowUp"===n.key){var p=this.getElementsByTagName("a");p=Array.prototype.slice.call(p);var q=p.indexOf(document.activeElement);do if(q="ArrowUp"===n.key?1<q?q-1:0:
"ArrowDown"===n.key?q<p.length-1?q+1:q:q,0===q||q===p.length-1)break;while(!p[q].offsetHeight);p[q]&&p[q].focus()}else"Enter"===n.key?n.target.click():"Escape"===n.key&&hideMenu()},!1);var m=document.getElementById("advancedMenuLink");m&&(m.addEventListener("click",function(){var n=this.getElementsByTagName("span")[0];n.innerText="keyboard_arrow_right"===n.innerText?"keyboard_arrow_down":"keyboard_arrow_right"},!1),new BSN.Collapse(m));document.getElementsByClassName("popover-content")[0].firstChild.focus()},
!1));f.show()}
function initQueue(){document.getElementById("searchqueuestr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.limit,app.current.filter,app.current.sort,"-",this.value)},!1);document.getElementById("searchqueuetags").addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&appGoto(app.current.app,app.current.tab,app.current.view,app.current.offset,app.current.limit,a.target.getAttribute("data-tag"),app.current.sort,
"-",app.current.search)},!1);document.getElementById("QueueCurrentList").addEventListener("click",function(a){"TD"===a.target.nodeName?sendAPI("MPD_API_PLAYER_PLAY_TRACK",{track:a.target.parentNode.getAttribute("data-trackid")}):"A"===a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("QueueLastPlayedList").addEventListener("click",function(a){"A"===a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("QueueJukeboxList").addEventListener("click",function(a){"A"===
a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("selectAddToQueueMode").addEventListener("change",function(){var a=this.options[this.selectedIndex].value;"2"===a?(document.getElementById("inputAddToQueueQuantity").setAttribute("disabled","disabled"),document.getElementById("inputAddToQueueQuantity").value="1",document.getElementById("selectAddToQueuePlaylist").setAttribute("disabled","disabled"),document.getElementById("selectAddToQueuePlaylist").value="Database"):"1"===a&&(document.getElementById("inputAddToQueueQuantity").removeAttribute("disabled"),
document.getElementById("selectAddToQueuePlaylist").removeAttribute("disabled"))});document.getElementById("modalAddToQueue").addEventListener("shown.bs.modal",function(){removeIsInvalid(document.getElementById("modalAddToQueue"));document.getElementById("warnJukeboxPlaylist2").classList.add("hide");!0===settings.featPlaylists&&sendAPI("MPD_API_PLAYLIST_LIST",{searchstr:"",offset:0,limit:0},function(a){getAllPlaylists(a,"selectAddToQueuePlaylist")})});document.getElementById("modalSaveQueue").addEventListener("shown.bs.modal",
function(){var a=document.getElementById("saveQueueName");a.focus();a.value="";removeIsInvalid(document.getElementById("modalSaveQueue"))})}
...
(d+1)+'"><small>'+t("Num songs",a.result.totalEntities)+"</small></td></tr>":"";a.result.totalEntities>settings.maxElementsPerPage?document.getElementById("btnQueueGotoPlayingSong").parentNode.classList.remove("hide"):document.getElementById("btnQueueGotoPlayingSong").parentNode.classList.add("hide");c=a.result.returnedEntities;var g=document.activeElement.parentNode.parentNode===b?!0:!1,f=0;b.setAttribute("data-version",a.result.queueVersion);b=b.getElementsByTagName("tbody")[0];for(var h=b.getElementsByTagName("tr"),
k=0;k<c;k++){a.result.data[k].Duration=beautifySongDuration(a.result.data[k].Duration);a.result.data[k].Pos++;var l=document.createElement("tr");l.setAttribute("draggable","true");l.setAttribute("data-trackid",a.result.data[k].id);l.setAttribute("id","queueTrackId"+a.result.data[k].id);l.setAttribute("data-songpos",a.result.data[k].Pos);l.setAttribute("data-duration",a.result.data[k].Duration);l.setAttribute("data-uri",a.result.data[k].uri);l.setAttribute("tabindex",0);for(var m="",n=0;n<settings.colsQueueCurrent.length;n++)m+=
'<td data-col="'+settings.colsQueueCurrent[n]+'">'+e(a.result.data[k][settings.colsQueueCurrent[n]])+"</td>";m+='<td data-col="Action"><a href="#" class="material-icons color-darkgrey">'+ligatureMore+"</a></td>";l.innerHTML=m;k<h.length?f=!0===replaceTblRow(h[k],l)?k:f:b.append(l)}for(k=h.length-1;k>=c;k--)h[k].remove();"MPD_API_QUEUE_SEARCH"===a.result.method&&0===c?b.innerHTML='<tr><td><span class="material-icons">error_outline</span></td><td colspan="'+d+'">'+t("No results, please refine your search")+
"</td></tr>":"MPD_API_QUEUE_LIST"===a.result.method&&0===c&&(b.innerHTML='<tr><td><span class="material-icons">error_outline</span></td><td colspan="'+d+'">'+t("Empty queue")+"</td></tr>");!0===g&&focusTable(f);setPagination(a.result.totalEntities,a.result.returnedEntities);document.getElementById("QueueCurrentList").classList.remove("opacity05")}}
...
a.result.data[h].Title);k.setAttribute("data-type","song");k.setAttribute("tabindex",0);for(var l="",m=0;m<settings.colsQueueLastPlayed.length;m++)l+='<td data-col="'+settings.colsQueueLastPlayed[m]+'">'+e(a.result.data[h][settings.colsQueueLastPlayed[m]])+"</td>";l+='<td data-col="Action">';""!==a.result.data[h].uri&&(l+='<a href="#" class="material-icons color-darkgrey">'+ligatureMore+"</a>");l+="</td>";k.innerHTML=l;h<f.length?g=!0===replaceTblRow(f[h],k)?h:g:c.append(k)}for(h=f.length-1;h>=b;h--)f[h].remove();
f=settings.colsQueueLastPlayed.length;0===b&&(c.innerHTML='<tr><td><span class="material-icons">error_outline</span></td><td colspan="'+f+'">'+t("Empty list")+"</td></tr>");!0===d&&focusTable(g);setPagination(a.result.totalEntities,a.result.returnedEntities);document.getElementById("QueueLastPlayedList").classList.remove("opacity05")}
...
""===a.target.parentNode.getAttribute("data-script"))return!1;showEditScript(decodeURI(a.target.parentNode.getAttribute("data-script")))}else if("A"===a.target.nodeName){var b=a.target.getAttribute("data-action"),c=decodeURI(a.target.parentNode.parentNode.getAttribute("data-script"));"delete"===b?deleteScript(c):"execute"===b?execScript(a.target.getAttribute("data-href")):"add2home"===b&&addScriptToHome(c,a.target.getAttribute("data-href"))}},!1);document.getElementById("modalScripts").addEventListener("shown.bs.modal",
function(){showListScripts()})}
function saveScript(){var a=!0,b=document.getElementById("inputScriptName");validatePlnameEl(b)||(a=!1);var c=document.getElementById("inputScriptOrder");validateInt(c)||(a=!1);if(!0===a){a=[];for(var d=document.getElementById("selectScriptArguments"),g=0;g<d.options.length;g++)a.push(d.options[g].text);sendAPI("MYMPD_API_SCRIPT_SAVE",{oldscript:document.getElementById("inputOldScriptName").value,script:b.value,order:parseInt(c.value),content:document.getElementById("textareaScriptContent").value,arguments:a},
showListScripts,!1)}}function addScriptArgument(){var a=document.getElementById("inputScriptArgument");if(validatePlnameEl(a)){var b=document.createElement("option");b.text=a.value;document.getElementById("selectScriptArguments").appendChild(b);a.value=""}}function removeScriptArgument(a){var b=document.getElementById("inputScriptArgument");b.value=a.target.text;a.target.remove();b.focus()}
...
function parseScriptList(a){var b=document.createElement("optgroup");b.setAttribute("data-value","script");b.setAttribute("label",t("Script"));var c="",d="",g=a.result.data.length,f=0;if(0<g){a.result.data.sort(function(l,m){return l.metadata.order-m.metadata.order});for(var h=0;h<g;h++){var k="";if(0<a.result.data[h].metadata.arguments.length){for(k=0;k<a.result.data[h].metadata.arguments.length;k++)a.result.data[h].metadata.arguments[k]=e(a.result.data[h].metadata.arguments[k]);k='"'+a.result.data[h].metadata.arguments.join('","')+
'"'}0<a.result.data[h].metadata.order&&(f++,c+='<a class="dropdown-item text-light alwaysEnabled" href="#" data-href=\'{"script": "'+e(a.result.data[h].name)+'", "arguments": ['+k+"]}'>"+e(a.result.data[h].name)+"</a>");d+='<tr data-script="'+encodeURI(a.result.data[h].name)+'"><td>'+e(a.result.data[h].name)+'</td><td data-col="Action">'+(!0===settings.featScripteditor?'<a href="#" title="'+t("Delete")+'" data-action="delete" class="material-icons color-darkgrey">delete</a>':"")+'<a href="#" title="'+
t("Execute")+'" data-action="execute" class="material-icons color-darkgrey"  data-href=\'{"script": "'+e(a.result.data[h].name)+'", "arguments": ['+k+']}\'>play_arrow</a><a href="#" title="'+t("Add to homescreen")+'" data-action="add2home" class="material-icons color-darkgrey"  data-href=\'{"script": "'+e(a.result.data[h].name)+'", "arguments": ['+k+"]}'>add_to_home_screen</a></td></tr>";b.innerHTML+='<option data-arguments=\'{"arguments":['+k+"]}' value=\""+e(a.result.data[h].name)+'">'+e(a.result.data[h].name)+
"</option>"}document.getElementById("listScriptsList").innerHTML=d}else document.getElementById("listScriptsList").innerHTML='<tr class="not-clickable"><td><span class="material-icons">error_outline</span></td><td colspan="2">'+t("Empty list")+"</td></tr>";document.getElementById("scripts").innerHTML=(4<f||0===f?"":'<div class="dropdown-divider"></div>')+c;4<f?(document.getElementById("navScripting").classList.remove("hide"),document.getElementById("scripts").classList.add("collapse","menu-indent")):
...
function initSearch(){document.getElementById("SearchList").addEventListener("click",function(a){"TD"===a.target.nodeName?appendQueue("song",decodeURI(a.target.parentNode.getAttribute("data-uri")),a.target.parentNode.getAttribute("data-name")):"A"===a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("searchtags").addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&(app.current.filter=a.target.getAttribute("data-tag"),doSearch(domCache.searchstr.value))},!1);domCache.searchstr.addEventListener("keyup",
function(a){if("Escape"===a.key)this.blur();else if("Enter"===a.key&&settings.featAdvsearch)if(""!==this.value){a=document.getElementById("searchMatch");var b=document.createElement("button");b.classList.add("btn","btn-light","mr-2");b.setAttribute("data-filter-tag",encodeURI(app.current.filter));b.setAttribute("data-filter-op",encodeURI(a.options[a.selectedIndex].value));b.setAttribute("data-filter-value",encodeURI(this.value));b.innerHTML=e(app.current.filter)+" "+e(a.options[a.selectedIndex].value)+
" '"+e(this.value)+'\'<span class="ml-2 badge badge-secondary">&times;</span>';this.value="";domCache.searchCrumb.appendChild(b)}else doSearch(this.value);else doSearch(this.value)},!1);domCache.searchCrumb.addEventListener("click",function(a){"SPAN"===a.target.nodeName?(a.preventDefault(),a.stopPropagation(),a.target.parentNode.remove(),doSearch("")):"BUTTON"===a.target.nodeName&&(a.preventDefault(),a.stopPropagation(),domCache.searchstr.value=unescapeMPD(decodeURI(a.target.getAttribute("data-filter-value"))),
selectTag("searchtags","searchtagsdesc",decodeURI(a.target.getAttribute("data-filter-tag"))),document.getElementById("searchMatch").value=decodeURI(a.target.getAttribute("data-filter-op")),a.target.remove(),doSearch(domCache.searchstr.value))},!1);document.getElementById("searchMatch").addEventListener("change",function(){doSearch(domCache.searchstr.value)},!1);document.getElementById("SearchList").getElementsByTagName("tr")[0].addEventListener("click",function(a){if(settings.featAdvsearch&&"TH"===
a.target.nodeName&&""!==a.target.innerHTML){var b=a.target.getAttribute("data-col");if("Duration"!==b){var c=app.current.sort,d=!0;if(c===b||c==="-"+b)0===c.indexOf("-")?(d=!0,b=c.substring(1)):d=!1;!1===d?(c="-"+b,d=!0):(d=!1,c=b);for(var g=document.getElementById("SearchList").getElementsByClassName("sort-dir"),f=0;f<g.length;f++)g[f].remove();app.current.sort=c;a.target.innerHTML=t(b)+'<span class="sort-dir material-icons pull-right">'+(!0===d?"arrow_drop_up":"arrow_drop_down")+"</span>";appGoto(app.current.app,
app.current.tab,app.current.view,app.current.offset,app.current.limit,app.current.filter,app.current.sort,"-",app.current.search)}}},!1)}
function doSearch(a){if(settings.featAdvsearch){for(var b="(",c=domCache.searchCrumb.children,d=0;d<c.length;d++)b+="("+decodeURI(c[d].getAttribute("data-filter-tag"))+" "+decodeURI(c[d].getAttribute("data-filter-op"))+" '"+escapeMPD(decodeURI(c[d].getAttribute("data-filter-value")))+"')",""!==a&&(b+=" AND ");""!==a?(c=document.getElementById("searchMatch"),b+="("+app.current.filter+" "+c.options[c.selectedIndex].value+" '"+escapeMPD(a)+"'))"):b+=")";2>=b.length&&(b="");appGoto("Search",void 0,void 0,
...
function initSettings(){document.getElementById("selectTheme").addEventListener("change",function(){var a=getSelectValue(this);"theme-default"===a?document.getElementById("inputBgColor").value="#ccc":"theme-light"===a?document.getElementById("inputBgColor").value="#fff":"theme-dark"===a&&(document.getElementById("inputBgColor").value="#000")},!1);document.getElementById("selectMusicDirectory").addEventListener("change",function(){"auto"===this.options[this.selectedIndex].value?(document.getElementById("inputMusicDirectory").value=
settings.musicDirectoryValue,document.getElementById("inputMusicDirectory").setAttribute("readonly","readonly")):"none"===this.options[this.selectedIndex].value?(document.getElementById("inputMusicDirectory").value="",document.getElementById("inputMusicDirectory").setAttribute("readonly","readonly")):(document.getElementById("inputMusicDirectory").value="",document.getElementById("inputMusicDirectory").removeAttribute("readonly"))},!1);document.getElementById("modalSettings").addEventListener("shown.bs.modal",
function(){getSettings();removeIsInvalid(document.getElementById("modalSettings"))});document.getElementById("modalConnection").addEventListener("shown.bs.modal",function(){getSettings();removeIsInvalid(document.getElementById("modalConnection"))});document.getElementById("btnJukeboxModeGroup").addEventListener("mouseup",function(){setTimeout(function(){var a=document.getElementById("btnJukeboxModeGroup").getElementsByClassName("active")[0].getAttribute("data-value");"0"===a?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled",
...
(document.getElementById("warnPlaybackStatistics").classList.remove("hide"),document.getElementById("inputJukeboxLastPlayed").setAttribute("disabled","disabled"))},100)})}
function saveConnection(){var a=!0,b=document.getElementById("inputMpdHost"),c=document.getElementById("inputMpdPort"),d=document.getElementById("inputMpdPass"),g=document.getElementById("selectMusicDirectory");g=g.options[g.selectedIndex].value;"custom"===g&&(g=document.getElementById("inputMusicDirectory"),validatePath(g)||(a=!1),g=g.value);""===c.value&&(c.value="6600");0!==b.value.indexOf("/")&&(validateInt(c)||(a=!1),validateHost(b)||(a=!1));!0===a&&(sendAPI("MYMPD_API_CONNECTION_SAVE",{mpdHost:b.value,
mpdPort:c.value,mpdPass:d.value,musicDirectory:g},getSettings),modalConnection.hide())}function getSettings(a){!1===settingsLock&&(settingsLock=!0,sendAPI("MYMPD_API_SETTINGS_GET",{},getMpdSettings,a))}
...
toggleBtnChkCollapse("btnSmartpls","collapseSmartpls",settings.smartpls);b="featLocalplayer featSyscmds featMixramp featCacert featBookmarks featRegex featTimer featLyrics featScripting featScripteditor featHome".split(" ");for(c=0;c<b.length;c++)for(var d=document.getElementsByClassName(b[c]),g=d.length,f=!0===settings[b[c]]?"":"none",h=0;h<g;h++)d[h].style.display=f;b=document.getElementsByClassName("warnReadonly");for(c=0;c<b.length;c++)!1===settings.readonly?b[c].classList.add("hide"):b[c].classList.remove("hide");
!0===settings.readonly?(document.getElementById("btnBookmarks").setAttribute("disabled","disabled"),document.getElementsByClassName("groupClearCovercache")[0].classList.add("hide")):(document.getElementById("btnBookmarks").removeAttribute("disabled"),document.getElementsByClassName("groupClearCovercache")[0].classList.remove("hide"));b='<optgroup data-value="player" label="'+t("Playback")+'"><option value="startplay">'+t("Start playback")+'</option><option value="stopplay">'+t("Stop playback")+"</option></optgroup>";
if(!0===settings.featSyscmds){c="";d=settings.syscmdList.length;if(0<d)for(b+='<optgroup data-value="syscmd" label="'+t("System command")+'">',c=4<d?"":'<div class="dropdown-divider"></div>',g=0;g<d;g++)"HR"===settings.syscmdList[g]?c+='<div class="dropdown-divider"></div>':(c+='<a class="dropdown-item text-light alwaysEnabled" href="#" data-href=\'{"cmd": "execSyscmd", "options": ["'+e(settings.syscmdList[g])+"\"]}'>"+e(settings.syscmdList[g])+"</a>",b+='<option value="'+e(settings.syscmdList[g])+
'">'+e(settings.syscmdList[g])+"</option>");document.getElementById("syscmds").innerHTML=c;b+="</optgroup>";4<d?(document.getElementById("navSyscmds").classList.remove("hide"),document.getElementById("syscmds").classList.add("collapse","menu-indent")):(document.getElementById("navSyscmds").classList.add("hide"),document.getElementById("syscmds").classList.remove("collapse","menu-indent"))}else document.getElementById("syscmds").innerHTML="";!0===settings.featScripting?getScriptList(!0):document.getElementById("scripts").innerHTML=
"";document.getElementById("selectTimerAction").innerHTML=b;toggleBtnGroupValueCollapse(document.getElementById("btnJukeboxModeGroup"),"collapseJukeboxMode",settings.jukeboxMode);document.getElementById("selectJukeboxUniqueTag").value=settings.jukeboxUniqueTag;document.getElementById("inputJukeboxQueueLength").value=settings.jukeboxQueueLength;document.getElementById("inputJukeboxLastPlayed").value=settings.jukeboxLastPlayed;0===settings.jukeboxMode?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled",
...
document.getElementById("inputSmartplsPrefix").value=settings.smartplsPrefix;document.getElementById("inputSmartplsInterval").value=settings.smartplsInterval/60/60;document.getElementById("selectSmartplsSort").value=settings.smartplsSort;domCache.volumeBar.setAttribute("min",settings.volumeMin);domCache.volumeBar.setAttribute("max",settings.volumeMax);!0===settings.featLocalplayer&&setLocalPlayerUrl();"auto"===settings.musicDirectory?(document.getElementById("selectMusicDirectory").value=settings.musicDirectory,
document.getElementById("inputMusicDirectory").value=void 0!==settings.musicDirectoryValue?settings.musicDirectoryValue:"",document.getElementById("inputMusicDirectory").setAttribute("readonly","readonly")):"none"===settings.musicDirectory?(document.getElementById("selectMusicDirectory").value=settings.musicDirectory,document.getElementById("inputMusicDirectory").value="",document.getElementById("inputMusicDirectory").setAttribute("readonly","readonly")):(document.getElementById("selectMusicDirectory").value=
"custom",document.getElementById("inputMusicDirectory").value=settings.musicDirectoryValue,document.getElementById("inputMusicDirectory").removeAttribute("readonly"));"Queue"===app.current.app&&"Current"===app.current.tab?getQueue():"Queue"===app.current.app&&"LastPlayed"===app.current.tab?appRoute():"Queue"===app.current.app&&"Jukebox"===app.current.tab?appRoute():"Search"===app.current.app?appRoute():"Browse"===app.current.app&&"Filesystem"===app.current.tab?appRoute():"Browse"===app.current.app&&
"Playlists"===app.current.tab&&"Detail"===app.current.view?appRoute():"Browse"===app.current.app&&"Database"===app.current.tab&&""!==app.current.search&&appRoute();i18nHtml(document.getElementsByTagName("body")[0]);checkConsume();!0===settings.mediaSession&&"mediaSession"in navigator?(navigator.mediaSession.setActionHandler("play",clickPlay),navigator.mediaSession.setActionHandler("pause",clickPlay),navigator.mediaSession.setActionHandler("stop",clickStop),navigator.mediaSession.setActionHandler("seekbackward",
seekRelativeBackward),navigator.mediaSession.setActionHandler("seekforward",seekRelativeForward),navigator.mediaSession.setActionHandler("previoustrack",clickPrev),navigator.mediaSession.setActionHandler("nexttrack",clickNext),navigator.mediaSession.setPositionState||logDebug("mediaSession.setPositionState not supported by browser")):logDebug("mediaSession not supported by browser");settingsParsed="true"}
...
function saveSettings(a){var b=!0,c=document.getElementById("inputCrossfade");c.getAttribute("disabled")||validateInt(c)||(b=!1);c=document.getElementById("inputJukeboxQueueLength");validateInt(c)||(b=!1);c=document.getElementById("inputJukeboxLastPlayed");validateInt(c)||(b=!1);var d=document.getElementById("selectStreamMode"),g=c="",f=document.getElementById("inputStreamUrl");"port"===d.options[d.selectedIndex].value?(g=f.value,validateInt(f)||(b=!1)):(c=f.value,validateStream(f)||(b=!1));d=document.getElementById("inputCoverimageSizeSmall");
validateInt(d)||(b=!1);d=document.getElementById("inputCoverimageSize");validateInt(d)||(b=!1);d=document.getElementById("inputCoverimageName");validateFilenameList(d)||(b=!1);d=document.getElementById("inputBookletName");validateFilename(d)||(b=!1);!0===isMobile&&(d=document.getElementById("inputScaleRatio"),validateFloat(d)?(scale=parseFloat(d.value),setViewport(!0)):b=!1);d=document.getElementById("inputLastPlayedCount");validateInt(d)||(b=!1);document.getElementById("btnLoveEnable").classList.contains("active")&&
(d=document.getElementById("inputLoveChannel"),f=document.getElementById("inputLoveMessage"),validateNotBlank(d)&&validateNotBlank(f)||(b=!1));!0===settings.featMixramp&&(d=document.getElementById("inputMixrampdb"),d.getAttribute("disabled")||validateFloat(d)||(b=!1),d=document.getElementById("inputMixrampdelay"),d.getAttribute("disabled")||("nan"===d.value&&(d.value="-1"),validateFloat(d)||(b=!1)));d=document.getElementById("inputSmartplsInterval");validateInt(d)||(b=!1);d=3600*document.getElementById("inputSmartplsInterval").value;
f=getBtnGroupValue("btnSingleGroup");var h=getBtnGroupValue("btnJukeboxModeGroup"),k=getBtnGroupValue("btnReplaygainGroup"),l=document.getElementById("selectJukeboxUniqueTag");l=l.options[l.selectedIndex].value;var m=document.getElementById("selectJukeboxPlaylist");m=m.options[m.selectedIndex].value;"2"===h&&(l="Album");"1"===h&&!1===settings.featSearchwindow&&"Database"===m&&(b=!1,document.getElementById("warnJukeboxPlaylist").classList.remove("hide"));if(!0===b){b=document.getElementById("selectLocale");
var n=document.getElementById("selectTheme");sendAPI("MYMPD_API_SETTINGS_SET",{consume:document.getElementById("btnConsume").classList.contains("active")?1:0,random:document.getElementById("btnRandom").classList.contains("active")?1:0,single:parseInt(f),repeat:document.getElementById("btnRepeat").classList.contains("active")?1:0,replaygain:k,crossfade:document.getElementById("inputCrossfade").value,mixrampdb:!0===settings.featMixramp?document.getElementById("inputMixrampdb").value:settings.mixrampdb,
...
jukeboxLastPlayed:parseInt(document.getElementById("inputJukeboxLastPlayed").value),jukeboxUniqueTag:l,autoPlay:document.getElementById("btnAutoPlay").classList.contains("active")?!0:!1,bgCover:document.getElementById("btnBgCover").classList.contains("active")?!0:!1,bgColor:document.getElementById("inputBgColor").value,bgCssFilter:document.getElementById("inputBgCssFilter").value,featLocalplayer:document.getElementById("btnFeatLocalplayer").classList.contains("active")?!0:!1,streamUrl:c,streamPort:parseInt(g),
...
bookmarks:document.getElementById("btnBookmarks").classList.contains("active")?!0:!1,maxElementsPerPage:parseInt(getSelectValue("selectMaxElementsPerPage")),stickers:document.getElementById("btnStickers").classList.contains("active")?!0:!1,lastPlayedCount:document.getElementById("inputLastPlayedCount").value,smartpls:document.getElementById("btnSmartpls").classList.contains("active")?!0:!1,smartplsPrefix:document.getElementById("inputSmartplsPrefix").value,smartplsInterval:d,smartplsSort:document.getElementById("selectSmartplsSort").value,
...
function setNavbarIcons(){var a=document.getElementById("badgeQueueItems"),b=0;a&&(b=a.innerText);a="";for(var c=0;c<settings.navbarIcons.length;c++){var d="";!1===settings.featHome&&"Home"===settings.navbarIcons[c].title&&(d="hide");a+='<div id="nav'+settings.navbarIcons[c].options.join("")+'" class="nav-item flex-fill text-center '+d+'"><a data-title-phrase="'+t(settings.navbarIcons[c].title)+'" data-href="" class="nav-link text-light" href="#"><span class="material-icons">'+settings.navbarIcons[c].ligature+
...
function isCoverfile(a){a=basename(a).toLowerCase();for(var b=a.split("."),c="png jpg jpeg svg webp tiff bmp".split(" "),d=settings.coverimageName.split(","),g=0;g<d.length;g++){var f=d[g].trim();if(a===f||b[1]&&f===b[0]&&c.includes(b[1]))return!0}return!1}
function getLyrics(a,b){void 0===a?b.innerHTML=t("No lyrics found"):(b.classList.add("opacity05"),sendAPI("MPD_API_LYRICS_GET",{uri:a},function(c){if(c.error)b.innerText=t(c.error.message);else if(c.result.message)b.innerText=t(c.result.message);else{for(var d='<span class="lyricsHeader" class="btn-group-toggle" data-toggle="buttons">',g='<div class="lyricsTextContainer">',f=0;f<c.result.returnedEntities;f++){var h=c.result.data[f].desc;h=""!==h&&""!==c.result.data[f].lang?h+(" ("+c.result.data[f].lang+
")"):""!==c.result.data[f].lang?c.result.data[f].lang:f;d+='<label data-num="'+f+'" class="btn btn-sm btn-outline-secondary mr-2'+(0===f?" active":"")+'">'+h+"</label>";g+='<div class="lyricsText'+(0<f?" hide":"")+'">'+(!0===c.result.synced?parseSyncedLyrics(c.result.data[f].text):e(c.result.data[f].text).replace(/\n/g,"<br/>"))+"</div>"}d+="</span>";g+="</div>";showSyncedLyrics=c.result.synced;1<c.result.returnedEntities?(b.innerHTML=d+g,b.getElementsByClassName("lyricsHeader")[0].addEventListener("click",
function(k){if("LABEL"===k.target.nodeName){k.target.parentNode.getElementsByClassName("active")[0].classList.remove("active");k.target.classList.add("active");k=parseInt(k.target.getAttribute("data-num"));for(var l=b.getElementsByClassName("lyricsText"),m=0;m<l.length;m++)m===k?l[m].classList.remove("hide"):l[m].classList.add("hide")}},!1)):b.innerHTML=g}b.classList.remove("opacity05")},!0))}
function parseSyncedLyrics(a){var b="";a=a.split("\r\n");for(var c=0;c<a.length;c++){var d=a[c].match(/^\[(\d+):(\d+)\.(\d+)\](.*)$/);if(d){var g=60*parseInt(d[1])+parseInt(d[2]);b+='<p><span data-sec="'+g+'">';b+=d[4].replace(/<(\d+):(\d+)\.\d+>/g,function(f,h,k){return'</span><span data-sec="'+(60*parseInt(h)+parseInt(k))+'">'});b+="</span></p>"}}return b+""}function loveSong(){sendAPI("MPD_API_LOVE",{})}
...
function showListOutputAttributes(a){sendAPI("MPD_API_PLAYER_OUTPUT_LIST",{},function(b){modalOutputAttributes.show();for(var c,d=0;d<b.result.data.length;d++)if(b.result.data[d].name===a){c=b.result.data[d];break}document.getElementById("modalOutputAttributesId").value=e(c.id);var g="<tr><td>"+t("Name")+"</td><td>"+e(c.name)+"</td></tr><tr><td>"+t("State")+"</td><td>"+(1===c.state?t("enabled"):t("disabled"))+"</td></tr><tr><td>"+t("Plugin")+"</td><td>"+e(c.plugin)+"</td></tr>",f=0;Object.keys(c.attributes).forEach(function(h){f++;
g+="<tr><td>"+e(h)+'</td><td><input name="'+e(h)+'" class="form-control border-secondary" type="text" value="'+e(c.attributes[h])+'"/></td></tr>'});0<f?document.getElementById("btnOutputAttributesSave").removeAttribute("disabled"):document.getElementById("btnOutputAttributesSave").setAttribute("disabled","disabled");document.getElementById("outputAttributesList").innerHTML=g})}
...
if(lastState&&lastState.currentSongId!==a&&(d=document.getElementById("queueTrackId"+lastState.currentSongId))){var g=d.querySelector("[data-col=Duration]");g&&(g.innerText=d.getAttribute("data-duration"));if(g=d.querySelector("[data-col=Pos]"))g.classList.remove("material-icons"),g.innerText=d.getAttribute("data-songpos");d.classList.remove("font-weight-bold")}if(a=document.getElementById("queueTrackId"+a)){if(d=a.querySelector("[data-col=Duration]"))d.innerHTML=b;(b=a.querySelector("[data-col=Pos]"))&&
...
function songChange(a){var b=a.result.Title+":"+a.result.Artist+":"+a.result.Album+":"+a.result.uri+":"+a.result.currentSongId;if(lastSong!==b){var c="",d="",g="";mediaSessionSetMetadata(a.result.Title,a.result.Artist,a.result.Album,a.result.uri);setCurrentCover(a.result.uri);!0===settings.bgCover&&!0===settings.featCoverimage&&setBackgroundImage(a.result.uri);domCache.footerArtist.classList.remove("clickable");domCache.footerAlbum.classList.remove("clickable");domCache.footerCover.classList.remove("clickable");
void 0!==a.result.Artist&&0<a.result.Artist.length&&"-"!==a.result.Artist?(c+=a.result.Artist,d+=a.result.Artist,g+=a.result.Artist+" - ",domCache.footerArtist.innerText=a.result.Artist,domCache.footerArtist.setAttribute("data-name",encodeURI(a.result.Artist)),!0===settings.featAdvsearch&&domCache.footerArtist.classList.add("clickable")):(domCache.footerArtist.innerText="",domCache.footerArtist.setAttribute("data-name",""));void 0!==a.result.Album&&0<a.result.Album.length&&"-"!==a.result.Album?(c+=
" - "+a.result.Album,d+="<br/>"+a.result.Album,domCache.footerAlbum.innerText=a.result.Album,domCache.footerAlbum.setAttribute("data-name",encodeURI(a.result.Album)),domCache.footerAlbum.setAttribute("data-albumartist",encodeURI(a.result[tagAlbumArtist])),!0===settings.featAdvsearch&&domCache.footerAlbum.classList.add("clickable")):(domCache.footerAlbum.innerText="",domCache.footerAlbum.setAttribute("data-name",""));void 0!==a.result.Title&&0<a.result.Title.length?(g+=a.result.Title,domCache.currentTitle.innerText=
...
document.title="myMPD: "+g;domCache.footerCover.title=g;void 0!==a.result.uri&&""!==a.result.uri&&-1===a.result.uri.indexOf("://")?domCache.footerTitle.classList.add("clickable"):domCache.footerTitle.classList.remove("clickable");void 0!==a.result.uri?(a.result.Filetype=filetype(a.result.uri),document.getElementById("addCurrentSongToPlaylist").removeAttribute("disabled")):(a.result.Filetype="",document.getElementById("addCurrentSongToPlaylist").setAttribute("disabled","disabled"));!0===settings.featStickers&&
setVoteSongBtns(a.result.like,a.result.uri);a.result.Fileformat=lastState?fileformat(lastState.audioFormat):"";for(g=0;g<settings.colsPlayback.length;g++){var f=document.getElementById("current"+settings.colsPlayback[g]);if(f&&"Lyrics"===settings.colsPlayback[g])getLyrics(a.result.uri,f.getElementsByTagName("p")[0]);else if(f){var h=a.result[settings.colsPlayback[g]];void 0===h&&(h="");h="Duration"===settings.colsPlayback[g]?beautifySongDuration(h):"LastModified"===settings.colsPlayback[g]?localeDate(h):
0===settings.colsPlayback[g].indexOf("MUSICBRAINZ")?getMBtagLink(settings.colsPlayback[g],a.result[settings.colsPlayback[g]]):e(h);f.getElementsByTagName("p")[0].innerHTML=h;f.setAttribute("data-name",encodeURI(h));"Album"===settings.colsPlayback[g]&&null!==a.result[tagAlbumArtist]&&f.setAttribute("data-albumartist",encodeURI(a.result[tagAlbumArtist]))}}document.getElementById("currentBooklet").innerHTML=""===a.result.bookletPath||void 0===a.result.bookletPath||!1===settings.featBrowse?"":'<span class="text-light material-icons">description</span>&nbsp;<a class="text-light" target="_blank" href="'+
subdir+"/browse/music/"+e(a.result.bookletPath)+'">'+t("Download booklet")+"</a>";if(g=document.getElementById("queueTrackId"+a.result.currentSongId))g.getElementsByTagName("td")[1].innerText=a.result.Title;"play"===playstate&&showNotification(a.result.Title,c,d,"success");lastSong=b;lastSongObj=a.result}}function gotoTagList(){appGoto(app.current.app,app.current.tab,app.current.view,"0",void 0,"-","-","-","")}function volumeStep(a){chVolume("up"===a?settings.volumeStep:0-settings.volumeStep)}
...
function mediaSessionSetMetadata(a,b,c,d){if(!0===settings.mediaSession&&"mediaSession"in navigator){var g=window.location.port;d=window.location.protocol+"//"+window.location.hostname+(""!==g?":"+g:"")+subdir+"/albumart/"+d;navigator.mediaSession.metadata=!0===settings.coverimage?new MediaMetadata({title:a,artist:b,album:c,artwork:[{src:d}]}):new MediaMetadata({title:a,artist:b,album:c})}}
...
c.target);c=b.getElementsByClassName("dragover-th");for(var d=c.length,g=0;g<d;g++)c[g].classList.remove("dragover-th");document.getElementById(a+"List")?(document.getElementById(a+"List").classList.add("opacity05"),saveCols(a)):saveCols(a,this.parentNode.parentNode)}},!1)}
...
function setCols(a){var b=document.getElementById(a+"ColsDropdown");b&&(b.firstChild.innerHTML=setColsChecklist(a));b=app.current.sort;"Search"===a&&"Title"===app.apps.Search.sort&&(b=settings.tags.includes("Title")?"Title":!1===settings.featTags?"Filename":"-");if("Playback"!==a){for(var c="",d=0;d<settings["cols"+a].length;d++){var g=settings["cols"+a][d];c+='<th draggable="true" data-col="'+g+'">';if("Track"===g||"Pos"===g)g="#";c+=t(g);"Search"!==a||g!==b&&"-"+g!==b||(g=!1,0===app.current.sort.indexOf("-")&&
(g=!0),c+='<span class="sort-dir material-icons pull-right">'+(!0===g?"arrow_drop_up":"arrow_drop_down")+"</span>");c+="</th>"}c=!0===settings.featTags?c+('<th data-col="Action"><a data-title-phrase="'+t("Columns")+'" href="#" class="text-secondary align-middle material-icons material-icons-small">settings</a></th>'):c+"<th></th>";document.getElementById(a+"List").getElementsByTagName("tr")[0].innerHTML=c}}
function saveCols(a,b){var c=document.getElementById(a+"ColsDropdown");b=void 0===b?document.getElementById(a+"List").getElementsByTagName("tr")[0]:"string"===typeof b?document.querySelector(b).getElementsByTagName("tr")[0]:b.getElementsByTagName("tr")[0];if(c){c=c.firstChild.getElementsByTagName("button");for(var d=0;d<c.length;d++)if(null!==c[d].getAttribute("name")){var g=b.querySelector("[data-col="+c[d].name+"]");!1===c[d].classList.contains("active")?g&&g.remove():g||(g=document.createElement("th"),
g.innerText=c[d].name,g.setAttribute("data-col",c[d].name),b.insertBefore(g,b.lastChild))}}a={table:"cols"+a,cols:[]};b=b.getElementsByTagName("th");for(c=0;c<b.length;c++)d=b[c].getAttribute("data-col"),"Action"!==d&&null!==d&&a.cols.push(d);sendAPI("MYMPD_API_COLS_SAVE",a,getSettings)}
function saveColsPlayback(a){for(var b=document.getElementById(a+"ColsDropdown").firstChild.getElementsByTagName("button"),c=document.getElementById("cardPlaybackTags"),d=0;d<b.length-1;d++){var g=document.getElementById("current"+b[d].name);!1===b[d].classList.contains("active")?g&&g.remove():g||(g=document.createElement("div"),g.innerHTML="<small>"+t(b[d].name)+"</small><p></p>",g.setAttribute("id","current"+b[d].name),g.setAttribute("data-tag",b[d].name),c.appendChild(g))}a={table:"cols"+a,cols:[]};
...
function initTimer(){document.getElementById("listTimerList").addEventListener("click",function(c){c.stopPropagation();c.preventDefault();"TD"===c.target.nodeName?c.target.parentNode.classList.contains("not-clickable")||showEditTimer(c.target.parentNode.getAttribute("data-id")):"A"===c.target.nodeName?deleteTimer(c.target.parentNode.parentNode.getAttribute("data-id")):"BUTTON"===c.target.nodeName&&toggleTimer(c.target,c.target.parentNode.parentNode.getAttribute("data-id"))},!1);for(var a="",b=0;24>
b;b++)a+='<option value="'+b+'">'+zeroPad(b,2)+"</option>";document.getElementById("selectTimerHour").innerHTML=a;a="";for(b=0;60>b;b+=5)a+='<option value="'+b+'">'+zeroPad(b,2)+"</option>";document.getElementById("selectTimerMinute").innerHTML=a;document.getElementById("inputTimerVolume").addEventListener("change",function(){document.getElementById("textTimerVolume").innerHTML=this.value+"&nbsp;%"},!1);document.getElementById("selectTimerAction").addEventListener("change",function(){selectTimerActionChange()},
...
function saveTimer(){var a=!0,b=document.getElementById("inputTimerName");validateNotBlank(b)||(a=!1);for(var c=!1,d="btnTimerMon btnTimerTue btnTimerWed btnTimerThu btnTimerFri btnTimerSat btnTimerSun".split(" "),g=[],f=0;f<d.length;f++){var h=document.getElementById(d[f]).classList.contains("active")?!0:!1;g.push(h);!0===h&&(c=!0)}!1===c?(a=!1,document.getElementById("invalidTimerWeekdays").style.display="block"):document.getElementById("invalidTimerWeekdays").style.display="none";c=document.getElementById("selectTimerAction");
d=document.getElementById("selectTimerPlaylist");f=document.getElementById("selectTimerHour");h=document.getElementById("selectTimerMinute");var k=document.getElementById("btnTimerJukeboxModeGroup").getElementsByClassName("active")[0].getAttribute("data-value");-1===c.selectedIndex&&(a=!1,c.classList.add("is-invalid"));"0"===k&&"Database"===d.options[d.selectedIndex].value&&"startplay"===c.options[c.selectedIndex].value&&(a=!1,document.getElementById("btnTimerJukeboxModeGroup").classList.add("is-invalid"));
if(!0===a){a={};for(var l=document.getElementById("timerActionScriptArguments").getElementsByTagName("input"),m=0;m<l.length;m++)a[l[m].getAttribute("data-name")]=l[m].value;sendAPI("MYMPD_API_TIMER_SAVE",{timerid:parseInt(document.getElementById("inputTimerId").value),name:b.value,enabled:document.getElementById("btnTimerEnabled").classList.contains("active")?!0:!1,startHour:parseInt(f.options[f.selectedIndex].value),startMinute:parseInt(h.options[h.selectedIndex].value),weekdays:g,action:c.options[c.selectedIndex].parentNode.getAttribute("data-value"),
...
function parseListTimer(a){for(var b=document.getElementById("listTimer").getElementsByTagName("tbody")[0],c=b.getElementsByTagName("tr"),d=0,g="Mon Tue Wed Thu Fri Sat Sun".split(" "),f=0;f<a.result.returnedEntities;f++){var h=document.createElement("tr");h.setAttribute("data-id",a.result.data[f].timerid);for(var k="<td>"+e(a.result.data[f].name)+'</td><td><button name="enabled" class="btn btn-secondary btn-xs clickable material-icons material-icons-small'+(!0===a.result.data[f].enabled?" active":
"")+'">'+(!0===a.result.data[f].enabled?"check":"radio_button_unchecked")+"</button></td><td>"+zeroPad(a.result.data[f].startHour,2)+":"+zeroPad(a.result.data[f].startMinute,2)+" "+t("on")+" ",l=[],m=0;7>m;m++)!0===a.result.data[f].weekdays[m]&&l.push(t(g[m]));k+=l.join(", ")+"</td><td>"+prettyTimerAction(a.result.data[f].action,a.result.data[f].subaction)+'</td><td data-col="Action"><a href="#" class="material-icons color-darkgrey">delete</a></td>';h.innerHTML=k;f<c.length?d=!0===replaceTblRow(c[f],
h)?f:d:b.append(h)}for(d=c.length-1;d>=a.result.returnedEntities;d--)c[d].remove();0===a.result.returnedEntities&&(b.innerHTML='<tr class="not-clickable"><td><span class="material-icons">error_outline</span></td><td colspan="4">'+t("Empty list")+"</td></tr>")}function prettyTimerAction(a,b){return"player"===a&&"startplay"===b?t("Start playback"):"player"===a&&"stopplay"===b?t("Stop playback"):"syscmd"===a?t("System command")+": "+e(b):"script"===a?t("Script")+": "+e(b):e(a)+": "+e(b)}
...
function escapeMPD(a){return a.replace(/(["'])/g,function(b,c){if('"'===c)return'\\"';if("'"===c)return"\\'";if("\\"===c)return"\\\\"})}function unescapeMPD(a){return a.replace(/(\\'|\\"|\\\\)/g,function(b,c){if('\\"'===c)return'"';if("\\'"===c)return"'";if("\\\\"===c)return"\\"})}function getSelectValue(a){"string"===typeof a&&(a=document.getElementById(a));if(a&&0<=a.selectedIndex)return a.options[a.selectedIndex].value}
...
function setPagination(a,b){var c=app.current.app+(void 0===app.current.tab?"":app.current.tab),d=0<app.current.limit?Math.ceil(a/app.current.limit):1;0===d&&(d=1);for(var g=0<app.current.limit?app.current.offset/app.current.limit+1:1,f='<button title="'+t("First page")+'" type="button" class="btn btn-group-prepend btn-secondary material-icons">first_page</button><button title="'+t("Previous page")+'" type="button" class="btn btn-group-prepend btn-secondary material-icons">navigate_before</button><div class="btn-group"><button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown"></button><div class="dropdown-menu bg-lite-dark px-2 pages dropdown-menu-right"></div></div><button title="'+
t("Next page")+'" type="button" class="btn btn-secondary btn-group-append material-icons">navigate_next</button><button title="'+t("Last page")+'" type="button" class="btn btn-secondary btn-group-append material-icons">last_page</button>',h='<button type="button" class="btn btn-secondary material-icons" title="'+t("To top")+'">keyboard_arrow_up</button><div><select class="form-control custom-select border-secondary" title="'+t("Elements per page")+'">',k=$jscomp.makeIterator([25,50,100,200,0]),l=
k.next();!l.done;l=k.next())l=l.value,h+='<option value="'+l+'"'+(app.current.limit===l?" selected":"")+">"+(0<l?l:t("All"))+"</option>";h+='</select></div><div id="'+c+'PaginationBottom" class="btn-group dropup pagination">'+f+"</div></div>";k=document.getElementById(c+"ButtonsBottom");k.innerHTML=h;k.getElementsByTagName("button")[0].addEventListener("click",function(){event.preventDefault();scrollToPosY(0)},!1);k.getElementsByTagName("select")[0].addEventListener("change",function(r){r=parseInt(getSelectValue(r.target));
app.current.limit!==r&&gotoPage(app.current.offset,r)},!1);document.getElementById(c+"PaginationTop").innerHTML=f;f=app.current.offset+app.current.limit;h=[document.getElementById(c+"PaginationTop"),document.getElementById(c+"PaginationBottom")];k={};for(l=0;l<h.length;k={$jscomp$loop$prop$lastPageOffset$68:k.$jscomp$loop$prop$lastPageOffset$68},l++){var m=h[l].children[0],n=h[l].children[1],p=h[l].children[2].children[0],q=h[l].children[2].children[1],v=h[l].children[3],u=h[l].children[4];p.innerText=
g+" / "+d;if(1<d){p.removeAttribute("disabled");for(var x="",w=0;w<d;w++){var y=w*app.current.limit;x+='<button data-offset="'+y+'" type="button" class="btn-sm btn btn-secondary'+(y===app.current.offset?" active":"")+'">'+(w+1)+"</button>"}q.innerHTML=x;p.classList.remove("nodropdown");q.addEventListener("click",function(r){"BUTTON"===r.target.nodeName&&gotoPage(r.target.getAttribute("data-offset"))},!1);new BSN.Dropdown(p);k.$jscomp$loop$prop$lastPageOffset$68=(d-1)*app.current.limit;k.$jscomp$loop$prop$lastPageOffset$68===
app.current.offset?u.setAttribute("disabled","disabled"):(u.removeAttribute("disabled"),u.classList.remove("hide"),v.classList.remove("rounded-right"),u.addEventListener("click",function(r){return function(){event.preventDefault();gotoPage(r.$jscomp$loop$prop$lastPageOffset$68)}}(k),!1))}else-1===a?(p.setAttribute("disabled","disabled"),p.innerText=g,p.classList.add("nodropdown"),u.setAttribute("disabled","disabled"),u.classList.add("hide"),v.classList.add("rounded-right")):(p.setAttribute("disabled",
"disabled"),p.classList.add("nodropdown"),u.setAttribute("disabled","disabled"));a>f&&0<f||-1===a&&b>=app.current.limit?(v.removeAttribute("disabled"),h[l].classList.remove("hide"),v.addEventListener("click",function(){event.preventDefault();gotoPage("next")},!1)):(v.setAttribute("disabled","disabled"),0===l&&h[l].classList.add("hide"));0<app.current.offset?(n.removeAttribute("disabled"),h[l].classList.remove("hide"),n.addEventListener("click",function(){event.preventDefault();gotoPage("prev")},!1),
m.removeAttribute("disabled"),m.addEventListener("click",function(){event.preventDefault();gotoPage(0)},!1)):(n.setAttribute("disabled","disabled"),m.setAttribute("disabled","disabled"))}b<app.current.limit?document.getElementById(c+"ButtonsBottom").classList.add("hide"):document.getElementById(c+"ButtonsBottom").classList.remove("hide")}function genId(a){return"id"+a.replace(/[^\w-]/g,"")}
