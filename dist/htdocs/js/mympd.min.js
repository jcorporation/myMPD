...
new BSN.Dropdown(document.getElementById("btnDropdownNeighbors")),collapseDBupdate=new BSN.Collapse(document.getElementById("navDBupdate")),collapseSyscmds=new BSN.Collapse(document.getElementById("navSyscmds")),collapseJukeboxMode=new BSN.Collapse(document.getElementById("labelJukeboxMode"));
...
function showNotification(a,b,c,d){if(!0===settings.notificationWeb){var f=new Notification(a,{icon:"assets/favicon.ico",body:b});setTimeout(f.close.bind(f),3E3)}if(!0===settings.notificationPage||"danger"===d||"warning"===d){document.getElementById("alertBox")?f=document.getElementById("alertBox"):(f=document.createElement("div"),f.setAttribute("id","alertBox"),f.classList.add("toast"));var g='<div class="toast-header">';g=("success"===d?g+'<span class="material-icons text-success mr-2">info</span>':
"warning"===d?g+'<span class="material-icons text-warning mr-2">warning</span>':g+'<span class="material-icons text-danger mr-2">error</span>')+('<strong class="mr-auto">'+e(a)+'</strong><button type="button" class="ml-2 mb-1 close">&times;</button></div>');if(""!==c||""!==b)g+='<div class="toast-body">'+(""===c?e(b):c)+"</div>";f.innerHTML=g+"</div>";document.getElementById("alertBox")||(document.getElementsByTagName("main")[0].append(f),requestAnimationFrame(function(){document.getElementById("alertBox").classList.add("alertBoxActive")}));
f.getElementsByTagName("button")[0].addEventListener("click",function(){hideNotification()},!1);alertTimeout&&clearTimeout(alertTimeout);alertTimeout=setTimeout(function(){hideNotification()},3E3)}setStateIcon("newMessage");logMessage(a,b,c,d)}
