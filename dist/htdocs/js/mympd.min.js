...
function parseOutputs(a){for(var b="",c=0,d=0;d<a.result.numOutputs;d++)"dummy"!==a.result.data[d].plugin&&(c++,b+='<button id="btnOutput'+a.result.data[d].id+'" data-output-name="'+encodeURI(a.result.data[d].name)+'" data-output-id="'+a.result.data[d].id+'" class="btn btn-secondary btn-block',1===a.result.data[d].state&&(b+=" active"),b+='"><span class="material-icons float-left">volume_up</span> '+e(a.result.data[d].name),b=0<Object.keys(a.result.data[d].attributes).length?b+('<a class="material-icons float-right" title="'+
t("Edit attributes")+'">settings</a>'):b+('<a class="material-icons float-right" title="'+t("Show attributes")+'">settings</a>'),b+="</button>");0===c&&(b='<span class="material-icons">error_outline</span> '+t("No outputs"));domCache.outputs.innerHTML=b}
...
function deleteTrigger(a){sendAPI("MPD_API_TRIGGER_DELETE",{id:a},function(a){sendAPI("MPD_API_TRIGGER_LIST",{},parseTriggerList,!1)},!0)}
