...
function(){document.getElementById("alertLocalPlayback").classList.add("hide");!0===settings.featLocalplayer&&!0===settings.localplayerAutoplay&&localplayerPlay()})}window.onerror=function(a,b,c){logError("JavaScript error: "+a+" ("+b+": "+c+")");4<=settings.loglevel&&(!0===appInited?showNotification(t("JavaScript error"),a+" ("+b+": "+c+")","","danger"):showAppInitAlert(t("JavaScript error")+": "+a+" ("+b+": "+c+")"));return!0};appInitStart();
