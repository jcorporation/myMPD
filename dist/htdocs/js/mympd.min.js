...
""===settings.musicDirectoryValue&&"none"!==settings.musicDirectory?document.getElementById("warnMusicDirectory").classList.remove("hide"):document.getElementById("warnMusicDirectory").classList.add("hide");!0===settings.bgCover&&!0===settings.featCoverimage&&!0===settings.coverimage?-1<lastSongObj.cover.indexOf("coverimage-")?clearBackgroundImage():lastSongObj.cover?setBackgroundImage(lastSongObj.cover):clearBackgroundImage():clearBackgroundImage();if(!1===settings.featTags)app.apps.Browse.active=
