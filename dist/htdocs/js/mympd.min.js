...
function showEditTimer(a){document.getElementById("timerActionPlay").classList.add("hide");document.getElementById("listTimer").classList.remove("active");document.getElementById("editTimer").classList.add("active");document.getElementById("listTimerFooter").classList.add("hide");document.getElementById("editTimerFooter").classList.remove("hide");if(0!==a)sendAPI("MYMPD_API_TIMER_GET",{timerid:a},parseEditTimer);else{getAllPlaylists(obj,"selectTimerPlaylist");document.getElementById("inputTimerId").value=
"0";document.getElementById("inputTimerName").value="";toggleBtnChk("btnTimerEnabled",!0);document.getElementById("selectTimerHour").value="12";document.getElementById("selectTimerMinute").value="0";document.getElementById("selectTimerAction").value="startplay";document.getElementById("inputTimerVolume").value="50";document.getElementById("selectTimerPlaylist").value="Database";toggleBtnGroupValue(document.getElementById("btnTimerJukeboxModeGroup"),1);a="btnTimerMon btnTimerTue btnTimerWed btnTimerThu btnTimerFri btnTimerSat btnTimerSun".split(" ");
for(var b=0;b<a.length;b++)toggleBtnChk(a[b],!1);document.getElementById("timerActionPlay").classList.remove("hide")}document.getElementById("inputTimerName").focus();document.getElementById("inputTimerName").classList.remove("is-invalid");document.getElementById("btnTimerJukeboxModeGroup").classList.remove("is-invalid");document.getElementById("invalidTimerWeekdays").style.display="none"}
