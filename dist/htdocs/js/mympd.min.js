...
a;showHomeIconCmdOptions(d);document.getElementById("previewHomeIconLigature").innerHTML=c;document.getElementById("previewHomeIconBgcolor").innerHTML=c;document.getElementById("previewHomeIconBgcolor").style.backgroundColor="#28a745";document.getElementById("previewHomeIconLigature").style.backgroundColor="#28a745";a=document.getElementById("previewHomeIconImage");a.style.backgroundImage="";a.style.height="";modalEditHomeIcon.show()}
function duplicateHomeIcon(a){_editHomeIcon(a,!1,"Duplicate home icon")}function editHomeIcon(a){_editHomeIcon(a,!0,"Edit home icon")}
...
c.result.data[0].image;document.getElementById("selectHomeIconCmd").value=c.result.data[0].cmd;showHomeIconCmdOptions(c.result.data[0].options);document.getElementById("previewHomeIconLigature").innerHTML=""!==c.result.data[0].ligature?c.result.data[0].ligature:"&nbsp;";document.getElementById("previewHomeIconBgcolor").innerHTML=""!==c.result.data[0].ligature?c.result.data[0].ligature:"&nbsp;";document.getElementById("previewHomeIconBgcolor").style.backgroundColor=c.result.data[0].bgcolor;document.getElementById("previewHomeIconLigature").style.backgroundColor=
c.result.data[0].bgcolor;var d=document.getElementById("previewHomeIconImage");d.style.backgroundImage="url("+subdir+'"/browse/pics/'+c.result.data[0].image+'")';d.style.height=""!==c.result.data[0].image?"105px":"";modalEditHomeIcon.show()})}
function saveHomeIcon(){var a=!0,b=document.getElementById("inputHomeIconName");validateNotBlank(b)||(a=!1);if(!0===a){a=[];for(var c=document.getElementById("divHomeIconOptions").getElementsByTagName("input"),d=0;d<c.length;d++)a.push(""!==c[d].value?c[d].value:"!undefined!");sendAPI("MYMPD_API_HOME_ICON_SAVE",{replace:"true"===document.getElementById("inputHomeIconReplace").value?!0:!1,oldpos:parseInt(document.getElementById("inputHomeIconOldpos").value),name:b.value,ligature:document.getElementById("inputHomeIconLigature").value,
...
for(var c=0;c<b.length;c++)b[c].classList.remove("selected");a.target.parentNode.classList.add("selected");showMenu(a.target,a);a.stopPropagation()}},!1);document.getElementById("HomeCards").addEventListener("keydown",function(a){navigateGrid(a.target,a.key)},!1);dragAndDropHome();document.getElementById("selectHomeIconCmd").addEventListener("change",function(){showHomeIconCmdOptions()},!1);document.getElementById("inputHomeIconLigature").addEventListener("change",function(a){document.getElementById("previewHomeIconLigature").innerHTML=
""!==a.target.value?a.target.value:"&nbsp;";document.getElementById("previewHomeIconBgcolor").innerHTML=""!==a.target.value?a.target.value:"&nbsp;"},!1);document.getElementById("inputHomeIconBgcolor").addEventListener("change",function(a){document.getElementById("previewHomeIconBgcolor").style.backgroundColor=a.target.value;document.getElementById("previewHomeIconLigature").style.backgroundColor=a.target.value},!1);document.getElementById("inputHomeIconImage").addEventListener("change",function(a){var b=
document.getElementById("previewHomeIconImage");b.style.backgroundImage='url("'+subdir+"/browse/pics/"+a.target.value+'")';b.style.height=""!==a.target.value?b.offsetWidth+"px":""},!1);a=document.getElementsByClassName("pages");b=a.length;for(c=0;c<b;c++)a[c].addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&gotoPage(a.target.getAttribute("data-page"))},!1);document.getElementById("cardPlaybackTags").addEventListener("click",function(a){"P"===a.target.nodeName&&gotoBrowse()},!1);
...
c=a.target.parentNode.parentNode.getAttribute("data-type"),d=decodeURI(a.target.parentNode.parentNode.getAttribute("data-uri")),g=a.target.parentNode.parentNode.firstChild.innerText,f=a.target.getAttribute("data-href");"delete"===f?(sendAPI("MYMPD_API_BOOKMARK_RM",{id:b},function(){sendAPI("MYMPD_API_BOOKMARK_LIST",{offset:0},parseBookmarks)}),a.preventDefault(),a.stopPropagation()):"edit"===f?showBookmarkSave(b,g,d,c):"goto"===f&&appGoto("Browse","Filesystem",void 0,"0","-","-","-",d)}},!1);document.getElementById("BrowsePlaylistsAllList").addEventListener("click",
...
function(a){"TD"===a.target.nodeName?appendQueue("song",decodeURI(a.target.parentNode.getAttribute("data-uri")),a.target.parentNode.getAttribute("data-name")):"A"===a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("BrowseDatabaseCards").addEventListener("click",function(a){"Album"===app.current.tag?a.target.classList.contains("card-body")?appGoto("Browse","Database","Detail","0","Album","AlbumArtist",decodeURI(a.target.parentNode.getAttribute("data-album")),decodeURI(a.target.parentNode.getAttribute("data-albumartist"))):
a.target.classList.contains("card-footer")&&showMenu(a.target,a):(app.current.search="",document.getElementById("searchDatabaseStr").value="",appGoto(app.current.app,app.current.card,void 0,"0","Album","AlbumArtist","Album","("+app.current.tag+" == '"+decodeURI(a.target.parentNode.getAttribute("data-tag"))+"')"))},!1);document.getElementById("BrowseDatabaseCards").addEventListener("keydown",function(a){navigateGrid(a.target,a.key)},!1);document.getElementById("BrowseDatabaseDetailList").addEventListener("click",
...
app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,app.current.tag,app.current.search))},!1);document.getElementById("BrowseDatabaseByTagDropdown").addEventListener("click",function(a){navBrowseHandler(a)},!1);document.getElementById("BrowseNavPlaylistsDropdown").addEventListener("click",function(a){navBrowseHandler(a)},!1);document.getElementById("BrowseNavFilesystemDropdown").addEventListener("click",function(a){navBrowseHandler(a)},!1);document.getElementById("dropdownSortPlaylistTags").addEventListener("click",
...
app.current.page,a.target.getAttribute("data-tag"),app.current.sort,"-",app.current.search)},!1);document.getElementById("searchFilesystemStr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",""!==this.value?this.value:"-",app.current.sort,"-",app.current.search)},!1);document.getElementById("searchPlaylistsStr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,
"0",app.current.filter,app.current.sort,"-",this.value)},!1);a=["PlaybackColsDropdown"];for(b=0;b<a.length;b++)document.getElementById(a[b]).addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&a.target.classList.contains("material-icons")&&(a.stopPropagation(),a.preventDefault(),toggleBtnChk(a.target))},!1);document.getElementById("search").addEventListener("submit",function(){return!1},!1);document.getElementById("searchqueue").addEventListener("submit",function(){return!1},!1);document.getElementById("searchdatabase").addEventListener("submit",
function(){return!1},!1);document.getElementById("searchDatabaseStr").addEventListener("keyup",function(a){if("Escape"===a.key)this.blur();else if("Enter"===a.key&&"Album"===app.current.tag)if(""!==this.value){a=document.getElementById("searchDatabaseMatch");var b=document.createElement("button");b.classList.add("btn","btn-light","mr-2");b.setAttribute("data-filter",encodeURI(app.current.filter+" "+a.options[a.selectedIndex].value+" '"+this.value+"'"));b.innerHTML=e(app.current.filter)+" "+a.options[a.selectedIndex].value+
...
a.target.nodeName)a.target.parentNode.remove(),searchAlbumgrid("");else if("BUTTON"===a.target.nodeName){var b=decodeURI(a.target.getAttribute("data-filter"));document.getElementById("searchDatabaseStr").value=b.substring(b.indexOf("'")+1,b.length-1);var c=b.substring(b.indexOf(" ")+1);c=c.substring(0,c.indexOf(" "));document.getElementById("searchDatabaseMatch").value=c;b=b.substring(0,b.indexOf(" "));selectTag("searchDatabaseTags","searchDatabaseTagsDesc",b);a.target.remove();searchAlbumgrid(document.getElementById("searchDatabaseStr").value)}},
...
dragAndDropTableHeader("QueueCurrent");dragAndDropTableHeader("QueueLastPlayed");dragAndDropTableHeader("Search");dragAndDropTableHeader("BrowseFilesystem");dragAndDropTableHeader("BrowsePlaylistsDetail");dragAndDropTableHeader("BrowseDatabaseDetail");window.addEventListener("focus",function(){sendAPI("MPD_API_PLAYER_STATE",{},parseState)},!1);document.addEventListener("keydown",function(a){if("INPUT"!==a.target.tagName&&"SELECT"!==a.target.tagName&&"TEXTAREA"!==a.target.tagName&&!a.ctrlKey&&!a.altKey){var b=
keymap[a.key];b&&"function"===typeof window[b.cmd]&&(void 0===keymap[a.key].req||!0===settings[keymap[a.key].req])&&parseCmd(a,b)}},!1);a=document.getElementsByTagName("table");for(b=0;b<a.length;b++)a[b].setAttribute("tabindex",0),a[b].addEventListener("keydown",function(a){navigateTable(this,a.key)},!1);var f="";Object.keys(themes).forEach(function(a){f+='<option value="'+e(a)+'">'+t(themes[a])+"</option>"});document.getElementById("selectTheme").innerHTML=f;window.addEventListener("beforeunload",
function(){webSocketClose()});document.getElementById("alertLocalPlayback").getElementsByTagName("a")[0].addEventListener("click",function(a){a.stopPropagation();a.preventDefault();clickCheckLocalPlayerState(a)},!1);document.getElementById("errorLocalPlayback").getElementsByTagName("a")[0].addEventListener("click",function(a){a.stopPropagation();a.preventDefault();clickCheckLocalPlayerState(a)},!1);document.getElementById("localPlayer").addEventListener("click",function(a){a.stopPropagation()});document.getElementById("localPlayer").addEventListener("canplay",
