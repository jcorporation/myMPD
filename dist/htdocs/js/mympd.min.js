...
function addToQueue(){var a=!0,b=document.getElementById("inputAddToQueueQuantity");validateInt(b)||(a=!1);b=selectAddToQueueMode.options[selectAddToQueueMode.selectedIndex].value;var c=selectAddToQueuePlaylist.options[selectAddToQueuePlaylist.selectedIndex].value;"1"===b&&!1===settings.featSearchwindow&&"Database"===c&&(document.getElementById("warnJukeboxPlaylist2").classList.remove("hide"),a=!1);!0===a&&(document.getElementById("selectAddToQueueMode"),document.getElementById("selectAddToQueuePlaylist"),
sendAPI("MPD_API_QUEUE_ADD_RANDOM",{mode:b,playlist:c,quantity:document.getElementById("inputAddToQueueQuantity").value}),modalAddToQueue.hide())}function saveQueue(){var a=document.getElementById("saveQueueName").value;!0===validatePlname(a)?(sendAPI("MPD_API_QUEUE_SAVE",{plist:a}),modalSaveQueue.hide()):document.getElementById("saveQueueName").classList.add("is-invalid")}
function delQueueSong(a,b,c){"range"===a?sendAPI("MPD_API_QUEUE_RM_RANGE",{start:b,end:c}):"single"===a&&sendAPI("MPD_API_QUEUE_RM_TRACK",{track:b})}
...
g=getBtnGroupValue("btnSingleGroup");var h=getBtnGroupValue("btnJukeboxModeGroup"),k=getBtnGroupValue("btnReplaygainGroup"),l=document.getElementById("selectJukeboxUniqueTag");l=l.options[l.selectedIndex].value;var m=selectJukeboxPlaylist.options[selectJukeboxPlaylist.selectedIndex].value;"2"===h&&(l="Album");"1"===h&&!1===settings.featSearchwindow&&"Database"===m&&(b=!1,document.getElementById("warnJukeboxPlaylist").classList.remove("hide"));if(!0===b){document.getElementById("selectJukeboxPlaylist");
b=document.getElementById("selectLocale");var p=document.getElementById("selectTheme");sendAPI("MYMPD_API_SETTINGS_SET",{consume:document.getElementById("btnConsume").classList.contains("active")?1:0,random:document.getElementById("btnRandom").classList.contains("active")?1:0,single:parseInt(g),repeat:document.getElementById("btnRepeat").classList.contains("active")?1:0,replaygain:k,crossfade:document.getElementById("inputCrossfade").value,mixrampdb:!0===settings.featMixramp?document.getElementById("inputMixrampdb").value:
