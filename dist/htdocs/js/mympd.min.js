...
function parseSettings(){settings.mpdConnected?parseMPDSettings():toggleAlert("alertMpdState",!0,"Connection to MPD failed.");0!=settings.mpdhost.indexOf("/")?document.getElementById("mpdInfo_host").innerText=settings.mpdhost+":"+settings.mpdport:document.getElementById("mpdInfo_host").innerText=settings.mpdhost;var a=document.getElementById("btnnotifyWeb");notificationsSupported()?settings.notificationWeb?(toggleBtn("btnnotifyWeb",settings.notificationWeb),Notification.requestPermission(function(a){"permission"in
