...
document.getElementById("homeIconPreview").innerHTML=c;document.getElementById("homeIconPreview").style.backgroundColor="#28a745";document.getElementById("homeIconPreview").backgroundImage="";document.getElementById("divHomeIconLigature").classList.remove("hide");modalEditHomeIcon.show()}function duplicateHomeIcon(a){_editHomeIcon(a,!1,"Duplicate home icon")}function editHomeIcon(a){_editHomeIcon(a,!0,"Edit home icon")}
...
c.result.data.cmd;showHomeIconCmdOptions(c.result.data.options);getHomeIconPictureList(c.result.data.image);document.getElementById("homeIconPreview").innerHTML=c.result.data.ligature;document.getElementById("homeIconPreview").style.backgroundColor=c.result.data.bgcolor;""===c.result.data.image?(document.getElementById("divHomeIconLigature").classList.remove("hide"),document.getElementById("homeIconPreview").style.backgroundImage=""):(document.getElementById("divHomeIconLigature").classList.add("hide"),
...
for(var c=0;c<b.length;c++)b[c].classList.remove("selected");a.target.parentNode.classList.add("selected");showMenu(a.target,a);a.stopPropagation()}},!1);document.getElementById("HomeCards").addEventListener("keydown",function(a){navigateGrid(a.target,a.key)},!1);dragAndDropHome();document.getElementById("selectHomeIconCmd").addEventListener("change",function(){showHomeIconCmdOptions()},!1);document.getElementById("inputHomeIconLigature").addEventListener("change",function(a){document.getElementById("homeIconPreview").innerHTML=
