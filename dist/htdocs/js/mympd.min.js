...
app.current.sort,a,app.current.search)))}function gotoBrowse(){if(!1!==settings.featAdvsearch){var a=event.target,b=a.getAttribute("data-tag"),c=decodeURI(a.getAttribute("data-name"));null===b&&(b=a.parentNode.getAttribute("data-tag"),c=decodeURI(a.parentNode.getAttribute("data-name")));""!==b&&""!==c&&"-"!==c&&settings.browsetags.includes(b)&&appGoto("Browse","Database","List","0",b,"AlbumArtist","Album",c)}}
...
function _addAlbum(a,b,c){b="((Album == '"+c+"') AND ("+(settings.tags.includes("AlbumArtist")?"AlbumArtist":"Artist")+" == '"+b+"'))";"appendQueue"===a?addAllFromSearchPlist("queue",b,!1):"replaceQueue"===a?addAllFromSearchPlist("queue",b,!0):"addPlaylist"===a&&showAddToPlaylist("ALBUM",b)}
...
("dir"===b?addMenuItem({cmd:"updateDB",options:[dirname(c),!0]},t("Update directory")):"")+("dir"===b?addMenuItem({cmd:"rescanDB",options:[dirname(c),!0]},t("Rescan directory")):"")),"Search"===app.current.app){var g=a.parentNode.parentNode.getAttribute("data-album"),k=a.parentNode.parentNode.getAttribute("data-albumartist");null!==g&&null!==k?(g=decodeURI(g),k=decodeURI(k),d+='<div class="dropdown-divider"></div><a class="dropdown-item" id="advancedMenuLink" data-toggle="collapse" href="#advancedMenu"><span class="material-icons material-icons-left">keyboard_arrow_right</span>Album actions</a><div class="collapse" id="advancedMenu">'+
addMenuItem({cmd:"_addAlbum",options:["appendQueue",k,g]},t("Append to queue"))+addMenuItem({cmd:"_addAlbum",options:["replaceQueue",k,g]},t("Replace queue"))+(!0===settings.featPlaylists?addMenuItem({cmd:"_addAlbum",options:["addPlaylist",k,g]},t("Add to playlist")):"")+"</div>"):(c=dirname(c),d+='<div class="dropdown-divider"></div><a class="dropdown-item" id="advancedMenuLink" data-toggle="collapse" href="#advancedMenu"><span class="material-icons material-icons-left">keyboard_arrow_right</span>Folder actions</a><div class="collapse" id="advancedMenu">'+
addMenuItem({cmd:"appendQueue",options:[b,c,f]},t("Append to queue"))+addMenuItem({cmd:"appendAfterQueue",options:[b,c,h,f]},t("Add after current playing song"))+addMenuItem({cmd:"replaceQueue",options:[b,c,f]},t("Replace queue"))+(!0===settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",options:[c,""]},t("Add to playlist")):"")+"</div>")}}else"Browse"===app.current.app&&"Database"===app.current.tab&&"List"===app.current.view?(b=decodeURI(a.parentNode.getAttribute("data-albumartist")),f=decodeURI(a.parentNode.getAttribute("data-album")),
d+=addMenuItem({cmd:"_addAlbum",options:["appendQueue",b,f]},t("Append to queue"))+addMenuItem({cmd:"_addAlbum",options:["replaceQueue",b,f]},t("Replace queue"))+(!0===settings.featPlaylists?addMenuItem({cmd:"_addAlbum",options:["addPlaylist",b,f]},t("Add to playlist")):"")):"Browse"===app.current.app&&"Playlists"===app.current.tab&&"All"===app.current.view?d+=addMenuItem({cmd:"appendQueue",options:[b,c,f]},t("Append to queue"))+addMenuItem({cmd:"replaceQueue",options:[b,c,f]},t("Replace queue"))+
(!0===settings.smartpls&&"smartpls"===b?addMenuItem({cmd:"playlistDetails",options:[c]},t("View playlist")):addMenuItem({cmd:"playlistDetails",options:[c]},t("Edit playlist")))+(!0===settings.smartpls&&"smartpls"===b?addMenuItem({cmd:"showSmartPlaylist",options:[c]},t("Edit smart playlist")):"")+(!0===settings.smartpls&&"smartpls"===b?addMenuItem({cmd:"updateSmartPlaylist",options:[c]},t("Update smart playlist")):"")+addMenuItem({cmd:"showRenamePlaylist",options:[c]},t("Rename playlist"))+addMenuItem({cmd:"showDelPlaylist",
options:[c]},t("Delete playlist"))+(!0===settings.featHome?addMenuItem({cmd:"addPlistToHome",options:[c,f]},t("Add to homescreen")):""):"Browse"===app.current.app&&"Playlists"===app.current.tab&&"Detail"===app.current.view?(h=document.getElementById("BrowsePlaylistsDetailList"),d+=addMenuItem({cmd:"appendQueue",options:[b,c,f]},t("Append to queue"))+addMenuItem({cmd:"replaceQueue",options:[b,c,f]},t("Replace queue"))+("false"===h.getAttribute("data-ro")?addMenuItem({cmd:"removeFromPlaylist",options:[h.getAttribute("data-uri"),
a.parentNode.parentNode.getAttribute("data-songpos")]},t("Remove")):"")+(settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",options:[c,""]},t("Add to playlist")):"")+(-1===c.indexOf("http")?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):"")):"Queue"===app.current.app&&"Current"===app.current.tab?d+=addMenuItem({cmd:"delQueueSong",options:["single",a.parentNode.parentNode.getAttribute("data-trackid")]},t("Remove"))+addMenuItem({cmd:"delQueueSong",options:["range",0,a.parentNode.parentNode.getAttribute("data-songpos")]},
t("Remove all upwards"))+addMenuItem({cmd:"delQueueSong",options:["range",parseInt(a.parentNode.parentNode.getAttribute("data-songpos"))-1,-1]},t("Remove all downwards"))+(-1===c.indexOf("http")?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):""):"Queue"===app.current.app&&"LastPlayed"===app.current.tab?d+=addMenuItem({cmd:"appendQueue",options:[b,c,f]},t("Append to queue"))+addMenuItem({cmd:"replaceQueue",options:[b,c,f]},t("Replace queue"))+(settings.featPlaylists?addMenuItem({cmd:"showAddToPlaylist",
options:[c,""]},t("Add to playlist")):"")+(-1===c.indexOf("http")?addMenuItem({cmd:"songDetails",options:[c]},t("Song details")):""):"Queue"===app.current.app&&"Jukebox"===app.current.tab?d+=addMenuItem({cmd:"songDetails",options:[c]},t("Song details"))+addMenuItem({cmd:"delQueueJukeboxSong",options:[a.parentNode.parentNode.getAttribute("data-pos")]},t("Remove")):"Home"===app.current.app&&(h=parseInt(a.parentNode.getAttribute("data-pos")),g=JSON.parse(a.parentNode.getAttribute("data-href")),k="",
"replaceQueue"===g.cmd&&"plist"===g.options[0]?(b="plist",c=g.options[1],k=t("Add and play playlist"),f=t("Playlist")):"appGoto"===g.cmd?(b="view",k=t("Goto view"),f=t("View")):"execScriptFromOptions"===g.cmd&&(b="script",k=t("Execute script"),f=t("Script")),d+='<h6 class="dropdown-header">'+f+"</h6>"+addMenuItem({cmd:"executeHomeIcon",options:[h]},k)+("plist"===b?addMenuItem({cmd:"playlistDetails",options:[c]},t("View playlist")):"")+addMenuItem({cmd:"editHomeIcon",options:[h]},t("Edit home icon"))+
...
checkConsume();!0===settings.mediaSession&&"mediaSession"in navigator?(navigator.mediaSession.setActionHandler("play",clickPlay),navigator.mediaSession.setActionHandler("pause",clickPlay),navigator.mediaSession.setActionHandler("stop",clickStop),navigator.mediaSession.setActionHandler("seekbackward",seekRelativeBackward),navigator.mediaSession.setActionHandler("seekforward",seekRelativeForward),navigator.mediaSession.setActionHandler("previoustrack",clickPrev),navigator.mediaSession.setActionHandler("nexttrack",
...
"Title");settings.tags.includes("AlbumArtist")||"AlbumArtist"!==app.apps.Browse.tabs.Database.views.List.filter||(app.apps.Browse.tabs.Database.views.List.filter="Artist",app.apps.Browse.tabs.Database.views.List.sort="Artist");!1===settings.featAdvsearch&&"Database"===app.apps.Browse.active&&(app.apps.Browse.active="Filesystem");if(!1===settings.featAdvsearch)for(a=document.getElementById("cardPlaybackTags").getElementsByTagName("p"),b=0;b<a.length;b++)a[b].classList.remove("clickable");else for(a=
document.getElementById("cardPlaybackTags").getElementsByTagName("p"),b=0;b<a.length;b++)a[b].classList.add("clickable");!0===settings.featPlaylists?sendAPI("MPD_API_PLAYLIST_LIST_ALL",{searchstr:""},function(k){getAllPlaylists(k,"selectJukeboxPlaylist",settings.jukeboxPlaylist)}):document.getElementById("selectJukeboxPlaylist").innerHTML='<option value="Database">'+t("Database")+"</option>";setCols("QueueCurrent");setCols("Search");setCols("QueueLastPlayed");setCols("QueueJukebox");setCols("BrowseFilesystem");
setCols("BrowsePlaylistsDetail");setCols("BrowseDatabaseDetail");setCols("Playback");addTagList("BrowseDatabaseByTagDropdown","browsetags");addTagList("BrowseNavPlaylistsDropdown","browsetags");addTagList("BrowseNavFilesystemDropdown","browsetags");addTagList("searchqueuetags","searchtags");addTagList("searchtags","searchtags");addTagList("searchDatabaseTags","browsetags");addTagList("databaseSortTagsList","browsetags");addTagList("dropdownSortPlaylistTags","tags");addTagList("saveSmartPlaylistSort",
"tags");addTagListSelect("selectSmartplsSort","tags");addTagListSelect("saveSmartPlaylistSort","tags");addTagListSelect("selectJukeboxUniqueTag","browsetags");initTagMultiSelect("inputEnabledTags","listEnabledTags",settings.allmpdtags,settings.tags);initTagMultiSelect("inputSearchTags","listSearchTags",settings.tags,settings.searchtags);initTagMultiSelect("inputBrowseTags","listBrowseTags",settings.tags,settings.browsetags);initTagMultiSelect("inputGeneratePlsTags","listGeneratePlsTags",settings.browsetags,
settings.generatePlsTags)}function resetSettings(){sendAPI("MYMPD_API_SETTINGS_RESET",{},getSettings)}
...
for(var f=0;f<c.length;f++)!0===b?c[f].classList.remove("hide"):c[f].classList.add("hide");if(!0===b){b=[subdir+"/albumart/"+a.result.uri];if(!0===settings.publish)for(c=0;c<a.result.images.length;c++)!1===isCoverfile(a.result.images[c])&&b.push(subdir+"/browse/music/"+a.result.images[c]);a=document.getElementById("tabSongPics");createImgCarousel(a,"songPicsCarousel",b)}else document.getElementById("tabSongPics").innerText=""}
...
" - "+a.result.Album,f+="<br/>"+a.result.Album,domCache.footerAlbum.innerText=a.result.Album,domCache.footerAlbum.setAttribute("data-name",encodeURI(a.result.Album)),!0===settings.featAdvsearch&&domCache.footerAlbum.classList.add("clickable")):(domCache.footerAlbum.innerText="",domCache.footerAlbum.setAttribute("data-name",""));void 0!==a.result.Title&&0<a.result.Title.length?(h+=a.result.Title,domCache.currentTitle.innerText=a.result.Title,domCache.currentTitle.setAttribute("data-uri",encodeURI(a.result.uri)),
domCache.footerTitle.innerText=a.result.Title,domCache.footerTitle.classList.add("clickable"),domCache.footerCover.classList.add("clickable")):(domCache.currentTitle.innerText="",domCache.currentTitle.setAttribute("data-uri",""),domCache.footerTitle.innerText="",domCache.footerTitle.setAttribute("data-name",""),domCache.footerTitle.classList.remove("clickable"),domCache.footerCover.classList.remove("clickable"));document.title="myMPD: "+h;domCache.footerCover.title=h;void 0!==a.result.uri&&""!==a.result.uri&&
-1===a.result.uri.indexOf("://")?domCache.footerTitle.classList.add("clickable"):domCache.footerTitle.classList.remove("clickable");void 0!==a.result.uri?(a.result.Filetype=filetype(a.result.uri),document.getElementById("addCurrentSongToPlaylist").removeAttribute("disabled")):(a.result.Filetype="",document.getElementById("addCurrentSongToPlaylist").setAttribute("disabled","disabled"));!0===settings.featStickers&&setVoteSongBtns(a.result.like,a.result.uri);a.result.Fileformat=lastState?fileformat(lastState.audioFormat):
"";for(h=0;h<settings.colsPlayback.length;h++){var d=document.getElementById("current"+settings.colsPlayback[h]);if(d&&"Lyrics"===settings.colsPlayback[h])getLyrics(a.result.uri,d.getElementsByTagName("p")[0]);else if(d){var g=a.result[settings.colsPlayback[h]];void 0===g&&(g="");"Duration"===settings.colsPlayback[h]?g=beautifySongDuration(g):"LastModified"===settings.colsPlayback[h]&&(g=localeDate(g));d.getElementsByTagName("p")[0].innerText=g;d.setAttribute("data-name",encodeURI(g))}}document.getElementById("currentBooklet").innerHTML=
""===a.result.bookletPath||void 0===a.result.bookletPath||!1===settings.featBrowse?"":'<span class="text-light material-icons">description</span>&nbsp;<a class="text-light" target="_blank" href="'+subdir+"/browse/music/"+e(a.result.bookletPath)+'">'+t("Download booklet")+"</a>";if(h=document.getElementById("queueTrackId"+a.result.currentSongId))h.getElementsByTagName("td")[1].innerText=a.result.Title;"play"===playstate&&showNotification(a.result.Title,c,f,"success");lastSong=b;lastSongObj=a.result}}
