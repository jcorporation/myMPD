...
function webSocketConnect(){if(null!==socket&&socket.readyState===WebSocket.OPEN)logInfo("Socket already connected"),websocketConnected=!0;else{websocketConnected=!1;var a=getWsUrl();socket=new WebSocket(a);logInfo("Connecting to "+a);try{socket.onopen=function(){logInfo("Websocket is connected");websocketConnected=!0;null!==websocketTimer&&(clearTimeout(websocketTimer),websocketTimer=null)},socket.onmessage=function(b){try{var c=JSON.parse(b.data);logDebug("Websocket notification: "+JSON.stringify(c))}catch(d){logError("Invalid JSON data received: "+
b.data)}switch(c.method){case "welcome":websocketConnected=!0;showNotification(t("Connected to myMPD")+": "+a,"","","success");appRoute();sendAPI("MPD_API_PLAYER_STATE",{},parseState,!0);break;case "update_state":c.result=c.params;parseState(c);break;case "mpd_disconnected":progressTimer&&clearTimeout(progressTimer);getSettings(!0);break;case "mpd_connected":showNotification(t("Connected to MPD"),"","","success");sendAPI("MPD_API_PLAYER_STATE",{},parseState);getSettings(!0);break;case "update_queue":"Queue"===
...
function parseCovergrid(a){var b=a.result.returnedEntities,c=document.getElementById("BrowseCovergridList"),d=c.getElementsByClassName("col");0===d.length&&(c.innerHTML="");for(var f=0;f<b;f++){var g=document.createElement("div");g.classList.add("col","px-0","flex-grow-0");var h='<div class="card card-grid" data-uri="'+encodeURI(a.result.data[f].FirstSongUri)+'"><div class="card-body album-cover-loading album-cover-grid"></div><div class="card-footer card-footer-grid p-2" title="'+a.result.data[f].AlbumArtist+
": "+a.result.data[f].Album+'">'+a.result.data[f].Album+"<br/><small>"+a.result.data[f].AlbumArtist+"</small></div></div>";g.innerHTML=h;h=!1;f<d.length?d[f].firstChild.getAttribute("data-uri")!==g.firstChild.getAttribute("data-uri")&&(d[f].replaceWith(g),h=!0):(c.append(g),h=!0);"IntersectionObserver"in window&&!0===h?(new IntersectionObserver(setGridImage,{root:null,rootMargin:"0px"})).observe(g):!0===h&&(g.firstChild.style.backgroundImage='url("/albumart/'+a.result.data[f].uri+'")')}for(f=d.length-
1;f>=b;f--)d[f].remove();setPagination(a.result.totalEntities,a.result.returnedEntities);0===b&&(c.innerHTML=t("Empty list"));document.getElementById(app.current.app+(void 0===app.current.tab?"":app.current.tab)+"List").classList.remove("opacity05");document.getElementById("cardFooterBrowse").innerText=gtPage("Num entries",a.result.returnedEntities,a.result.totalEntities)}
function setGridImage(a,b){a.forEach(function(a){if(0<a.intersectionRatio){b.unobserve(a.target);var c=decodeURI(a.target.firstChild.getAttribute("data-uri"));a.target.firstChild.firstChild.style.backgroundImage='url("/albumart/'+c+'")'}})}
...
AlbumArtistSort:{"de-DE":"Album Interpret","ko-KR":"\uc74c\ubc18 \uc5f0\uc8fc\uac00 \uc815\ub82c"},AlbumSort:{"de-DE":"Album","ko-KR":"\uc74c\ubc18 \uc815\ub82c"},Albumart:{"de-DE":"Albumcover","ko-KR":"\uc74c\ubc18\ud45c\uc9c0"},Albums:{"de-DE":"Alben","ko-KR":"\uc74c\ubc18"},"Any Tag":{"de-DE":"Alle Tags","ko-KR":"\ubaa8\ub4e0 \ud0dc\uadf8"},"Append item to playlist":{"de-DE":"Ausgew\u00e4hltes Element zu einer Wiedergabeliste hinzuf\u00fcgen","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d\uc5d0 \ud56d\ubaa9 \ucd94\uac00"},
...
"ko-KR":"\uc74c\uc6d0 \ub514\ub809\ud130\ub9ac\uc5d0 \uc811\uadfc\ud560 \uc218 \uc5c6\uc74c"},"Can't save setting %{setting}":{"de-DE":"%{setting} konnte nicht gespeichert werden","ko-KR":"%{setting} \uc124\uc815 \uc800\uc7a5\ud560 \uc218 \uc5c6\uc74c"},Cancel:{"de-DE":"Abbrechen","ko-KR":"\ucde8\uc18c"},Certificate:{"de-DE":"Zertifikat","ko-KR":"\uc778\uc99d"},Clear:{"de-DE":"L\u00f6schen"},"Clear app cache and reload":{"de-DE":"Browser Cache l\u00f6schen und neu laden","ko-KR":"\uce90\uc2dc\ub97c \uc9c0\uc6b0\uace0 \ub2e4\uc2dc \uc77d\uae30"},
"Clear covercache":{"de-DE":"Covercache l\u00f6schen"},"Clear playlist":{"de-DE":"Playlist leeren","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \ube44\uc6b0\uae30"},"Clear queue":{"de-DE":"Warteschlange leeren","ko-KR":"\uc21c\uc11c \ube44\uc6b0\uae30"},"Clearing bookmarks failed":{"de-DE":"L\u00f6schen aller Lesezeichen fehlgeschlagen","ko-KR":"\uc990\uaca8\ucc3e\uae30 \uc9c0\uc6b0\uae30 \uc548 \ub428"},Close:{"de-DE":"Schlie\u00dfen","ko-KR":"\ub2eb\uae30"},Comment:{"de-DE":"Kommentar","ko-KR":"\uc124\uba85"},
Composer:{"de-DE":"Komponist","ko-KR":"\uc791\uace1\uac00"},Conductor:{"de-DE":"Dirigent"},"Connect to websocket":{"de-DE":"Websocketverbindung wird hergestellt","ko-KR":"\uc6f9\uc18c\ucf13\uc5d0 \uc5f0\uacb0"},"Connected to MPD":{"de-DE":"Verbindung zu MPD hergestellt","ko-KR":"MPD\ub85c \uc5f0\uacb0\ub428"},"Connected to myMPD":{"de-DE":"Verbindung zu myMPD hergestellt","ko-KR":"myMPD\ub85c \uc5f0\uacb0\ub428"},"Connecting to stream...":{"de-DE":"Verbinde...","ko-KR":"\uc2a4\ud2b8\ub9bc\uc5d0 \uc5f0\uacb0 \uc911..."},
Connection:{"de-DE":"Verbindung","ko-KR":"\uc5f0\uacb0"},Consume:{"de-DE":"Konsumieren","ko-KR":"\uc368\ubc84\ub9ac\uae30"},"Consume must be enabled":{"de-DE":"Konsumieren muss aktiviert sein","ko-KR":"\uc18c\ube44\ub97c \uc120\ud0dd\ud574\uc57c \ud568"},Covergrid:{"de-DE":"Albumcover"},"Create Playlist":{"de-DE":"Neue Wiedergabeliste erstellen","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \ub9cc\ub4e4\uae30"},Crop:{"de-DE":"Abschneiden"},"Crop queue":{"de-DE":"Warteschlange abschneiden","ko-KR":"\uc21c\uc11c \ub0a8\uae30\uae30"},
Crossfade:{"de-DE":"Crossfade","ko-KR":"\ud06c\ub85c\uc2a4\ud398\uc774\ub4dc"},"DB play time":{"de-DE":"Datenbank Wiedergabedauer","ko-KR":"DB \uc5f0\uc8fc \uc2dc\uac04"},"DB updated":{"de-DE":"Datenbank zuletzt aktualisiert","ko-KR":"DB \uc5c5\ub370\uc774\ud2b8\ub428"},Dark:{"de-DE":"Dunkel"},Database:{"de-DE":"Datenbank","ko-KR":"\ub370\uc774\ud130 \ubca0\uc774\uc2a4"},"Database statistics":{"de-DE":"Datenbank Statistiken","ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \ud1b5\uacc4"},"Database successfully updated":{"de-DE":"Datenbank erfolgreich aktualisiert",
"ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \uc5c5\ub370\uc774\ud2b8\ub428"},"Database update finished":{"de-DE":"Datenbankaktualisierung beendet","ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \uc5c5\ub370\uc774\ud2b8 \ub9c8\uce68"},"Database update started":{"de-DE":"Datenbankaktualisierung gestartet","ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \uc5c5\ub370\uc774\ud2b8 \uc2dc\uc791\ub428"},Date:{"de-DE":"Datum","ko-KR":"\ub0a0\uc9dc"},Days:{"de-DE":"Tage","en-US":"Days","ko-KR":"\uc77c"},Default:{"de-DE":"Standard"},
Delete:{"de-DE":"L\u00f6schen","ko-KR":"\uc9c0\uc6b0\uae30"},"Delete playlist":{"de-DE":"Wiedergabeliste l\u00f6schen","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc9c0\uc6b0\uae30"},"Deleting bookmark failed":{"de-DE":"Lesezeichen konnte nicht gel\u00f6scht werden","ko-KR":"\uc990\uaca8\ucc3e\uae30 \uc9c0\uc6b0\uae30 \uc548 \ub428"},"Deleting smart playlist failed":{"de-DE":"Intelligente Wiedergabeliste konnte nicht gel\u00f6scht werden","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc9c0\uc6b0\uae30 \uc548 \ub428"},
"Dependent on the size of your music collection this can take a while":{"de-DE":"Der Aktualisierungsvorgang kann einige Zeit in Anspruch nehmen","ko-KR":"\uc74c\uc6d0 \ud06c\uae30\uc5d0 \ub530\ub77c \uc2dc\uac04\uc774 \uac78\ub9b4 \uc218 \uc788\uc2b5\ub2c8\ub2e4"},Descending:{"de-DE":"Absteigend"},Disc:{"de-DE":"CD","ko-KR":"\ub514\uc2a4\ud06c"},"Dislike song":{"de-DE":"Schlechtes Lied","ko-KR":"\uace1 \uc88b\uc544\ud558\uc9c0 \uc54a\uc74c"},Download:{"de-DE":"Herunterladen","ko-KR":"\ub0b4\ub824\ubc1b\uae30"},
Duration:{"de-DE":"L\u00e4nge","ko-KR":"\uae38\uc774"},"Edit playlist":{"de-DE":"Wiegergabeliste bearbeiten","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \ud3b8\uc9d1"},"Edit smart playlist":{"de-DE":"Intelligente Wiedergabeliste bearbeiten","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \ud3b8\uc9d1"},"Empty list":{"de-DE":"Leere Liste","ko-KR":"\ubaa9\ub85d \ube44\uc6b0\uae30"},"Empty playlist":{"de-DE":"Leere Wiedergabeliste","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \ube44\uc6b0\uae30"},"Empty queue":{"de-DE":"Leere Warteschlange",
"ko-KR":"\uc21c\uc11c \ube44\uc6b0\uae30"},"Failed to execute cmd %{cmd}":{"de-DE":"Fehler beim Ausf\u00fchren des Systembefehls %{cmd}","ko-KR":"%{cmd} \uba85\ub839\uc5b4 \uc2e4\ud589 \uc548 \ub428"},"Failed to open bookmarks file":{"de-DE":"Lesezeichen Datei konnte nicht ge\u00f6ffnet werden","ko-KR":"\uc990\uaca8\ucc3e\uae30 \ud30c\uc77c \uc5f4\uae30 \uc548 \ub428"},"Failed to save playlist":{"de-DE":"Wiedergabeliste konnte nicht gespeichert werden","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc800\uc7a5 \uc548 \ub428"},
...
Filetype:{"de-DE":"Dateityp","ko-KR":"\ud30c\uc77c \ud615\uc2dd"},Fingerprint:{"de-DE":"Fingerabdruck","ko-KR":"\uc9c0\ubb38"},"Fingerprint command not supported":{"de-DE":"Fingerprint Befehl ist nicht unterst\u00fctzt","ko-KR":"\uc9c0\ubb38 \uba85\ub839\uc5b4 \uc9c0\uc6d0 \uc548 \ub428"},"Focus search":{"de-DE":"Gehe zur Suche","ko-KR":"\ucc3e\uae30\ub85c \uac00\uae30"},"Focus table":{"de-DE":"In Tabelle navigieren","ko-KR":"\ubaa9\ub85d\uc5d0\uc11c \ucc3e\uae30"},From:{"de-DE":"Von","ko-KR":"\uc6d0\ub798"},
General:{"de-DE":"Allgemein","ko-KR":"\uc77c\ubc18"},Genre:{"de-DE":"Genre","ko-KR":"\uc7a5\ub974"},"Goto browse covergrid":{"de-DE":"Gehe zu Albumcover"},"Goto browse database":{"de-DE":"Gehe zu Datenbank durchsuchen","ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \uc5f4\uae30\ub85c \uac00\uae30"},"Goto browse filesystem":{"de-DE":"Gehe zu Dateisystem","ko-KR":"\ud30c\uc77c \uc2dc\uc2a4\ud15c \uc5f4\uae30\ub85c \uac00\uae30"},"Goto browse playlists":{"de-DE":"Gehe zu Wiedergabelisten","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc5f4\uae30\ub85c \uac00\uae30"},
"Goto last played":{"de-DE":"Gehe zu Zuletzt gespielt","ko-KR":"\uc55e\uc120 \uc5f0\uc8fc\ub85c \uac00\uae30"},"Goto playback":{"de-DE":"Gehe zu Wiedergabe","ko-KR":"\uc5f0\uc8fc\ub85c \uac00\uae30"},"Goto queue":{"de-DE":"Gehe zu Warteschlange","ko-KR":"\uc21c\uc11c\ub85c \uac00\uae30"},"Goto search":{"de-DE":"Gehe zur Suche","ko-KR":"\ucc3e\uae30\ub85c \uac00\uae30"},Grouping:{"de-DE":"Grupierung","ko-KR":"\ubb36\uc74c"},Homepage:{"de-DE":"Homepage","ko-KR":"\ud648\ud398\uc774\uc9c0"},Hours:{"de-DE":"Std",
"en-US":"Hrs","ko-KR":"\uc2dc\uac04"},"Initializing myMPD":{"de-DE":"Initialisiere myMPD","ko-KR":"myMPD \ucd08\uae30\ud654"},Interface:{"de-DE":"Oberfl\u00e4che"},"Invalid API request":{"de-DE":"Ung\u00fcltiger API Befehl","ko-KR":"\uc798\ubabb\ub41c API \uc694\uad6c"},"Invalid CSS filter":{"de-DE":"Ung\u00fcltiger CSS Filter","ko-KR":"\uc798\ubabb\ub41c CSS \ud544\ud130"},"Invalid MPD host":{"de-DE":"Ung\u00fcltiger MPD Host","ko-KR":"\uc798\ubabb\ub41c MPD \ud638\uc2a4\ud2b8"},"Invalid MPD password":{"de-DE":"Ung\u00fcltiges MPD Passwort",
"ko-KR":"\uc798\ubabb\ub41c MPD \ube44\ubc00\ubc88\ud638"},"Invalid MPD port":{"de-DE":"Ung\u00fcltiger MPD Port","ko-KR":"\uc798\ubabb\ub41c MPD \ud3ec\ud2b8"},"Invalid URI":{"de-DE":"Ung\u00fcltige URL","ko-KR":"\uc798\ubabb\ub41c \uc8fc\uc18c"},"Invalid channel name":{"de-DE":"Ung\u00fcltiger Channel name","ko-KR":"\uc798\ubabb\ub41c \ucc44\ub110 \uc774\ub984"},"Invalid color":{"de-DE":"Ung\u00fcltige Farbe","ko-KR":"\uc798\ubabb\ub41c \uc0c9\uc0c1"},"Invalid filename":{"de-DE":"Ung\u00fcltiger Dateiname",
"ko-KR":"\uc798\ubabb\ub41c \ud30c\uc77c \uc774\ub984"},"Invalid message":{"de-DE":"Ung\u00fcltige Zeichen in Nachricht","ko-KR":"\uc798\ubabb\ub41c \uba54\uc2dc\uc9c0"},"Invalid music directory":{"de-DE":"Ung\u00fcltiges Musikverzeichnis","ko-KR":"\uc798\ubabb\ub41c \uc74c\uc6d0 \ub514\ub809\ud130\ub9ac"},"Invalid size":{"de-DE":"Ung\u00fcltige Gr\u00f6\u00dfe","ko-KR":"\uc798\ubabb\ub41c \ud06c\uae30"},"Invalid type":{"de-DE":"Ung\u00fcltiger Typ","ko-KR":"\uc798\ubabb\ub41c \ud615\uc2dd"},"JavaScript is disabled":{"de-DE":"JavaScript ist deaktiviert",
"ko-KR":"\uc790\ubc14\uc2a4\ud06c\ub9bd\ud2b8 \uc0ac\uc6a9 \uc548 \ud568"},Jukebox:{"de-DE":"Jukebox","ko-KR":"\ubba4\uc9c1\ubc15\uc2a4"},"Jukebox mode":{"de-DE":"Jukebox Modus","ko-KR":"\ubba4\uc9c1\ubc15\uc2a4 \ubaa8\ub4dc"},"Keep queue length":{"de-DE":"Warteschlangenl\u00e4nge","ko-KR":"\uc21c\uc11c \uae38\uc774 \uc720\uc9c0"},Label:{"de-DE":"Herausgeber","ko-KR":"\uc74c\ubc18\uc0ac"},"Last modified":{"de-DE":"Zuletzt ge\u00e4ndert","ko-KR":"\uc55e\uc11c \uc218\uc815\ud568"},"Last played":{"de-DE":"Zuletzt gespielt",
"ko-KR":"\uc55e\uc11c \uc5f0\uc8fc\ud568"},"Last played list count":{"de-DE":"Anzahl zuletzt gespielte Lieder","ko-KR":"\uc55e\uc120 \uc5f0\uc8fc \ubaa9\ub85d \uac1c\uc218"},"Last skipped":{"de-DE":"Zuletzt \u00fcbersprungen","ko-KR":"\uc55e\uc11c \uac74\ub108\ub700"},LastPlayed:{"de-DE":"Zuletzt gespielt","ko-KR":"\uc55e\uc11c \uc5f0\uc8fc\ud568"},"Libmpdclient version":{"de-DE":"Libmpdclient Version","ko-KR":"Libmpdclient \ubc84\uc804"},"Libmympdclient version":{"de-DE":"Libmympdclient Version"},
Light:{"de-DE":"Hell"},Like:{"de-DE":"Wertung","ko-KR":"\uc88b\uc544\uc694"},"Like song":{"de-DE":"Gutes Lied","ko-KR":"\uace1 \uc88b\uc544\uc694"},"Local playback":{"de-DE":"Lokale Wiedergabe","ko-KR":"\ub85c\uceec \uc5f0\uc8fc"},Locale:{"de-DE":"Sprache","ko-KR":"\uc5b8\uc5b4"},"Love song":{"de-DE":"Lieblingslied","ko-KR":"\uc560\uccad\uace1"},"MPD channel":{"de-DE":"MPD Channel","ko-KR":"MPD \ucc44\ub110"},"MPD channel not found":{"de-DE":"MPD Channel nicht gefunden","ko-KR":"MPD \ucc44\ub110 \uc5c6\uc74c"},
"MPD connection":{"de-DE":"MPD Verbindung","ko-KR":"MPD \uc5f0\uacb0"},"MPD connection error: %{error}":{"de-DE":"MPD Verbindungsfehler: %{error}","ko-KR":"MPD \uc5f0\uacb0 \uc624\ub958: %{error}"},"MPD disconnected":{"de-DE":"MPD nicht verbunden","ko-KR":"MPD \uc5f0\uacb0 \ub04a\uc5b4\uc9d0"},"MPD host":{"de-DE":"MPD Host","ko-KR":"MPD \ud638\uc2a4\ud2b8"},"MPD password":{"de-DE":"MPD Passwort","ko-KR":"MPD \ube44\ubc00\ubc88\ud638"},"MPD port":{"de-DE":"MPD Port","ko-KR":"MPD \ud3ec\ud2b8"},"MPD stickers are disabled":{"de-DE":"MPD Sticker sind deaktiviert",
"ko-KR":"MPD \uc2a4\ud2f0\ucee4 \uc0ac\uc6a9 \uc548 \ud568"},"MPD uptime":{"de-DE":"MPD Uptime","ko-KR":"MPD \uac00\ub3d9 \uc2dc\uac04"},MUSICBRAINZ_ALBUMARTISTID:{"de-DE":"Musicbrainz AlbumArtist ID","ko-KR":"\ubba4\uc9c1\ube0c\ub808\uc778\uc988 \uc74c\ubc18 \uc5f0\uc8fc\uc790 ID"},MUSICBRAINZ_ALBUMID:{"de-DE":"Musicbrainz Album ID","ko-KR":"\ubba4\uc9c1\ube0c\ub808\uc778\uc988 \uc74c\ubc18 ID"},MUSICBRAINZ_ARTISTID:{"de-DE":"Musicbrainz K\u00fcnstler ID","ko-KR":"\ubba4\uc9c1\ube0c\ub808\uc778\uc988 \uc5f0\uc8fc\uc790 ID"},
MUSICBRAINZ_RELEASETRACKID:{"de-DE":"Musicbrainz Release Track ID","ko-KR":"\ubba4\uc9c1\ube0c\ub808\uc778\uc988 \ubc1c\ud45c \uace1 ID"},MUSICBRAINZ_TRACKID:{"de-DE":"Musicbrainz Track ID","ko-KR":"\ubba4\uc9c1\ube0c\ub808\uc778\uc988 \uace1 ID"},MUSICBRAINZ_WORKID:{"de-DE":"Musicbrainz Werk ID","ko-KR":"\ubba4\uc9c1\ube0c\ub808\uc778\uc988 \uc791\ud488 ID"},"Max. songs":{"de-DE":"Max. Lieder","ko-KR":"\ucd5c\ub300 \uace1"},Message:{"de-DE":"Nachricht","ko-KR":"\uba54\uc2dc\uc9c0"},Minutes:{"de-DE":"Min",
"en-US":"Min","ko-KR":"\ubd84"},"Mixramp DB":{"de-DE":"Mixramp DB","ko-KR":"Mixramp DB"},"Mixramp delay":{"de-DE":"Mixramp Verz\u00f6gerung","ko-KR":"Mixramp \uc9c0\uc5f0"},"Music directory":{"de-DE":"Musikverzeichnis","ko-KR":"\uc74c\uc6d0 \ub514\ub809\ud130\ub9ac"},"Music directory not found":{"de-DE":"Musikverzeichnis nicht gefunden","ko-KR":"\uc74c\uc6d0 \ub514\ub809\ud130\ub9ac \uc5c6\uc74c"},"Must be a number":{"de-DE":"Muss eine Zahl sein","ko-KR":"\uc22b\uc790\uc5ec\uc57c \ud568"},"Must be a number and greater than zero":{"de-DE":"Muss eine Zahl gr\u00f6\u00dfer als 0 sein",
"ko-KR":"0\ubcf4\ub2e4 \ud070 \uc22b\uc790\uc5ec\uc57c \ud568"},"Must be a number smaller or equal 200":{"de-DE":"Muss eine Zahl kleinergleich 200 sein","ko-KR":"200\uc774\ud558\uc758 \uc22b\uc790\uc5ec\uc57c \ud568"},Name:{"de-DE":"Name","ko-KR":"\uc774\ub984"},"New playlist":{"de-DE":"Neue Wiedergabeliste","ko-KR":"\uc0c8 \uc5f0\uc8fc\ubaa9\ub85d"},"Next page":{"de-DE":"N\u00e4chste Seite","ko-KR":"\ub2e4\uc74c \ud398\uc774\uc9c0"},"Next song":{"de-DE":"N\u00e4chstes Lied","ko-KR":"\ub2e4\uc74c \uace1"},
"No albumart found by mpd":{"de-DE":"MPD konnte keine Cover finden"},"No bookmarks found":{"de-DE":"Keine Lesezeichen gefunden","ko-KR":"\uc990\uaca8\ucc3e\uae30\ub97c \ucc3e\uc744 \uc218 \uc5c6\uc74c"},"No current song":{"de-DE":"Kein Lied ausgw\u00e4hlt","ko-KR":"\uc9c0\uae08 \uace1 \uc5c6\uc74c"},"No playlists found":{"de-DE":"Keine Wiedergabelisten gefunden","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \ucc3e\uc744 \uc218 \uc5c6\uc74c"},"No response for method %{method}":{"de-DE":"Keine R\u00fcckmeldung f\u00fcr Aufruf %{method}",
"ko-KR":"%{method} \uc751\ub2f5 \uc5c6\uc74c"},"No results, please refine your search":{"de-DE":"Keine Ergebnisse, bitte passe die Suche an","ko-KR":"\uacb0\uacfc\uac00 \uc5c6\uc73c\ubbc0\ub85c, \ub9de\uac8c \ucc3e\uc544\uc57c \ud568"},"No search expression defined":{"de-DE":"Kein Suchausdruck angegeben","ko-KR":"\ucc3e\uc744 \ubb38\uad6c \uc5c6\uc74c"},None:{"de-DE":"Keines","ko-KR":"\uc5c6\uc74c"},Notifications:{"de-DE":"Hinweise","ko-KR":"\uc54c\ub9bc"},"Num entries":{"de-DE":"%{smart_count} Eintrag |||| %{smart_count} Eintr\u00e4ge",
"en-US":"%{smart_count} Entry |||| %{smart_count} Entries","ko-KR":"%{smart_count} \ud56d\ubaa9 |||| %{smart_count} \ud56d\ubaa9"},"Num playlists":{"de-DE":"%{smart_count} Wiedergabeliste |||| %{smart_count} Wiedergabelisten","en-US":"%{smart_count} Playlist |||| %{smart_count} Playlists","ko-KR":"%{smart_count} \uc5f0\uc8fc\ubaa9\ub85d |||| %{smart_count} \uc5f0\uc8fc\ubaa9\ub85d"},"Num songs":{"de-DE":"%{smart_count} Lied |||| %{smart_count} Lieder","en-US":"%{smart_count} Song |||| %{smart_count} Songs",
"ko-KR":"%{smart_count} \uace1 |||| %{smart_count} \uace1"},Off:{"de-DE":"deaktiviert","ko-KR":"\ub044\uae30"},"On page notifications":{"de-DE":"Integrierte Hinweise","ko-KR":"\ud398\uc774\uc9c0\uc5d0 \uc54c\ub9bc"},"Open about":{"de-DE":"\u00d6ffne \u00dcber myMPD","ko-KR":"myMPD\uc5d0 \ub300\ud558\uc5ec \uc5f4\uae30"},"Open local player":{"de-DE":"Lokale Wiedergabe","ko-KR":"\ub85c\uceec \uc5f0\uc8fc\uae30 \uc5f4\uae30"},"Open main menu":{"de-DE":"\u00d6ffne Hauptmen\u00fc","ko-KR":"\uc8fc \uba54\ub274\ub85c \uac00\uae30"},
"Open settings":{"de-DE":"Einstellungen","ko-KR":"\uc124\uc815 \uc5f4\uae30"},"Open song details":{"de-DE":"Lieddetails","ko-KR":"\uace1 \uc815\ubcf4 \uc5f4\uae30"},"Open volume menu":{"de-DE":"\u00d6ffne Lautst\u00e4rkemen\u00fc","ko-KR":"\uc74c\ub7c9 \uba54\ub274 \uc5f4\uae30"},Pagination:{"de-DE":"Seitenumbruch","ko-KR":"\ud398\uc774\uc9c0 \ub9e4\uae30\uae30"},Performer:{"de-DE":"Auff\u00fchrender","ko-KR":"\uc5f0\uc8fc\uc790"},"Play count":{"de-DE":"Wie oft gespielt","ko-KR":"\uc5f0\uc8fc \ud69f\uc218"},
"Play time":{"de-DE":"Wiedergabedauer","ko-KR":"\uc5f0\uc8fc \uc2dc\uac04"},Playback:{"de-DE":"Wiedergabe","ko-KR":"\uc5f0\uc8fc"},"Playback statistics":{"de-DE":"Wiedergabestatistiken","ko-KR":"\uc5f0\uc8fc \ud1b5\uacc4"},Playlist:{"de-DE":"Wiedergabeliste","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d"},"Playlist name":{"de-DE":"Wiedergabelistenname","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc774\ub984"},Playlists:{"de-DE":"Wiedergabelisten","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d"},"Playlists are disabled":{"de-DE":"Wiedergabelisten sind deaktiviert",
"ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc0ac\uc6a9 \uc548 \ud568"},"Please choose playlist":{"de-DE":"Bitte Wiedergabeliste ausw\u00e4hlen","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d\uc744 \uc120\ud0dd\ud569\ub2c8\ub2e4"},Port:{"de-DE":"Port","ko-KR":"\ud3ec\ud2b8"},Pos:{"de-DE":"Pos","ko-KR":"\uc704\uce58"},"Previous page":{"de-DE":"Vorige Seite","ko-KR":"\uc774\uc804 \ud398\uc774\uc9c0"},"Previous song":{"de-DE":"Voriges Lied","ko-KR":"\uc774\uc804 \uace1"},"Protocol version":{"de-DE":"Protokoll Version","ko-KR":"\ud504\ub85c\ud1a0\ucf5c \ubc84\uc804"},
Quantity:{"de-DE":"Anzahl","ko-KR":"\uac2f\uc218"},Queue:{"de-DE":"Warteschlange","ko-KR":"\uc21c\uc11c"},"Queue replaced with %{name}":{"de-DE":"Warteschlange mit %{name} ersetzt","ko-KR":"%{name} \uc21c\uc11c \ubc14\uafc8"},Random:{"de-DE":"Zufall","ko-KR":"\ubb34\uc791\uc704"},Reload:{"de-DE":"Neu laden","ko-KR":"\ub2e4\uc2dc \uc77d\uae30"},Remove:{"de-DE":"Entfernen","ko-KR":"\uc9c0\uc6b0\uae30"},"Remove all downwards":{"de-DE":"Aller Lieder darunter entfernen","ko-KR":"\uc544\ub798\ub85c \uc9c0\uc6b0\uae30"},
"Remove all upwards":{"de-DE":"Alle Lieder dar\u00fcber entfernen","ko-KR":"\uc704\ub85c \uc9c0\uc6b0\uae30"},"Remove item from queue":{"de-DE":"Ausgew\u00e4hltes Element aus Warteschlange entfernen","ko-KR":"\uc21c\uc11c\uc5d0\uc11c \ud56d\ubaa9 \uc9c0\uc6b0\uae30"},"Rename playlist":{"de-DE":"Wiedergabeliste umbenennen","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc774\ub984 \ubc14\uafb8\uae30"},"Renaming playlist failed":{"de-DE":"Wiedergabeliste konnte nicht umbenannt werden","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc774\ub984 \ubc14\uafb8\uae30 \uc548 \ub428"},
Repeat:{"de-DE":"Wiederholen","ko-KR":"\ub2e4\uc2dc"},"Replace queue":{"de-DE":"Warteschlange ersetzen","ko-KR":"\uc21c\uc11c \ubc14\uafb8\uae30"},"Replace queue with item":{"de-DE":"Warteschlange mit ausgew\u00e4hltem Element ersetzen","ko-KR":"\uc21c\uc11c\uc5d0 \ud56d\ubaa9 \ub300\uccb4"},Replaygain:{"de-DE":"Lautst\u00e4rkeanpassung","ko-KR":"\ub9ac\ud50c\ub808\uc774\uac8c\uc778"},"Rescan database":{"de-DE":"Datenbank neu einlesen","ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \ub2e4\uc2dc \uac80\uc0c9"},
"Rescan directory":{"de-DE":"Verzeichnis neu einlesen"},Reset:{"de-DE":"Zur\u00fccksetzen","ko-KR":"\ub2e4\uc2dc \uc124\uc815"},"Reset settings":{"de-DE":"Einstellungen zur\u00fccksetzen","ko-KR":"\ub2e4\uc2dc \uc124\uc815 \ud558\uae30"},Save:{"de-DE":"Speichern","ko-KR":"\uc800\uc7a5"},"Save as smart playlist":{"de-DE":"Als intelligente Wiedergabeliste speichern","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc800\uc7a5"},"Save bookmark":{"de-DE":"Lesezeichen speichern","ko-KR":"\uc990\uaca8\ucc3e\uae30 \uc800\uc7a5"},
"Save queue":{"de-DE":"Warteschlange speichern","ko-KR":"\uc21c\uc11c \uc800\uc7a5"},"Save smart playlist":{"de-DE":"Intelligente Wiedergabeliste sichern","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc800\uc7a5"},"Saved smart playlist %{name}":{"de-DE":"Intelligente Wiedergabeliste %{name} gespeichert","ko-KR":"%{name} \uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc800\uc7a5\ud568"},"Saving bookmark failed":{"de-DE":"Lesezeichen konnte nicht gespeichert werden","ko-KR":"\uc990\uaca8\ucc3e\uae30 \uc800\uc7a5 \uc548 \ub428"},
"Scrobbled love":{"de-DE":"Lieblingslied wurde gescrobbelt","ko-KR":"\uc560\uccad\uace1 \ucd94\ucc9c"},"Scrobbler integration":{"de-DE":"Scrobbler Integration","ko-KR":"\ucd94\ucc9c \ud1b5\ud569"},Search:{"de-DE":"Suchen","ko-KR":"\ucc3e\uae30"},"Search queue":{"de-DE":"Warteschlange durchsuchen","ko-KR":"\uc21c\uc11c \ucc3e\uae30"},"Searching...":{"de-DE":"Suche...","ko-KR":"\ucc3e\ub294 \uc911..."},Seconds:{"de-DE":"Sek","en-US":"Sec","ko-KR":"\ucd08"},"Select tag to search":{"de-DE":"Tag zum Suchen ausw\u00e4hlen",
"ko-KR":"\ucc3e\uc744 \ud0dc\uadf8 \uc120\ud0dd"},"Send love message":{"de-DE":"Sende Lieblingslied","ko-KR":"\uc560\uccad \uba54\uc2dc\uc9c0 \ubcf4\ub0b4\uae30"},Settings:{"de-DE":"Einstellungen","ko-KR":"\uc124\uc815"},Shortcut:{"de-DE":"Tastenk\u00fcrzel","ko-KR":"\ub2e8\ucd95\ud0a4"},Shortcuts:{"de-DE":"Tastenkombinationen","ko-KR":"\ub2e8\ucd95\ud0a4"},"Shuffle queue":{"de-DE":"Warteschlange mischen","ko-KR":"\uc21c\uc11c \ub4a4\uc11e\uae30"},Single:{"de-DE":"Nur ein Lied","ko-KR":"\ud55c \uace1\ub9cc"},
"Size in px":{"de-DE":"Gr\u00f6\u00dfe in PX","ko-KR":"\ud53d\uc140 \ud06c\uae30"},"Size normal":{"de-DE":"Normale Gr\u00f6\u00dfe"},"Size small":{"de-DE":"Kleine Gr\u00f6\u00dfe"},"Skip count":{"de-DE":"Wie oft \u00fcbersprungen","ko-KR":"\uac74\ub108\ub6f4 \ud69f\uc218"},"Smart playlist":{"de-DE":"Intelligente Wiedergabeliste","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d"},"Smart playlist %{playlist} updated":{"de-DE":"Intelligente Wiedergabeliste %{playlist} aktualisiert","ko-KR":"%{playlist} \uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc5c5\ub370\uc774\ud2b8\ud568"},
"Smart playlists":{"de-DE":"Intelligente Wiedergabelisten","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d"},"Smart playlists update failed":{"de-DE":"Intelligente Wiedergabelisten konnten nicht aktualisiert werden","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc5c5\ub370\uc774\ud2b8 \uc548 \ub428"},"Smart playlists updated":{"de-DE":"Intelligente Wiedergabelisten wurden aktualisiert","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc5c5\ub370\uc774\ud2b8\ub428"},"Solid color":{"de-DE":"Farbe",
"ko-KR":"\uaf49 \ucc2c \uc0c9\uc0c1"},Song:{"de-DE":"Lied","ko-KR":"\uace1"},"Song details":{"de-DE":"Lieddetails","ko-KR":"\uace1 \uc815\ubcf4"},Songs:{"de-DE":"Lieder","ko-KR":"\uace1"},"Sort by":{"de-DE":"Sortieren"},Specify:{"de-DE":"Manuell","ko-KR":"\uc9c0\uc815"},Statistics:{"de-DE":"Statistiken","ko-KR":"\ud1b5\uacc4"},Sticker:{"de-DE":"Sticker","ko-KR":"\uc2a4\ud2f0\ucee4"},"Stickers are disabled":{"de-DE":"Sticker sind deaktiviert","ko-KR":"\uc2a4\ud2f0\ucee4 \uc0ac\uc6a9 \uc548 \ud568"},
"Stop playing":{"de-DE":"Stop","ko-KR":"\uc815\uc9c0"},"Stream URI":{"de-DE":"Stream URL","ko-KR":"\uc2a4\ud2b8\ub9bc \uc8fc\uc18c"},"Successfully cleared covercache":{"de-DE":"Covercache erfolgreich geleert"},"Successfully croped covercache":{"de-DE":"Covercache erfolgreich bereinigt"},"Successfully execute cmd %{cmd}":{"de-DE":"Systembefehl %{cmd} erfolgreich ausgef\u00fchrt","ko-KR":"%{cmd} \uba85\ub839\uc5b4 \uc2e4\ud589\ud568"},"Sucessfully added random songs to queue":{"de-DE":"Zuf\u00e4llige Lieder wurden zur Warteschlange hinzugef\u00fcgt",
"ko-KR":"\ubb34\uc791\uc704 \uace1\uc744 \uc21c\uc11c\uc5d0 \ucd94\uac00\ud568"},"Sucessfully renamed playlist":{"de-DE":"Wiedergabeliste erfolgreich umbenannt","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d \uc774\ub984 \ubc14\uafc8"},"System command not defined":{"de-DE":"Systembefehl nicht definiert","ko-KR":"\uc2dc\uc2a4\ud15c \uba85\ub839\uc5b4 \uc815\uc758 \uc548\ub428"},"System commands":{"de-DE":"Systembefehle","ko-KR":"\uc2dc\uc2a4\ud15c \uba85\ub839\uc5b4"},"System commands are disabled":{"de-DE":"Systembefehle sind deaktiviert",
"ko-KR":"\uc2dc\uc2a4\ud15c \uba85\ub839\uc5b4 \uc0ac\uc6a9 \uc548 \ud568"},Tag:{"de-DE":"Tag","ko-KR":"\ud0dc\uadf8"},Tags:{"de-DE":"Tags","ko-KR":"\ud0dc\uadf8"},"Tags to browse":{"de-DE":"Tags f\u00fcr die Datenbankanzeige","ko-KR":"\uc5f4 \ud0dc\uadf8"},"Tags to search":{"de-DE":"Tags f\u00fcr die Suche","ko-KR":"\ucc3e\uc744 \ud0dc\uadf8"},"Tags to use":{"de-DE":"Genutzte Tags","ko-KR":"\uc4f8 \ud0dc\uadf8"},Theme:{"de-DE":"Design","ko-KR":"\ud14c\ub9c8"},"Timerange (days)":{"de-DE":"Tage","ko-KR":"\uc2dc\uac04 \ubc94\uc704 (\ub0a0\uc9dc)"},
Title:{"de-DE":"Titel","ko-KR":"\uc81c\ubaa9"},To:{"de-DE":"Zu","ko-KR":"\ubc14\uafc8"},"To top":{"de-DE":"Nach oben","ko-KR":"\uc704\ub85c"},"Toggle play / pause":{"de-DE":"Play / Pause","ko-KR":"\uc5f0\uc8fc / \uc7a0\uc2dc \uba48\ucda4"},Track:{"de-DE":"Liednummer","ko-KR":"\ud2b8\ub799"},Type:{"de-DE":"Typ","ko-KR":"\ud615\uc2dd"},URI:{"de-DE":"URL","ko-KR":"\uc8fc\uc18c"},"Unknown request":{"de-DE":"Unbekannter Befehl","ko-KR":"\uc54c \uc218 \uc5c6\ub294 \uc694\uad6c"},"Unknown smart playlist type":{"de-DE":"Unbekannter intelligenter Wiedergabenlisten Typ",
"ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \ud615\uc2dd\uc744 \uc54c \uc218 \uc5c6\uc74c"},"Unknown table %{table}":{"de-DE":"Unbekannte Tabelle %{table}","ko-KR":"%{table} \ud14c\uc774\ube14 \uc54c \uc218 \uc5c6\uc74c"},Update:{"de-DE":"Aktualisieren","ko-KR":"\uc5c5\ub370\uc774\ud2b8"},"Update database":{"de-DE":"Datenbank aktualisieren","ko-KR":"\ub370\uc774\ud130\ubca0\uc774\uc2a4 \uc5c5\ub370\uc774\ud2b8"},"Update directory":{"de-DE":"Verzeichnis aktualisieren"},"Update smart playlist":{"de-DE":"Intelligente Wiedergabeliste aktualisieren",
"ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc5c5\ub370\uc774\ud2b8"},"Update smart playlists":{"de-DE":"Intelligente Wiedergabelisten aktualisieren","ko-KR":"\uc2a4\ub9c8\ud2b8 \uc5f0\uc8fc\ubaa9\ub85d \uc5c5\ub370\uc774\ud2b8"},"Updating MPD database":{"de-DE":"MPD Datenbank wird aktualisiert","ko-KR":"MPD \ub370\uc774\ud130\ubca0\uc774\uc2a4 \uc5c5\ub370\uc774\ud2b8 \uc911"},"Updating of smart playlist %{playlist} failed":{"de-DE":"Intelligente Wiedergabeliste %{playlist} konnte nicht aktualisiert werden",
...
Work:{"de-DE":"Werk","ko-KR":"\uc791\ud488"},"You need to be playing to crop the playlist":{"de-DE":"Wiedergabe muss gestartet sein um die Warteschlange abzuschneiden","ko-KR":"\uc5f0\uc8fc\ubaa9\ub85d\uc5d0 \ub0a8\uae30\ub824\uba74 \uc5f0\uc8fc \uc911\uc774\uc5b4\uc57c \ud568"},bits:{"de-DE":"Bits","ko-KR":"\ube44\ud2b8"},contains:{"de-DE":"enth\u00e4lt","ko-KR":"\ub0b4\uc6a9"},"folder.jpg":{"de-DE":"folder.jpg","ko-KR":"folder.jpg"},"http://uri.to/stream.mp3":{"de-DE":"http://url.zum/stream.mp3",
"ko-KR":"http://\uc8fc\uc18c/stream.mp3"},kHz:{"de-DE":"kHz","ko-KR":"kHz"},"myMPD CA":{"de-DE":"myMPD Stammzertifikat","ko-KR":"myMPD \uc778\uc99d\uc11c"},"myMPD installed as app":{"de-DE":"myMPD wurde als App installiert","ko-KR":"myMPD\uac00 \uc571\uc73c\ub85c \uc124\uce58\ub428"},"myMPD is in readonly mode":{"de-DE":"myMPD ist im Readonly Modus","ko-KR":"\uc77d\uae30 \uc804\uc6a9 \ubaa8\ub4dc\uc784"},"myMPD uptime":{"de-DE":"myMPD Uptime","ko-KR":"myMPD \uac00\ub3d9 \uc2dc\uac04"},never:{"de-DE":"noch nie",
"ko-KR":"\uc548 \ud568"}},keymap={ArrowLeft:{cmd:"clickPrev",options:[],desc:"Previous song",key:"keyboard_arrow_left"},ArrowRight:{cmd:"clickNext",options:[],desc:"Next song",key:"keyboard_arrow_right"}," ":{cmd:"clickPlay",options:[],desc:"Toggle play / pause",key:"space_bar"},s:{cmd:"clickStop",options:[],desc:"Stop playing"},"-":{cmd:"volumeStep",options:["down"],desc:"Volume down"},"+":{cmd:"VolumeStep",options:["up"],desc:"Volume up"},c:{cmd:"sendAPI",options:[{cmd:"MPD_API_QUEUE_CLEAR"}],desc:"Clear queue"},
u:{cmd:"updateDB",options:[],desc:"Update database"},r:{cmd:"rescanDB",options:[],desc:"Rescan database"},p:{cmd:"updateSmartPlaylists",options:[],desc:"Update smart playlists",req:"featSmartpls"},a:{cmd:"showAddToPlaylist",options:["stream"],desc:"Add stream"},t:{cmd:"openModal",options:["modalSettings"],desc:"Open settings"},i:{cmd:"clickTitle",options:[],desc:"Open song details"},l:{cmd:"openDropdown",options:["dropdownLocalPlayer"],desc:"Open local player"},0:{cmd:"appGoto",options:["Playback"],
desc:"Goto playback"},1:{cmd:"appGoto",options:["Queue","Current"],desc:"Goto queue"},2:{cmd:"appGoto",options:["Queue","LastPlayed"],desc:"Goto last played"},3:{cmd:"appGoto",options:["Browse","Database"],desc:"Goto browse database",req:"featTags"},4:{cmd:"appGoto",options:["Browse","Playlists"],desc:"Goto browse playlists",req:"featPlaylists"},5:{cmd:"appGoto",options:["Browse","Filesystem"],desc:"Goto browse filesystem"},6:{cmd:"appGoto",options:["Browse","Covergrid"],desc:"Goto browse covergrid",
req:"featTags"},7:{cmd:"appGoto",options:["Search"],desc:"Goto search"},m:{cmd:"openDropdown",options:["dropdownMainMenu"],desc:"Open main menu"},v:{cmd:"openDropdown",options:["dropdownVolumeMenu"],desc:"Open volume menu"},S:{cmd:"sendAPI",options:[{cmd:"MPD_API_QUEUE_SHUFFLE"}],desc:"Shuffle queue"},C:{cmd:"sendAPI",options:[{cmd:"MPD_API_QUEUE_CROP"}],desc:"Crop queue"},"?":{cmd:"openModal",options:["modalAbout"],desc:"Open about"},"/":{cmd:"focusSearch",options:[],desc:"Focus search"},n:{cmd:"focusTable",
options:[],desc:"Focus table"},q:{cmd:"queueSelectedItem",options:[!0],desc:"Append item to queue"},Q:{cmd:"queueSelectedItem",options:[!1],desc:"Replace queue with item"},d:{cmd:"dequeueSelectedItem",options:[],desc:"Remove item from queue"},x:{cmd:"addSelectedItemToPlaylist",options:[],desc:"Append item to playlist"}};function e(a){return isNaN(a)?a.replace(/([<>])/g,function(a,c){if("<"===c)return"&lt;";if(">"===c)return"&gt;"}):a}
...
'">'+e(b[f])+"</a></li>";d+="/"}document.getElementById("BrowseBreadcrumb").innerHTML=a;doSetFilterLetter("BrowseFilesystemFilter")}else if("Browse"===app.current.app&&"Covergrid"===app.current.tab)document.getElementById("searchCovergridStr").value=app.current.search,selectTag("searchCovergridTags","searchCovergridTagsDesc",app.current.filter),selectTag("searchCovergridSortTags",void 0,app.current.sort),a=app.current.sort,b=!1,"-"===app.current.sort.charAt(0)?(b=!0,a=app.current.sort.substr(1),document.getElementById("searchCovergridSortDesc").checked=
!0):document.getElementById("searchCovergridSortDesc").checked=!1,sendAPI("MPD_API_DATABASE_GET_ALBUMS",{offset:app.current.page,searchstr:app.current.search,tag:app.current.filter,sort:a,sortdesc:b},parseCovergrid);else if("Search"===app.current.app){domCache.searchstr.focus();if(settings.featAdvsearch){a="";b=app.current.search.substring(1,app.current.search.length-1).split(" AND ");for(c=0;c<b.length-1;c++)d=b[c].substring(1,b[c].length-1),a+='<button data-filter="'+encodeURI(d)+'" class="btn btn-light mr-2">'+
...
a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("BrowseFilesystemBookmarks").addEventListener("click",function(a){if("A"===a.target.nodeName){var b=a.target.parentNode.parentNode.getAttribute("data-id"),c=a.target.parentNode.parentNode.getAttribute("data-type"),f=decodeURI(a.target.parentNode.parentNode.getAttribute("data-uri")),d=a.target.parentNode.parentNode.firstChild.innerText,m=a.target.getAttribute("data-href");"delete"===m?(sendAPI("MYMPD_API_BOOKMARK_RM",{id:b},function(){sendAPI("MYMPD_API_BOOKMARK_LIST",
{offset:0},parseBookmarks)}),a.preventDefault(),a.stopPropagation()):"edit"===m?showBookmarkSave(b,d,f,c):"goto"===m&&appGoto("Browse","Filesystem",void 0,"0/-/-/"+f)}},!1);document.getElementById("BrowsePlaylistsAllList").addEventListener("click",function(a){"TD"===a.target.nodeName?appendQueue("plist",decodeURI(a.target.parentNode.getAttribute("data-uri")),a.target.parentNode.getAttribute("data-name")):"A"===a.target.nodeName&&showMenu(a.target,a)},!1);document.getElementById("BrowsePlaylistsDetailList").addEventListener("click",
...
a.target.nodeName&&(app.current.filter=a.target.getAttribute("data-tag"),appGoto(app.current.app,app.current.tab,app.current.view,"0/"+app.current.filter+"/"+app.current.sort+"/"+app.current.search))},!1);document.getElementById("searchCovergridSortDesc").addEventListener("click",function(a){"-"===app.current.sort.charAt(0)?app.current.sort=app.current.sort.substr(1):app.current.sort="-"+app.current.sort;appGoto(app.current.app,app.current.tab,app.current.view,"0/"+app.current.filter+"/"+app.current.sort+
"/"+app.current.search)},!1);document.getElementById("searchCovergridSortTags").addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&(app.current.sort=a.target.getAttribute("data-tag"),appGoto(app.current.app,app.current.tab,app.current.view,"0/"+app.current.filter+"/"+app.current.sort+"/"+app.current.search))},!1);document.getElementById("searchCovergridStr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0/"+
app.current.filter+"/"+app.current.sort+"/"+this.value)},!1);document.getElementById("searchqueuestr").addEventListener("keyup",function(a){"Escape"===a.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0/"+app.current.filter+"/"+app.current.sort+"/"+this.value)},!1);document.getElementById("searchqueuetags").addEventListener("click",function(a){"BUTTON"===a.target.nodeName&&appGoto(app.current.app,app.current.tab,app.current.view,app.current.page+"/"+a.target.getAttribute("data-tag")+
"/"+app.current.sort+"/"+app.current.search)},!1);a=["BrowseDatabaseColsDropdown","PlaybackColsDropdown"];for(b=0;b<a.length;b++)document.getElementById(a[b]).addEventListener("click",function(a){"INPUT"===a.target.nodeName&&a.stopPropagation()},!1);document.getElementById("search").addEventListener("submit",function(){return!1},!1);document.getElementById("searchqueue").addEventListener("submit",function(){return!1},!1);document.getElementById("searchcovergrid").addEventListener("submit",function(){return!1},
...
c);b=b.substring(b.indexOf(" ")+1);b=b.substring(0,b.indexOf(" "));document.getElementById("searchMatch").value=b;a.target.remove();search(domCache.searchstr.value)}},!1);document.getElementById("searchMatch").addEventListener("change",function(){search(domCache.searchstr.value)},!1);document.getElementById("SearchList").getElementsByTagName("tr")[0].addEventListener("click",function(a){if(settings.featAdvsearch&&"TH"===a.target.nodeName&&""!==a.target.innerHTML){var b=a.target.getAttribute("data-col");
if("Duration"!==b){var c=app.current.sort,d=!0;if(c===b||c==="-"+b)0===c.indexOf("-")?(d=!0,b=c.substring(1)):d=!1;!1===d?(c="-"+b,d=!0):(d=!1,c=b);for(var f=document.getElementById("SearchList").getElementsByClassName("sort-dir"),m=0;m<f.length;m++)f[m].remove();app.current.sort=c;a.target.innerHTML=t(b)+'<span class="sort-dir material-icons pull-right">'+(!0===d?"arrow_drop_up":"arrow_drop_down")+"</span>";appGoto(app.current.app,app.current.tab,app.current.view,app.current.page+"/"+app.current.filter+
...
dragAndDropTableHeader("QueueLastPlayed");dragAndDropTableHeader("Search");dragAndDropTableHeader("BrowseFilesystem");dragAndDropTableHeader("BrowsePlaylistsDetail");window.addEventListener("hashchange",appRoute,!1);window.addEventListener("focus",function(){sendAPI("MPD_API_PLAYER_STATE",{},parseState)},!1);document.addEventListener("keydown",function(a){if("INPUT"!==a.target.tagName&&"SELECT"!==a.target.tagName&&!a.ctrlKey&&!a.altKey){var b=keymap[a.key];b&&"function"===typeof window[b.cmd]&&(void 0===
keymap[a.key].req||!0===settings[keymap[a.key].req])&&parseCmd(a,b)}},!1);a=document.getElementsByTagName("table");for(b=0;b<a.length;b++)a[b].setAttribute("tabindex",0),a[b].addEventListener("keydown",function(a){navigateTable(this,a.key)},!1);var d="";Object.keys(themes).forEach(function(a,b){d+='<option value="'+a+'">'+t(themes[a])+"</option>"});document.getElementById("selectTheme").innerHTML=d;window.addEventListener("beforeinstallprompt",function(a){a.preventDefault();deferredPrompt=a});window.addEventListener("beforeinstallprompt",
function(a){a.preventDefault();deferredPrompt=a;domCache.btnAdd.classList.remove("hide")});domCache.btnAdd.addEventListener("click",function(){domCache.btnAdd.classList.add("hide");deferredPrompt.prompt();deferredPrompt.userChoice.then(function(a){"accepted"===a.outcome?logVerbose("User accepted the A2HS prompt"):logVerbose("User dismissed the A2HS prompt");deferredPrompt=null})});window.addEventListener("appinstalled",function(){logInfo("myMPD installed as app");showNotification(t("myMPD installed as app"),
"","","success")});window.addEventListener("beforeunload",function(){null!==websocketTimer&&(clearTimeout(websocketTimer),websocketTimer=null);null!==socket&&(socket.onclose=function(){},socket.close(),socket=null);websocketConnected=!1});document.getElementById("localPlayer").addEventListener("canplay",function(){document.getElementById("alertLocalPlayback").classList.add("hide");1==settings.featLocalplayer&&1==settings.localplayerAutoplay&&localplayerPlay()})}appInitStart();
...
0;h<b;h++){var l=encodeURI(a.result.data[h].uri),k=document.createElement("tr");k.setAttribute("data-uri",l);k.setAttribute("data-type",a.result.data[h].Type);k.setAttribute("data-name",a.result.data[h].name);k.setAttribute("tabindex",0);k.innerHTML='<td data-col="Type"><span class="material-icons">'+("smartpls"===a.result.data[h].Type?"queue_music":"list")+"</span></td><td>"+e(a.result.data[h].name)+"</td><td>"+localeDate(a.result.data[h].last_modified)+'</td><td data-col="Action"><a href="#" class="material-icons color-darkgrey">'+
ligatureMore+"</a></td>";h<f.length?g=!0===replaceTblRow(f[h],k)?h:g:d.append(k)}document.getElementById("cardFooterBrowse").innerText=gtPage("Num playlists",a.result.returnedEntities,a.result.totalEntities)}else if("Detail"===app.current.view){for(h=0;h<b;h++){k=encodeURI(a.result.data[h].uri);l=document.createElement("tr");!1===a.result.smartpls&&l.setAttribute("draggable","true");l.setAttribute("id","playlistTrackId"+a.result.data[h].Pos);l.setAttribute("data-type",a.result.data[h].Type);l.setAttribute("data-uri",
k);l.setAttribute("data-name",a.result.data[h].Title);l.setAttribute("data-songpos",a.result.data[h].Pos);l.setAttribute("tabindex",0);a.result.data[h].Duration=beautifySongDuration(a.result.data[h].Duration);k="";for(var m=0;m<settings.colsBrowsePlaylistsDetail.length;m++)k+='<td data-col="'+settings.colsBrowsePlaylistsDetail[m]+'">'+e(a.result.data[h][settings.colsBrowsePlaylistsDetail[m]])+"</td>";k+='<td data-col="Action"><a href="#" class="material-icons color-darkgrey">'+ligatureMore+"</a></td>";
...
b=a.Popover;a.setAttribute("data-init","true");a.addEventListener("shown.bs.popover",function(a){a.target.setAttribute("data-popover","true");var b=app.current.app+(void 0!==app.current.tab?app.current.tab:"")+(void 0!==app.current.view?app.current.view:"");document.getElementById("colChecklist"+b).addEventListener("click",function(a){"BUTTON"===a.target.nodeName?(a.preventDefault(),saveCols(b)):"INPUT"===a.target.nodeName&&a.stopPropagation()},!1)},!1);b.show()}
function showMenuTd(a,b){b=a.getAttribute("data-type");var c=decodeURI(a.getAttribute("data-uri")),d=a.getAttribute("data-name"),f=0;if(null===b||""===c)b=a.parentNode.parentNode.getAttribute("data-type"),c=decodeURI(a.parentNode.parentNode.getAttribute("data-uri")),d=a.parentNode.parentNode.getAttribute("data-name");lastState&&(f=lastState.nextSongPos);var g="";"Browse"===app.current.app&&"Filesystem"===app.current.tab||"Search"===app.current.app||"Browse"===app.current.app&&"Database"===app.current.tab?
...
toggleBtnChk("btnLocalplayerAutoplay",settings.localplayerAutoplay);toggleBtnChk("btnBookmarks",settings.featBookmarks);""===settings.streamUrl?(document.getElementById("selectStreamMode").value="port",document.getElementById("inputStreamUrl").value=settings.streamPort):(document.getElementById("selectStreamMode").value="url",document.getElementById("inputStreamUrl").value=settings.streamUrl);toggleBtnChk("btnCoverimage",settings.coverimage);document.getElementById("selectLocale").value=settings.locale;
document.getElementById("inputCoverimageName").value=settings.coverimageName;document.getElementById("inputCoverimageSize").value=settings.coverimageSize;document.getElementById("inputCovergridSize").value=settings.covergridSize;document.documentElement.style.setProperty("--mympd-coverimagesize",settings.coverimageSize+"px");document.documentElement.style.setProperty("--mympd-covergridsize",settings.covergridSize+"px");document.getElementById("inputBgColor").value=settings.bgColor;document.getElementsByTagName("body")[0].style.backgroundColor=
settings.bgColor;document.getElementById("inputBgCssFilter").value=settings.bgCssFilter;b=document.querySelectorAll(".albumartbg");for(var c=0;c<b.length;c++)b[c].style.filter=settings.bgCssFilter;toggleBtnChk("btnLoveEnable",settings.love);document.getElementById("inputLoveChannel").value=settings.loveChannel;document.getElementById("inputLoveMessage").value=settings.loveMessage;document.getElementById("inputMaxElementsPerPage").value=settings.maxElementsPerPage;toggleBtnChk("btnStickers",settings.stickers);
document.getElementById("inputLastPlayedCount").value=settings.lastPlayedCount;toggleBtnChk("btnSmartpls",settings.smartpls);b=["featLocalplayer","featSyscmds","featMixramp","featCacert","featBookmarks"];for(c=0;c<b.length;c++)for(var d=document.getElementsByClassName(b[c]),f=d.length,g=!0===settings[b[c]]?"":"none",h=0;h<f;h++)d[h].style.display=g;b=document.getElementsByClassName("warnReadonly");for(c=0;c<b.length;c++)!1===settings.readonly?b[c].classList.add("hide"):b[c].classList.remove("hide");
!0===settings.readonly?(document.getElementById("btnBookmarks").setAttribute("disabled","disabled"),document.getElementsByClassName("groupClearCovercache")[0].classList.add("hide")):(document.getElementById("btnBookmarks").removeAttribute("disabled"),document.getElementsByClassName("groupClearCovercache")[0].classList.remove("hide"));if(settings.featSyscmds){b="";c=settings.syscmdList.length;if(0<c)for(b=4<c?"":'<div class="dropdown-divider"></div>',d=0;d<c;d++)b="HR"===settings.syscmdList[d]?b+'<div class="dropdown-divider"></div>':
b+('<a class="dropdown-item text-light bg-dark alwaysEnabled" href="#" data-href=\'{"cmd": "execSyscmd", "options": ["'+e(settings.syscmdList[d])+"\"]}'>"+e(settings.syscmdList[d])+"</a>");document.getElementById("syscmds").innerHTML=b;4<c?(document.getElementById("navSyscmds").classList.remove("hide"),document.getElementById("syscmds").classList.add("collapse","menu-indent")):(document.getElementById("navSyscmds").classList.add("hide"),document.getElementById("syscmds").classList.remove("collapse",
"menu-indent"))}else document.getElementById("syscmds").innerHTML="";dropdownMainMenu=new Dropdown(document.getElementById("mainMenu"));document.getElementById("selectJukeboxMode").value=settings.jukeboxMode;document.getElementById("inputJukeboxQueueLength").value=settings.jukeboxQueueLength;0===settings.jukeboxMode?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").setAttribute("disabled","disabled")):2===settings.jukeboxMode?
(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").value="Database"):1===settings.jukeboxMode&&(document.getElementById("inputJukeboxQueueLength").removeAttribute("disabled"),document.getElementById("selectJukeboxPlaylist").removeAttribute("disabled"));!0===settings.featLocalplayer&&(""===settings.streamUrl?(settings.mpdstream="http://",
null!==settings.mpdHost.match(/^127\./)||"localhost"===settings.mpdHost||null!==settings.mpdHost.match(/^\//)?settings.mpdstream+=window.location.hostname:settings.mpdstream+=settings.mpdHost,settings.mpdstream+=":"+settings.streamPort+"/"):settings.mpdstream=settings.streamUrl,b=document.getElementById("localPlayer"),b.src!==settings.mpdstream&&(b.pause(),document.getElementById("alertLocalPlayback").classList.remove("hide"),b.src=settings.mpdstream,b.load()));"auto"===settings.musicDirectory?(document.getElementById("selectMusicDirectory").value=
settings.musicDirectory,document.getElementById("inputMusicDirectory").value=settings.musicDirectoryValue,document.getElementById("inputMusicDirectory").setAttribute("readonly","readonly")):"none"===settings.musicDirectory?(document.getElementById("selectMusicDirectory").value=settings.musicDirectory,document.getElementById("inputMusicDirectory").value="",document.getElementById("inputMusicDirectory").setAttribute("readonly","readonly")):(document.getElementById("selectMusicDirectory").value="custom",
document.getElementById("inputMusicDirectory").value=settings.musicDirectoryValue,document.getElementById("inputMusicDirectory").removeAttribute("readonly"));"Queue"===app.current.app&&"Current"===app.current.tab?getQueue():"Queue"===app.current.app&&"LastPlayed"===app.current.tab?appRoute():"Search"===app.current.app?appRoute():"Browse"===app.current.app&&"Filesystem"===app.current.tab?appRoute():"Browse"===app.current.app&&"Playlists"===app.current.tab&&"Detail"===app.current.view?appRoute():"Browse"===
app.current.app&&"Database"===app.current.tab&&""!==app.current.search&&appRoute();i18nHtml(document.getElementsByTagName("body")[0]);checkConsume();settingsParsed="true"}
...
function saveSettings(){var a=!0,b=document.getElementById("inputCrossfade");b.getAttribute("disabled")||validateInt(b)||(a=!1);b=document.getElementById("inputJukeboxQueueLength");validateInt(b)||(a=!1);var c=document.getElementById("selectStreamMode"),d=b="",f=document.getElementById("inputStreamUrl");"port"===c.options[c.selectedIndex].value?(d=f.value,validateInt(f)||(a=!1)):(b=f.value,validateStream(f)||(a=!1));c=document.getElementById("inputCovergridSize");validateInt(c)||(a=!1);c=document.getElementById("inputCoverimageSize");
validateInt(c)||(a=!1);c=document.getElementById("inputCoverimageName");validateFilenameList(c)||(a=!1);c=document.getElementById("inputMaxElementsPerPage");validateInt(c)||(a=!1);200<parseInt(c.value)&&(a=!1);c=document.getElementById("inputLastPlayedCount");validateInt(c)||(a=!1);document.getElementById("btnLoveEnable").classList.contains("active")&&(c=document.getElementById("inputLoveChannel"),f=document.getElementById("inputLoveMessage"),validateNotBlank(c)&&validateNotBlank(f)||(a=!1));!0===
settings.featMixramp&&(c=document.getElementById("inputMixrampdb"),c.getAttribute("disabled")||validateFloat(c)||(a=!1),c=document.getElementById("inputMixrampdelay"),c.getAttribute("disabled")||("nan"===c.value&&(c.value="-1"),validateFloat(c)||(a=!1)));if(!0===a){a=document.getElementById("selectReplaygain");c=document.getElementById("selectJukeboxPlaylist");f=document.getElementById("selectJukeboxMode");var g=document.getElementById("selectLocale"),h=document.getElementById("selectTheme");sendAPI("MYMPD_API_SETTINGS_SET",
{consume:document.getElementById("btnConsume").classList.contains("active")?1:0,random:document.getElementById("btnRandom").classList.contains("active")?1:0,single:document.getElementById("btnSingle").classList.contains("active")?1:0,repeat:document.getElementById("btnRepeat").classList.contains("active")?1:0,replaygain:a.options[a.selectedIndex].value,crossfade:document.getElementById("inputCrossfade").value,mixrampdb:!0===settings.featMixramp?document.getElementById("inputMixrampdb").value:settings.mixrampdb,
mixrampdelay:!0===settings.featMixramp?document.getElementById("inputMixrampdelay").value:settings.mixrampdelay,notificationWeb:document.getElementById("btnNotifyWeb").classList.contains("active")?!0:!1,notificationPage:document.getElementById("btnNotifyPage").classList.contains("active")?!0:!1,jukeboxMode:parseInt(f.options[f.selectedIndex].value),jukeboxPlaylist:c.options[c.selectedIndex].value,jukeboxQueueLength:parseInt(document.getElementById("inputJukeboxQueueLength").value),autoPlay:document.getElementById("btnAutoPlay").classList.contains("active")?
!0:!1,bgCover:document.getElementById("btnBgCover").classList.contains("active")?!0:!1,bgColor:document.getElementById("inputBgColor").value,bgCssFilter:document.getElementById("inputBgCssFilter").value,featLocalplayer:document.getElementById("btnFeatLocalplayer").classList.contains("active")?!0:!1,localplayerAutoplay:document.getElementById("btnLocalplayerAutoplay").classList.contains("active")?!0:!1,streamUrl:b,streamPort:parseInt(d),coverimage:document.getElementById("btnCoverimage").classList.contains("active")?
!0:!1,coverimageName:document.getElementById("inputCoverimageName").value,coverimageSize:document.getElementById("inputCoverimageSize").value,covergridSize:document.getElementById("inputCovergridSize").value,locale:g.options[g.selectedIndex].value,love:document.getElementById("btnLoveEnable").classList.contains("active")?!0:!1,loveChannel:document.getElementById("inputLoveChannel").value,loveMessage:document.getElementById("inputLoveMessage").value,bookmarks:document.getElementById("btnBookmarks").classList.contains("active")?
!0:!1,maxElementsPerPage:document.getElementById("inputMaxElementsPerPage").value,stickers:document.getElementById("btnStickers").classList.contains("active")?!0:!1,lastPlayedCount:document.getElementById("inputLastPlayedCount").value,smartpls:document.getElementById("btnSmartpls").classList.contains("active")?!0:!1,taglist:getTagMultiSelectValues("listEnabledTags"),searchtaglist:getTagMultiSelectValues("listSearchTags"),browsetaglist:getTagMultiSelectValues("listBrowseTags"),theme:h.options[h.selectedIndex].value},
getSettings);modalSettings.hide()}}function getTagMultiSelectValues(a){var b=[];a=document.getElementById(a).getElementsByTagName("input");for(var c=0;c<a.length;c++)!0===a[c].checked&&b.push(a[c].name);return b.join(",")}
...
a.result.Album,d+="<br/>"+a.result.Album);void 0!==a.result.Title&&0<a.result.Title.length?(f+=a.result.Title,domCache.currentTitle.innerText=a.result.Title,domCache.currentTitle.setAttribute("data-uri",encodeURI(a.result.uri))):(domCache.currentTitle.innerText="",domCache.currentTitle.setAttribute("data-uri",""));document.title="myMPD: "+f;document.getElementById("headerTitle").innerText=f;document.getElementById("headerTitle").title=f;void 0!==a.result.uri?(!0===settings.featStickers&&setVoteSongBtns(a.result.like,
a.result.uri),a.result.Filetype=filetype(a.result.uri)):a.result.Filetype="";a.result.Fileformat=lastState?fileformat(lastState.audioFormat):"";for(f=0;f<settings.colsPlayback.length;f++){var g=document.getElementById("current"+settings.colsPlayback[f]);if(g){var h=a.result[settings.colsPlayback[f]];void 0===h&&(h="");"Duration"==settings.colsPlayback[f]&&(h=beautifySongDuration(h));g.getElementsByTagName("p")[0].innerText=h;g.setAttribute("data-name",encodeURI(h))}}if(f=document.getElementById("queueTrackId"+
a.result.currentSongId))f.getElementsByTagName("td")[1].innerText=a.result.Title;"play"===playstate&&showNotification(a.result.Title,c,d,"success");lastSong=b;lastSongObj=a.result}}function gotoTagList(){appGoto(app.current.app,app.current.tab,app.current.view,"0/-/-/")}function volumeStep(a){chVolume("up"===a?settings.volumeStep:0-settings.volumeStep)}
...
b){var c=b.getElementsByClassName("selected");if(void 0===a)0===c.length?(a=b.getElementsByTagName("tbody")[0].rows[0],a.focus(),a.classList.add("selected")):c[0].focus();else{c&&0<c.length&&c[0].classList.remove("selected");c=b.getElementsByTagName("tbody")[0].rows;var d=c.length;d<a&&(a=0);d>a&&(c[a].focus(),c[a].classList.add("selected"))}"BrowseFilesystemList"===b.id&&(a=b.getElementsByTagName("tbody")[0],0<a.rows.length&&"parentDir"!==a.rows[0].getAttribute("data-type")&&""!==app.current.search&&
(b=b.getElementsByTagName("thead")[0].rows[0].cells.length,c=app.current.search.replace(/\/?([^/]+)$/,""),a=a.insertRow(0),a.setAttribute("data-type","parentDir"),a.setAttribute("tabindex",0),a.setAttribute("data-uri",encodeURI(c)),a.innerHTML='<td colspan="'+b+'">..</td>'));scrollFocusIntoView()}}function scrollFocusIntoView(){var a=document.activeElement,b=a.getBoundingClientRect().top;a=a.offsetHeight;74>b?window.scrollBy(0,-74):b+a>window.innerHeight-74&&window.scrollBy(0,74)}
...
function setColsChecklist(a){for(var b="",c=setColTags(a),d=0;d<c.length;d++)if("Playback"!==a||"Title"!==c[d])b+='<div class="form-check"><input class="form-check-input" type="checkbox" value="1" name="'+c[d]+'"',settings["cols"+a].includes(c[d])&&(b+="checked"),b+='><label class="form-check-label" for="'+c[d]+'">&nbsp;&nbsp;'+t(c[d])+"</label></div>";return b}
function setCols(a,b){var c=document.getElementById(a+"ColsDropdown");c&&(c.firstChild.innerHTML=setColsChecklist(a));setColTags(a);var d=app.current.sort;"Search"===a&&"0/any/Title/"===app.apps.Search.state&&(d=settings.tags.includes("Title")?"Title":!1===settings.featTags?"Filename":"-");if("Playback"!==a){c="";for(var f=0;f<settings["cols"+a].length;f++){var g=settings["cols"+a][f];c+='<th draggable="true" data-col="'+g+'">';if("Track"===g||"Pos"===g)g="#";c+=t(g);"Search"!==a||g!==d&&"-"+g!==
d||(g=!1,0===app.current.sort.indexOf("-")&&(g=!0),c+='<span class="sort-dir material-icons pull-right">'+(!0===g?"arrow_drop_up":"arrow_drop_down")+"</span>");c+="</th>"}c=!0===settings.featTags&&"BrowseDatabase"!==a?c+'<th data-col="Action"><a href="#" class="text-secondary align-middle material-icons material-icons-small">settings</a></th>':c+"<th></th>";if(void 0===b)document.getElementById(a+"List").getElementsByTagName("tr")[0].innerHTML=c;else for(a=document.querySelectorAll(b),b=0;b<a.length;b++)a[b].getElementsByTagName("tr")[0].innerHTML=
c}}
function saveCols(a,b){var c=document.getElementById(a+"ColsDropdown");b=void 0===b?document.getElementById(a+"List").getElementsByTagName("tr")[0]:"string"===typeof b?document.querySelector(b).getElementsByTagName("tr")[0]:b.getElementsByTagName("tr")[0];if(c){c=c.firstChild.getElementsByTagName("input");for(var d=0;d<c.length;d++){var f=b.querySelector("[data-col="+c[d].name+"]");!1===c[d].checked?f&&f.remove():f||(f=document.createElement("th"),f.innerText=c[d].name,f.setAttribute("data-col",c[d].name),
b.appendChild(f))}}a={table:"cols"+a,cols:[]};b=b.getElementsByTagName("th");for(c=0;c<b.length;c++)(d=b[c].getAttribute("data-col"))&&a.cols.push(d);sendAPI("MYMPD_API_COLS_SAVE",a,getSettings)}
