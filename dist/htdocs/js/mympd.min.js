...
"menu-indent")):(document.getElementById("navSyscmds").classList.add("hide"),document.getElementById("syscmds").classList.remove("collapse","menu-indent"))}else document.getElementById("syscmds").innerHTML="";if(!0===settings.featScripting){c="";d=settings.scriptList.length;if(0<d)for(b+='<optgroup data-value="script" label="'+t("Script")+'">',settings.scriptList.sort(),g=f=0;g<d;g++){h=settings.scriptList[g];var k=h.match(/^(\d+)(.+)$/),l=!1;null!==k&&(h=k[2],l=!0);"HR"===settings.scriptList[g]?
c+='<div class="dropdown-divider"></div>':(!0===l&&(0===f&&(c=4<d?"":'<div class="dropdown-divider"></div>'),f++,c+='<a title="'+e(settings.scriptList[g])+'" class="dropdown-item text-light alwaysEnabled" href="#" data-href=\'{"cmd": "execScript", "options": ["'+e(settings.scriptList[g])+"\"]}'>"+e(h)+"</a>"),b+='<option value="'+e(settings.scriptList[g])+'">'+e(h)+"</option>")}document.getElementById("scripts").innerHTML=c;b+="</optgroup>";4<d?(document.getElementById("navScripting").classList.remove("hide"),
document.getElementById("scripts").classList.add("collapse","menu-indent")):(document.getElementById("navScripting").classList.add("hide"),document.getElementById("scripts").classList.remove("collapse","menu-indent"))}else document.getElementById("scripts").innerHTML="";document.getElementById("selectTimerAction").innerHTML=b;toggleBtnGroupValueCollapse(document.getElementById("btnJukeboxModeGroup"),"collapseJukeboxMode",settings.jukeboxMode);document.getElementById("selectJukeboxUniqueTag").value=
