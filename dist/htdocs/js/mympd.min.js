...
function songChange(a){var b=JSON.stringify(a.result);if(lastSong!==b){var c="",d="",f="";setCurrentCover(a.result.cover);!0===settings.bgCover&&!0===settings.featCoverimage&&(-1<a.result.cover.indexOf("coverimage-")?clearBackgroundImage():setBackgroundImage(a.result.cover));void 0!==a.result.Artist&&0<a.result.Artist.length&&"-"!==a.result.Artist&&(c+=a.result.Artist,d+=a.result.Artist,f+=a.result.Artist+" - ");void 0!==a.result.Album&&0<a.result.Album.length&&"-"!==a.result.Album&&(c+=" - "+a.result.Album,
d+="<br/>"+a.result.Album);void 0!==a.result.Title&&0<a.result.Title.length?(f+=a.result.Title,domCache.currentTitle.innerText=a.result.Title,domCache.currentTitle.setAttribute("data-uri",encodeURI(a.result.uri))):(domCache.currentTitle.innerText="",domCache.currentTitle.setAttribute("data-uri",""));document.title="myMPD: "+f;document.getElementById("headerTitle").innerText=f;document.getElementById("headerTitle").title=f;!0===settings.featStickers&&setVoteSongBtns(a.result.like,a.result.uri);logDebug("colsPlayback: "+
