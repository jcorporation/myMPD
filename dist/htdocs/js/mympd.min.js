...
"myMPD: "+f;document.getElementById("headerTitle").innerText=f;document.getElementById("headerTitle").title=f;void 0!==a.result.uri&&!0===settings.featStickers&&setVoteSongBtns(a.result.like,a.result.uri);for(f=0;f<settings.colsPlayback.length;f++){var g=document.getElementById("current"+settings.colsPlayback[f]);if(g){var h=a.result[settings.colsPlayback[f]];void 0===h&&(h="");g.getElementsByTagName("h4")[0].innerText=h;g.setAttribute("data-name",encodeURI(h))}}if(f=document.getElementById("queueTrackId"+
...
function clickTitle(){var a=decodeURI(domCache.currentTitle.getAttribute("data-uri"));""!==a&&songDetails(a)}
