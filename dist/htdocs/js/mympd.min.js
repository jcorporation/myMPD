...
function getSelectValue(a){"string"===typeof a&&(a=document.getElementById(a));return a.options[a.selectedIndex].value}function getSelectedOptionAttribute(a,b){a=document.getElementById(a);return a.options[a.selectedIndex].getAttribute(b)}
