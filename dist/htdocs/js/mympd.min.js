...
break;case "mpd_disconnected":toggleAlert("alertMpdState",!0,"Connection to MPD failed.");progressTimer&&clearTimeout(progressTimer);break;case "mpd_connected":showNotification("Connected to MPD","","","success");toggleAlert("alertMpdState",!1,"");break;case "update_queue":"Queue"===app.current.app&&getQueue();sendAPI({cmd:"MPD_API_PLAYER_STATE"},parseState);break;case "update_options":getSettings();break;case "update_outputs":sendAPI({cmd:"MPD_API_PLAYER_OUTPUT_LIST"},parseOutputs);break;case "update_started":updateDBstarted(!1);
