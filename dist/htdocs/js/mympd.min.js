...
function parseListTitles(a){var b=genId(a.Album),c=document.getElementById("card"+b),d=c.getElementsByTagName("tbody")[0],f=c.getElementsByTagName("tfoot")[0],g=c.querySelector(".card-header");g.setAttribute("data-uri",encodeURI(a.data[0].uri.replace(/\/[^\/]+$/,"")));g.setAttribute("data-name",a.Album);g.setAttribute("data-type","dir");g.addEventListener("click",function(a){showMenu(this,a)},!1);g.classList.add("clickable");if(c=c.getElementsByTagName("a")[0])c.style.backgroundImage='url("'+subdir+
