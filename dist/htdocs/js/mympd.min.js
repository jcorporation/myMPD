...
"update_database"===a?showNotification(t("Database successfully updated"),"","","success"):"update_finished"===a&&showNotification(t("Database update finished"),"","","success")}function unmountMount(a){sendAPI("MPD_API_MOUNT_UNMOUNT",{uri:a},showListMounts)}
...
domCache.searchCrumb=document.getElementById("searchCrumb");domCache.body=document.getElementsByTagName("body")[0];
...
"BUTTON"===a.target.nodeName&&toggleTimer(a.target,a.target.parentNode.parentNode.getAttribute("data-id"))},!1);document.getElementById("listMountsList").addEventListener("click",function(a){a.stopPropagation();a.preventDefault();if("TD"===a.target.nodeName){if(""===a.target.parentNode.getAttribute("data-point"))return!1;showEditMount(decodeURI(a.target.parentNode.getAttribute("data-url")),decodeURI(a.target.parentNode.getAttribute("data-point")))}else"A"===a.target.nodeName&&unmountMount(decodeURI(a.target.parentNode.parentNode.getAttribute("data-point")))},
