...
"AlbumArist",app={apps:{Home:{page:0,filter:"-",sort:"-",tag:"-",search:"",scrollPos:0},Playback:{page:0,filter:"-",sort:"-",tag:"-",search:"",scrollPos:0},Queue:{active:"Current",tabs:{Current:{page:0,filter:"any",sort:"-",tag:"-",search:"",scrollPos:0},LastPlayed:{page:0,filter:"any",sort:"-",tag:"-",search:"",scrollPos:0},Jukebox:{page:0,filter:"any",sort:"-",tag:"-",search:"",scrollPos:0}}},Browse:{active:"Database",tabs:{Filesystem:{page:0,filter:"-",sort:"-",tag:"-",search:"",scrollPos:0},Playlists:{active:"All",
...
initTagMultiSelect("inputSearchTags","listSearchTags",settings.tags,settings.searchtags);initTagMultiSelect("inputBrowseTags","listBrowseTags",settings.tags,settings.browsetags);initTagMultiSelect("inputGeneratePlsTags","listGeneratePlsTags",settings.browsetags,settings.generatePlsTags)}function resetSettings(){sendAPI("MYMPD_API_SETTINGS_RESET",{},getSettings)}
