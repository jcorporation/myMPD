...
dropdownNeighbors=new BSN.Dropdown(document.getElementById("btnDropdownNeighbors")),dropdownHomeIconLigature=new BSN.Dropdown(document.getElementById("btnHomeIconLigature")),collapseDBupdate=new BSN.Collapse(document.getElementById("navDBupdate")),collapseSettings=new BSN.Collapse(document.getElementById("navSettings")),collapseSyscmds=new BSN.Collapse(document.getElementById("navSyscmds")),collapseScripting=new BSN.Collapse(document.getElementById("navScripting")),collapseJukeboxMode=new BSN.Collapse(document.getElementById("labelJukeboxMode"));
