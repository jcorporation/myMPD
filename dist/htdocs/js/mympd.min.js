...
function songChange(a){var b=JSON.stringify(a.result);if(lastSong!==b){var c="",d="",f="";void 0!==a.result.cover?setCurrentCover(a.result.cover):setCurrentCover("/assets/coverimage-notavailable.svg");!0===settings.bgCover&&!0===settings.featCoverimage&&(void 0===a.result.cover||-1<a.result.cover.indexOf("coverimage-")?clearBackgroundImage():setBackgroundImage(a.result.cover));void 0!==a.result.Artist&&0<a.result.Artist.length&&"-"!==a.result.Artist&&(c+=a.result.Artist,d+=a.result.Artist,f+=a.result.Artist+
" - ");void 0!==a.result.Album&&0<a.result.Album.length&&"-"!==a.result.Album&&(c+=" - "+a.result.Album,d+="<br/>"+a.result.Album);void 0!==a.result.Title&&0<a.result.Title.length?(f+=a.result.Title,domCache.currentTitle.innerText=a.result.Title,domCache.currentTitle.setAttribute("data-uri",encodeURI(a.result.uri))):(domCache.currentTitle.innerText="",domCache.currentTitle.setAttribute("data-uri",""));document.title="myMPD: "+f;document.getElementById("headerTitle").innerText=f;document.getElementById("headerTitle").title=
f;void 0!==a.result.uri&&!0===settings.featStickers&&setVoteSongBtns(a.result.like,a.result.uri);logDebug("colsPlayback: "+JSON.stringify(settings.colsPlayback));for(f=0;f<settings.colsPlayback.length;f++){var g=document.getElementById("current"+settings.colsPlayback[f]);if(g){var h=a.result[settings.colsPlayback[f]];void 0===h&&(h="");g.getElementsByTagName("h4")[0].innerText=h;g.setAttribute("data-name",encodeURI(h))}}if(f=document.getElementById("queueTrackId"+a.result.currentSongId))f.getElementsByTagName("td")[1].innerText=
