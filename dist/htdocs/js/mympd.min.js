...
function appGoto(a,b,c,f,h,d,g,k,l){var m=document.body.scrollTop?document.body.scrollTop:document.documentElement.scrollTop;void 0!==app.apps[app.current.app].scrollPos?app.apps[app.current.app].scrollPos=m:void 0!==app.apps[app.current.app].tabs[app.current.tab].scrollPos?app.apps[app.current.app].tabs[app.current.tab].scrollPos=m:void 0!==app.apps[app.current.app].tabs[app.current.tab].views[app.current.view].scrollPos&&(app.apps[app.current.app].tabs[app.current.tab].views[app.current.view].scrollPos=
m);app.apps[a].tabs?(void 0===b&&(b=app.apps[a].active),app.apps[a].tabs[b].views?(void 0===c&&(c=app.apps[a].tabs[b].active),f="/"+encodeURIComponent(a)+"/"+encodeURIComponent(b)+"/"+encodeURIComponent(c)+"!"+encodeURIComponent(void 0===f?app.apps[a].tabs[b].views[c].page:f)+"/"+encodeURIComponent(void 0===h?app.apps[a].tabs[b].views[c].filter:h)+"/"+encodeURIComponent(void 0===d?app.apps[a].tabs[b].views[c].sort:d)+"/"+encodeURIComponent(void 0===g?app.apps[a].tabs[b].views[c].tag:g)+"/"+encodeURIComponent(void 0===
k?app.apps[a].tabs[b].views[c].search:k),void 0!==l&&(app.apps[a].tabs[b].views[c].scrollPos=l)):(f="/"+encodeURIComponent(a)+"/"+encodeURIComponent(b)+"!"+encodeURIComponent(void 0===f?app.apps[a].tabs[b].page:f)+"/"+encodeURIComponent(void 0===h?app.apps[a].tabs[b].filter:h)+"/"+encodeURIComponent(void 0===d?app.apps[a].tabs[b].sort:d)+"/"+encodeURIComponent(void 0===g?app.apps[a].tabs[b].tag:g)+"/"+encodeURIComponent(void 0===k?app.apps[a].tabs[b].search:k),void 0!==l&&(app.apps[a].tabs[b].scrollPos=
l))):(f="/"+encodeURIComponent(a)+"!"+encodeURIComponent(void 0===f?app.apps[a].page:f)+"/"+encodeURIComponent(void 0===h?app.apps[a].filter:h)+"/"+encodeURIComponent(void 0===d?app.apps[a].sort:d)+"/"+encodeURIComponent(void 0===g?app.apps[a].tag:g)+"/"+encodeURIComponent(void 0===k?app.apps[a].search:k),void 0!==l&&(app.apps[a].scrollPos=l));location.hash=f}
...
function setPagination(a,b){var c=app.current.app+(void 0===app.current.tab?"":app.current.tab),f=Math.ceil(a/settings.maxElementsPerPage);0===f&&(f=1);for(var h=parseInt(app.current.page)+parseInt(settings.maxElementsPerPage),d=[document.getElementById(c+"PaginationTop"),document.getElementById(c+"PaginationBottom")],g=0;g<d.length;g++){var k=d[g].children[0],l=d[g].children[1].children[0],m=d[g].children[1].children[1],n=d[g].children[2];l.innerText=app.current.page/settings.maxElementsPerPage+
1+" / "+f;if(1<f){l.removeAttribute("disabled");for(var p="",q=0;q<f;q++)p+='<button data-page="'+q*settings.maxElementsPerPage+'" type="button" class="mr-1 mb-1 btn-sm btn btn-secondary">'+(q+1)+"</button>";m.innerHTML=p;l.classList.remove("nodropdown")}else-1===a?(l.setAttribute("disabled","disabled"),l.innerText=app.current.page/settings.maxElementsPerPage+1):l.setAttribute("disabled","disabled"),l.classList.add("nodropdown");a>h||-1===a&&b>=settings.maxElementsPerPage?(n.removeAttribute("disabled"),
d[g].classList.remove("hide"),document.getElementById(c+"ButtonsBottom").classList.remove("hide")):(n.setAttribute("disabled","disabled"),d[g].classList.add("hide"),document.getElementById(c+"ButtonsBottom").classList.add("hide"));0<app.current.page?(k.removeAttribute("disabled"),d[g].classList.remove("hide"),document.getElementById(c+"ButtonsBottom").classList.remove("hide")):k.setAttribute("disabled","disabled")}}function genId(a){return"id"+a.replace(/[^\w-]/g,"")}
