...
var cmds = [
    ...
    {"jsonrpc":"2.0","id":0,"method":"MPD_API_DATABASE_SEARCH_ADV","params":{"offset":0,"expression":"","sort":"", "sortdesc":true,"plist":"","cols":[""],"replace":false}},
    {"jsonrpc":"2.0","id":0,"method":"MPD_API_DATABASE_SEARCH_ADV","params":{"offset":0,"expression":"","sort":"", "sortdesc":"","plist":"","cols":[""],"replace":false}},
...
function sendAPI() {
    ...
    ajaxRequest.onreadystatechange = function() {
        if (ajaxRequest.readyState === 4) {
            document.getElementById('result').innerText = ajaxRequest.responseText;
        }
    };
