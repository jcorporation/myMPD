...
var cmds = [
    '{"cmd":"MYMPD_API_BOOKMARK_SAVE","data":{"id": -1, "name":"testdir1", "uri":"parent1/child1", "type": "dir"}}',
    '{"cmd":"MYMPD_API_BOOKMARK_SAVE","data":{"id": -1, "name":"testdir2", "uri":"parent2/child2", "type": "dir"}}',
    '{"cmd":"MYMPD_API_BOOKMARK_SAVE","data":{"id": 2, "name":"testdir2id2", "uri":"parent1/child1/child2", "type": "dir"}}',
    '{"cmd":"MYMPD_API_BOOKMARK_LIST","data":{"offset":0}}',
    '{"cmd":"MYMPD_API_BOOKMARK_RM","data":{"id":1}}',
    '{"cmd":"MPD_API_QUEUE_CLEAR"}',
    '{"cmd":"MPD_API_DATABASE_SEARCH","data":{"offset":0,"filter":"any","searchstr":"__SEARCHSTR__","plist":"","cols":["Title","Album"]}}',
    ...
    '{"cmd":"MPD_API_QUEUE_SEARCH","data":{"offset":0,"filter":"any","searchstr":"__SEARCHSTR__","cols":["Title","Album"]}}',
    ...
    '{"cmd":"MPD_API_PLAYLIST_CONTENT_LIST","data":{"uri":"test2","offset":0,"filter":"","cols":["Title","Album"]}}',
...
//    '{"cmd":"MPD_API_DATABASE_RESCAN"}',
    ...
    '{"cmd":"MPD_API_DATABASE_TAG_ALBUM_TITLE_LIST","data":{"album":"__ALBUM1__","search":"__ARTIST1__","tag":"Artist","cols":["Title","Album"]}}',
