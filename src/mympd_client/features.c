...
static void features_tags(struct t_mympd_state *mympd_state, struct t_partition_state *partition_state) {
    //reset all tags
    mympd_mpd_tags_reset(&partition_state->mpd_state->tags_mpd);
    mympd_mpd_tags_reset(&partition_state->mpd_state->tags_mympd);
    mympd_mpd_tags_reset(&partition_state->mpd_state->tags_search);
    mympd_mpd_tags_reset(&partition_state->mpd_state->tags_browse);
    mympd_mpd_tags_reset(&partition_state->mpd_state->tags_album);
...
static void features_mpd_tags(struct t_partition_state *partition_state) {
    ...
    bool has_albumartist = mympd_client_tag_exists(&partition_state->mpd_state->tags_mympd, MPD_TAG_ALBUM_ARTIST);
