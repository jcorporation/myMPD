...
sds mpd_client_get_fingerprint(struct t_mympd_state *mympd_state, sds buffer, sds method,
                               long request_id, const char *uri);
sds mpd_client_get_songdetails(struct t_mympd_state *mympd_state, sds buffer, sds method,
                               long request_id, const char *uri);
sds mpd_client_get_filesystem(struct t_mympd_state *mympd_state, sds buffer, 
...
sds mpd_client_get_songs_in_album(struct t_mympd_state *mympd_state, sds buffer, sds method,
                                  long request_id, sds album, sds albumartist, 
                                  const struct t_tags *tagcols);
sds mpd_client_get_firstsong_in_albums(struct t_mympd_state *mympd_state, sds buffer, sds method,
