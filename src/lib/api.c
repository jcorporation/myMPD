...
static enum mympd_cmd_acl_entity mympd_cmd_acl[] = {
    ...
    [MYMPD_API_JUKEBOX_REFILL] = API_PUBLIC | API_MYMPD_ONLY,
    [MYMPD_API_JUKEBOX_REFILL_ADD] = API_PUBLIC | API_MYMPD_ONLY,
    ...
    [MYMPD_API_LYRICS_GET] = API_PUBLIC | API_MYMPD_ONLY,
