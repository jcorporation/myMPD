...
//privat definitions
static void _mympd_api_lyrics_unsynced(struct t_lyrics *lyrics, struct t_list *extracted, sds mediafile, const char *mime_type_mediafile);
static void _mympd_api_lyrics_synced(struct t_lyrics *lyrics, struct t_list *extracted, sds mediafile, const char *mime_type_mediafile);
...
sds mympd_api_lyrics_get(struct t_lyrics *lyrics, sds music_directory, sds buffer, sds method, long request_id, sds uri) {
    ...
    list_init(&extracted);
    _mympd_api_lyrics_synced(lyrics, &extracted, mediafile, mime_type_mediafile);
    _mympd_api_lyrics_unsynced(lyrics, &extracted, mediafile, mime_type_mediafile);
...
/**
 * Retrieves unsynced lyrics
 * @param lyrics pointer to lyrics configuration
 * @param extracted t_list struct to append found lyrics
 * @param returned_entities number of already retrieved lyrics
 ...
 * @param returned_entites already retrieved lyrics
